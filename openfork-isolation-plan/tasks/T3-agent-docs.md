...
1. Copy `drafts/AGENTS.md` → repo root `AGENTS.md` (replace).
...
An agent that only reads `AGENTS.md` + `FORK.md` + the skill knows remotes, tag-merge, union conflicts, and what not to maintain.
