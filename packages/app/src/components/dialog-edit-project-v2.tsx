  ...
  return (
    <Dialog fit>
      <form onSubmit={model.submit} class="contents">
        ...
        <DividerV2 />
        <DialogBody class="flex max-h-[min(560px,calc(100vh-160px))] w-full flex-col px-4 pt-4 pb-1">
          <ScrollView class="min-h-0 flex-1 [&_.scroll-view__viewport]:flex [&_.scroll-view__viewport]:flex-col [&_.scroll-view__viewport]:gap-6">
            <Field>
