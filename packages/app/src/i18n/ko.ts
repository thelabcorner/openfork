export const dict = {
  ...
  "command.fileTree.toggle": "파일 트리 표시/숨기기",  "command.terminal.new": "새 터미널",
  ...
  "command.browser.toggle": "브라우저 표시/숨기기",
  "browser.address.placeholder": "주소 검색 또는 입력",
  "browser.nav.back": "뒤로",
  "browser.nav.forward": "앞으로",
  "browser.nav.reload": "새로고침",
  "browser.nav.stop": "중지",
  "browser.nav.newTab": "새 탭",
  ...
  "browser.panel.empty": "열린 페이지 없음",
  "browser.panel.unavailable": "브라우저는 데스크톱 앱에서만 사용할 수 있습니다",
  "browser.mode.fill": "채우기",
  "browser.mode.freeform": "자유 형식",
  "browser.mode.preset": "사전 설정",
  "browser.viewportMode": "뷰포트 모드",
  "browser.rotate": "회전",
  "browser.aspectLock": "가로세로 비율 잠금",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "배지",
  "browser.badges.toggle": "요소 배지 표시/숨기기",
  ...
  "browser.resize.left": "왼쪽 가장자리에서 크기 조정",
  "browser.resize.right": "오른쪽 가장자리에서 크기 조정",
  "browser.resize.bottom": "아래쪽 가장자리에서 크기 조정",
  "browser.resize.bottom-left": "왼쪽 아래 모서리에서 크기 조정",
  "browser.resize.bottom-right": "오른쪽 아래 모서리에서 크기 조정",
  "browser.crash.title": "이 페이지가 충돌했습니다",
  "browser.crash.reload": "페이지 다시 로드",
  "browser.action.running": "실행 중",
  "browser.action.succeeded": "성공",
  "browser.action.failed": "실패",
  "browser.action.interrupted": "중단됨",
  "browser.summary.interactive": "상호 작용",
  "browser.summary.forms": "양식",
  "browser.summary.consoleErrors": "콘솔 오류",
  "browser.summary.failedRequests": "실패한 요청",
  ...
  "dialog.credential.manageKeys": "API 키 관리",
  "dialog.credential.title": "OpenCode API 키",
  "dialog.credential.description": "연결된 OpenCode API 키 사이를 전환하거나 저장된 키를 관리합니다.",
  "dialog.credential.active": "활성",
  "dialog.credential.select": "이 키로 전환",
  "dialog.credential.rename": "이름 바꾸기",
  "dialog.credential.remove": "제거",
  "dialog.credential.add": "API 키 추가",
  "dialog.credential.rename.placeholder": "라벨",
  "dialog.credential.empty": "연결된 API 키가 없습니다.",
  "provider.connect.apiKey.labelName": "라벨",
  "provider.connect.apiKey.labelPlaceholder": "예: 개인, 업무",
  ...
  "dialog.titlePrompt.default": "기본 프롬프트",
  "dialog.titlePrompt.token.previousTitle": "현재 세션 제목으로 바뀝니다",
  "dialog.titlePrompt.token.conversation": "생략해도 항상 첨부됩니다",
  "usage.go.title": "OpenCode Go 사용량",
  "usage.window.5h": "5시간",
  "usage.window.week": "주간",
  "usage.window.month": "월간",
  "usage.calls.one": "{{count}}회 호출",
  "usage.calls.other": "{{count}}회 호출",
  "usage.reset": "재설정",
  "usage.clear": "지우기",
  "usage.reset.predicted": "예측",
  ...
  "dialog.titlePrompt.title": "제목 생성 프롬프트",
  "dialog.titlePrompt.description": "제목 모델에 대한 지침입니다. 대화는 항상 첨부됩니다. {previousTitle}은(는) 현재 제목으로 바뀝니다.",
  "dialog.titlePrompt.placeholder": "사용자 지정 지침 (비우면 기본 프롬프트)",
  "dialog.titlePrompt.reset": "기본값으로 재설정",
  ...
  "session.tab.changes": "검토",
  "session.tab.context": "컨텍스트",
  "session.panel.fileBrowser": "검토 및 파일",
  "session.changes.filesChanged": "{{count}}개 파일 변경됨",
  "session.changes.change.one": "변경",
  "session.changes.change.other": "변경",
  "session.changes.loadingChanges": "변경 사항 로드 중...",
  "session.changes.empty": "이 세션에 변경 사항이 아직 없습니다",
  "session.changes.noVcs": "Git 버전 관리 시스템이 감지되지 않아 변경 사항이 표시되지 않습니다",
  "session.changes.noSnapshot": "구성에서 스냅샷 추적이 비활성화되어 있어 세션 변경 사항을 사용할 수 없습니다",
  "session.changes.noChanges": "변경 없음",
  ...
  "settings.general.section.titleGeneration": "제목 생성",
  ...
  "toast.title.regenerated": "세션 제목이 업데이트되었습니다",
  "toast.title.failed": "세션 제목을 생성하지 못했습니다",
  "toast.title.keepExisting": "제목 유지 — 생성 중에 변경되었습니다",
  ...
  "session.changes.noVcs.createGit.title": "Git 저장소 생성",
  "session.changes.noVcs.createGit.description": "이 프로젝트의 변경 사항을 추적, 검토 및 실행 취소",
  "session.changes.noVcs.createGit.actionLoading": "Git 저장소 생성 중...",
  "session.changes.noVcs.createGit.action": "Git 저장소 생성",
  ...
  "session.changes.noUncommittedChanges": "아직 커밋되지 않은 변경 사항이 없습니다",
  "session.changes.noBranchChanges": "아직 브랜치 변경 사항이 없습니다",
  ...
  "settings.general.row.titleModel.title": "제목 모델",
  "settings.general.row.titleModel.description": "세션 제목을 생성하고 다시 생성하는 데 사용하는 모델",
  "settings.general.row.titleModel.default": "기본 (소형 모델)",
  "settings.general.row.titlePrompt.edit": "프롬프트 편집",
