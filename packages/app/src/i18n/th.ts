export const dict = {
  ...
  "command.fileTree.toggle": "สลับแผนผังไฟล์",  "command.terminal.new": "เทอร์มินัลใหม่",
  ...
  "command.browser.toggle": "สลับเบราว์เซอร์",
  "browser.address.placeholder": "ค้นหาหรือป้อนที่อยู่",
  "browser.nav.back": "ย้อนกลับ",
  "browser.nav.forward": "ไปข้างหน้า",
  "browser.nav.reload": "โหลดซ้ำ",
  "browser.nav.stop": "หยุด",
  "browser.nav.newTab": "แท็บใหม่",
  ...
  "browser.panel.empty": "ไม่มีหน้าเปิดอยู่",
  "browser.panel.unavailable": "เบราว์เซอร์ใช้งานได้เฉพาะในแอปเดสก์ท็อป",
  "browser.mode.fill": "เติม",
  "browser.mode.freeform": "อิสระ",
  "browser.mode.preset": "ตั้งค่าล่วงหน้า",
  "browser.viewportMode": "โหมดวิวพอร์ต",
  "browser.rotate": "หมุน",
  "browser.aspectLock": "ล็อกอัตราส่วนกว้างยาว",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "ป้าย",
  "browser.badges.toggle": "สลับป้ายองค์ประกอบ",
  ...
  "browser.resize.left": "ปรับขนาดจากขอบซ้าย",
  "browser.resize.right": "ปรับขนาดจากขอบขวา",
  "browser.resize.bottom": "ปรับขนาดจากขอบล่าง",
  "browser.resize.bottom-left": "ปรับขนาดจากมุมล่างซ้าย",
  "browser.resize.bottom-right": "ปรับขนาดจากมุมล่างขวา",
  "browser.crash.title": "หน้านี้ขัดข้อง",
  "browser.crash.reload": "โหลดหน้าใหม่",
  "browser.action.running": "กำลังทำงาน",
  "browser.action.succeeded": "สำเร็จ",
  "browser.action.failed": "ล้มเหลว",
  "browser.action.interrupted": "ถูกขัดจังหวะ",
  "browser.summary.interactive": "โต้ตอบได้",
  "browser.summary.forms": "ฟอร์ม",
  "browser.summary.consoleErrors": "ข้อผิดพลาดคอนโซล",
  "browser.summary.failedRequests": "คำขอที่ล้มเหลว",
  ...
  "dialog.credential.manageKeys": "จัดการคีย์ API",
  "dialog.credential.title": "คีย์ OpenCode API",
  "dialog.credential.description": "สลับระหว่างคีย์ OpenCode API ที่เชื่อมต่ออยู่หรือจัดการคีย์ที่บันทึกไว้",
  "dialog.credential.active": "ใช้งานอยู่",
  "dialog.credential.select": "สลับไปยังคีย์นี้",
  "dialog.credential.rename": "เปลี่ยนชื่อ",
  "dialog.credential.remove": "นำออก",
  "dialog.credential.add": "เพิ่มคีย์ API",
  "dialog.credential.rename.placeholder": "ป้ายกำกับ",
  "dialog.credential.empty": "ยังไม่มีคีย์ API ที่เชื่อมต่อ",
  "provider.connect.apiKey.labelName": "ป้ายกำกับ",
  "provider.connect.apiKey.labelPlaceholder": "เช่น ส่วนตัว, ที่ทำงาน",
  ...
  "dialog.titlePrompt.default": "พรอมต์เริ่มต้น",
  "dialog.titlePrompt.token.previousTitle": "จะถูกแทนที่ด้วยชื่อเซสชันปัจจุบัน",
  "dialog.titlePrompt.token.conversation": "แนบเสมอแม้จะละไว้",
  "usage.go.title": "การใช้งาน OpenCode Go",
  "usage.window.5h": "5 ชั่วโมง",
  "usage.window.week": "รายสัปดาห์",
  "usage.window.month": "รายเดือน",
  "usage.calls.one": "{{count}} ครั้ง",
  "usage.calls.other": "{{count}} ครั้ง",
  "usage.reset": "รีเซ็ต",
  "usage.clear": "ล้าง",
  "usage.reset.predicted": "คาดการณ์",
  ...
  "dialog.titlePrompt.title": "พรอมต์สร้างชื่อเรื่อง",
  "dialog.titlePrompt.description": "คำแนะนำสำหรับโมเดลชื่อเรื่อง บทสนทนาจะถูกแนบเสมอ {previousTitle} จะถูกแทนที่ด้วยชื่อเรื่องปัจจุบัน",
  "dialog.titlePrompt.placeholder": "คำแนะนำที่กำหนดเอง (เว้นว่าง = พรอมต์เริ่มต้น)",
  "dialog.titlePrompt.reset": "รีเซ็ตเป็นค่าเริ่มต้น",
  ...
  "session.tab.changes": "ตรวจสอบ",
  "session.tab.context": "บริบท",
  "session.tab.unknown": "เซสชันที่ไม่รู้จัก",
  "session.panel.fileBrowser": "ตรวจสอบและไฟล์",
  ...
  "session.changes.filesChanged": "{{count}} ไฟล์ที่เปลี่ยนแปลง",
  "session.changes.change.one": "การเปลี่ยนแปลง",
  "session.changes.change.other": "การเปลี่ยนแปลง",
  "session.changes.loadingChanges": "กำลังโหลดการเปลี่ยนแปลง...",
  "session.changes.empty": "ยังไม่มีการเปลี่ยนแปลงในเซสชันนี้",
  "session.changes.noVcs": "ไม่ตรวจพบระบบควบคุมเวอร์ชัน Git การเปลี่ยนแปลงจะไม่แสดง",
  "session.changes.noSnapshot": "การติดตามสแนปชอตถูกปิดใช้งานในการกำหนดค่า ดังนั้นการเปลี่ยนแปลงเซสชันจึงไม่พร้อมใช้งาน",
  "session.changes.noChanges": "ไม่มีการเปลี่ยนแปลง",
  "session.changes.noUncommittedChanges": "ยังไม่มีการเปลี่ยนแปลงที่รอคอมมิต",
  "session.changes.noBranchChanges": "ยังไม่มีการเปลี่ยนแปลงในสาขา",
  ...
  "settings.general.section.titleGeneration": "การสร้างชื่อเรื่อง",
  ...
  "settings.general.row.titleModel.title": "โมเดลชื่อเรื่อง",
  "settings.general.row.titleModel.description": "โมเดลที่ใช้สร้างและสร้างชื่อเซสชันใหม่",
  "settings.general.row.titleModel.default": "ค่าเริ่มต้น (โมเดลขนาดเล็ก)",
  "settings.general.row.titlePrompt.edit": "แก้ไขพรอมต์",
  ...
  "toast.title.regenerated": "อัปเดตชื่อเซสชันแล้ว",
  "toast.title.failed": "สร้างชื่อเซสชันไม่สำเร็จ",
  "toast.title.keepExisting": "เก็บชื่อเดิมไว้ — มีการเปลี่ยนแปลงระหว่างการสร้าง",
  ...
  "session.changes.noVcs.createGit.title": "สร้าง Git รีโพซิทอรี",
  "session.changes.noVcs.createGit.description": "ติดตาม ตรวจสอบ และเลิกทำการเปลี่ยนแปลงในโปรเจกต์นี้",
  "session.changes.noVcs.createGit.actionLoading": "กำลังสร้าง Git รีโพซิทอรี...",
  "session.changes.noVcs.createGit.action": "สร้าง Git รีโพซิทอรี",
