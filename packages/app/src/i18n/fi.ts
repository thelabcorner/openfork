export const dict = {
  ...
  "command.fileTree.toggle": "Näytä tai piilota tiedostopuu",  "command.terminal.new": "Uusi terminaali",
  ...
  "command.browser.toggle": "Vaihda selainta",
  "browser.address.placeholder": "Hae tai kirjoita osoite",
  "browser.nav.back": "Takaisin",
  "browser.nav.forward": "Eteenpäin",
  "browser.nav.reload": "Lataa uudelleen",
  "browser.nav.stop": "Pysäytä",
  "browser.nav.newTab": "Uusi välilehti",
  ...
  "browser.panel.empty": "Ei avoimia sivuja",
  "browser.panel.unavailable": "Selain on käytettävissä vain työpöytäsovelluksessa",
  "browser.mode.fill": "Täytä",
  "browser.mode.freeform": "Vapaa",
  "browser.mode.preset": "Esiasetus",
  "browser.viewportMode": "Näyttöalueen tila",
  "browser.rotate": "Kierrä",
  "browser.aspectLock": "Lukitse kuvasuhde",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "Merkit",
  "browser.badges.toggle": "Vaihda elementtimerkkejä",
  ...
  "browser.resize.left": "Muuta kokoa vasemmasta reunasta",
  "browser.resize.right": "Muuta kokoa oikeasta reunasta",
  "browser.resize.bottom": "Muuta kokoa alareunasta",
  "browser.resize.bottom-left": "Muuta kokoa vasemmasta alakulmasta",
  "browser.resize.bottom-right": "Muuta kokoa oikeasta alakulmasta",
  "browser.crash.title": "Tämä sivu kaatui",
  "browser.crash.reload": "Lataa sivu uudelleen",
  "browser.action.running": "Käynnissä",
  "browser.action.succeeded": "Onnistui",
  "browser.action.failed": "Epäonnistui",
  "browser.action.interrupted": "Keskeytetty",
  "browser.summary.interactive": "Vuorovaikutteiset",
  "browser.summary.forms": "Lomakkeet",
  "browser.summary.consoleErrors": "Konsolivirheet",
  "browser.summary.failedRequests": "Epäonnistuneet pyynnöt",
  ...
  "dialog.credential.manageKeys": "Hallinnoi API-avaimia",
  "dialog.credential.title": "OpenCode API-avaimet",
  "dialog.credential.description": "Vaihda yhdistettyjen OpenCode API-avainten välillä tai hallinnoi tallennettuja.",
  "dialog.credential.active": "Aktiivinen",
  "dialog.credential.select": "Vaihda tähän avaimeen",
  "dialog.credential.rename": "Nimeä uudelleen",
  "dialog.credential.remove": "Poista",
  "dialog.credential.add": "Lisää API-avain",
  "dialog.credential.rename.placeholder": "Tunniste",
  "dialog.credential.empty": "API-avaimia ei ole vielä yhdistetty.",
  "provider.connect.apiKey.labelName": "Tunniste",
  "provider.connect.apiKey.labelPlaceholder": "esim. Henkilökohtainen, Työ",
  ...
  "dialog.titlePrompt.default": "Oletuskehote",
  "dialog.titlePrompt.token.previousTitle": "Korvataan nykyisellä istunnon otsikolla",
  "dialog.titlePrompt.token.conversation": "Liitetään aina, vaikka jättäisit sen pois",
  "usage.go.title": "OpenCode Go -käyttö",
  "usage.window.5h": "5 tuntia",
  "usage.window.week": "Viikoittain",
  "usage.window.month": "Kuukausittain",
  "usage.calls.one": "{{count}} puhelu",
  "usage.calls.other": "{{count}} puhelua",
  "usage.reset": "Palauta",
  "usage.clear": "Tyhjennä",
  "usage.reset.predicted": "Ennustettu",
  ...
  "dialog.titlePrompt.title": "Otsikon luonnin kehote",
  "dialog.titlePrompt.description": "Ohjeet otsikkomallille. Keskustelu liitetään aina mukaan; {previousTitle} korvataan nykyisellä otsikolla.",
  "dialog.titlePrompt.placeholder": "Omat ohjeet (tyhjä = oletuskehote)",
  "dialog.titlePrompt.reset": "Palauta oletusarvoon",
  ...
  "toast.title.regenerated": "Istunnon otsikko päivitetty",
  "toast.title.failed": "Istunnon otsikkoa ei voitu luoda",
  "toast.title.keepExisting": "Otsikko säilytetty — se muuttui luonnin aikana",
  ...
  "session.tab.changes": "Tarkistus",
  "session.tab.context": "Konteksti",
  "session.tab.unknown": "Tuntematon istunto",
  "session.panel.fileBrowser": "Tarkistus ja tiedostot",
  ...
  "session.changes.filesChanged": "Muutettuja tiedostoja: {{count}}",
  "session.changes.change.one": "Muutos",
  "session.changes.change.other": "Muutokset",
  "session.changes.loadingChanges": "Ladataan muutoksia...",
  "session.changes.empty": "Tässä istunnossa ei vielä muutoksia",
  "session.changes.noVcs": "Git-versionhallintaa ei havaittu, joten muutoksia ei näytetä",
  "session.changes.noVcs.createGit.title": "Luo Git-säilö",
  "session.changes.noVcs.createGit.description": "Seuraa, tarkista ja kumoa muutoksia tässä projektissa",
  "session.changes.noVcs.createGit.actionLoading": "Luodaan Git-säilöä...",
  "session.changes.noVcs.createGit.action": "Luo Git-säilö",
  ...
  "session.changes.noChanges": "Ei muutoksia",
  "session.changes.noUncommittedChanges": "Ei vielä sitomattomia muutoksia",
  "session.changes.noBranchChanges": "Ei vielä haaran muutoksia",
  ...
  "settings.general.section.titleGeneration": "Otsikon luonti",
  ...
  "settings.general.row.titleModel.title": "Otsikkomalli",
  "settings.general.row.titleModel.description": "Malli, jota käytetään istunnon otsikoiden luomiseen ja uudelleenluomiseen",
  "settings.general.row.titleModel.default": "Oletus (pieni malli)",
  "settings.general.row.titlePrompt.edit": "Muokkaa kehotetta",
