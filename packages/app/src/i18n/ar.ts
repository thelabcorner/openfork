export const dict = {
  ...
  "command.fileTree.toggle": "تبديل شجرة الملفات",  "command.terminal.new": "محطة طرفية جديدة",
  ...
  "command.browser.toggle": "تبديل المتصفح",
  "browser.address.placeholder": "ابحث أو أدخل عنوانًا",
  "browser.nav.back": "رجوع",
  "browser.nav.forward": "تقدم",
  "browser.nav.reload": "إعادة تحميل",
  "browser.nav.stop": "إيقاف",
  "browser.nav.newTab": "تبويب جديد",
  ...
  "browser.panel.empty": "لا توجد صفحات مفتوحة",
  "browser.panel.unavailable": "المتصفح متاح فقط في تطبيق سطح المكتب",
  "browser.mode.fill": "تعبئة",
  "browser.mode.freeform": "حر",
  "browser.mode.preset": "مسبق الضبط",
  "browser.viewportMode": "وضع منفذ العرض",
  "browser.rotate": "تدوير",
  "browser.aspectLock": "قفل نسبة الأبعاد",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "شارات",
  "browser.badges.toggle": "تبديل شارات العناصر",
  ...
  "browser.resize.left": "تغيير الحجم من الحافة اليسرى",
  "browser.resize.right": "تغيير الحجم من الحافة اليمنى",
  "browser.resize.bottom": "تغيير الحجم من الحافة السفلية",
  "browser.resize.bottom-left": "تغيير الحجم من الزاوية السفلية اليسرى",
  "browser.resize.bottom-right": "تغيير الحجم من الزاوية السفلية اليمنى",
  "browser.crash.title": "تعطلت هذه الصفحة",
  "browser.crash.reload": "إعادة تحميل الصفحة",
  "browser.action.running": "قيد التشغيل",
  "browser.action.succeeded": "نجح",
  "browser.action.failed": "فشل",
  "browser.action.interrupted": "توقف",
  "browser.summary.interactive": "تفاعلية",
  "browser.summary.forms": "نماذج",
  "browser.summary.consoleErrors": "أخطاء وحدة التحكم",
  "browser.summary.failedRequests": "طلبات فاشلة",
  ...
  "dialog.titlePrompt.default": "الموجه الافتراضي",
  "dialog.titlePrompt.token.previousTitle": "يُستبدل بعنوان الجلسة الحالي",
  "dialog.titlePrompt.token.conversation": "تُرفق دائمًا حتى لو حذفتها",
  "dialog.titlePrompt.title": "موجه إنشاء العنوان",
  "dialog.titlePrompt.description": "إرشادات لنموذج العناوين. تُرفق المحادثة دائمًا؛ يُستبدل {previousTitle} بالعنوان الحالي.",
  "dialog.titlePrompt.placeholder": "إرشادات مخصصة (فارغ = الموجه الافتراضي)",
  "dialog.titlePrompt.reset": "إعادة التعيين إلى الافتراضي",
  "dialog.credential.manageKeys": "إدارة مفاتيح API",
  "dialog.credential.title": "مفاتيح API الخاصة بـ OpenCode",
  "dialog.credential.description": "بدّل بين مفاتيح API المتصلة بـ OpenCode، أو أدر المفاتيح المحفوظة لديك.",
  "dialog.credential.active": "نشط",
  "dialog.credential.select": "التبديل إلى هذا المفتاح",
  "dialog.credential.rename": "إعادة تسمية",
  "dialog.credential.remove": "إزالة",
  "dialog.credential.add": "إضافة مفتاح API",
  "dialog.credential.rename.placeholder": "التسمية",
  "dialog.credential.empty": "لا توجد مفاتيح API متصلة بعد.",

  "usage.go.title": "استخدام OpenCode Go",
  "usage.window.5h": "5 ساعات",
  "usage.window.week": "أسبوعي",
  "usage.window.month": "شهري",
  "usage.calls.one": "{{count}} مكالمة",
  "usage.calls.other": "{{count}} مكالمات",
  "usage.calls.zero": "{{count}} مكالمة",
  "usage.calls.two": "{{count}} مكالمتان",
  "usage.calls.few": "{{count}} مكالمات",
  "usage.calls.many": "{{count}} مكالمة",
  "usage.reset": "إعادة تعيين",
  "usage.clear": "مسح",
  "usage.reset.predicted": "متوقع",
  "usage.duration.zero": "0د",
  "usage.duration.minutes": "{{minutes}}د",
  "usage.duration.hoursMinutes": "{{hours}}س {{minutes}}د",
  "usage.duration.daysHours": "{{days}}ي {{hours}}س",
  ...
  "provider.connect.apiKey.labelName": "التسمية",
  "provider.connect.apiKey.labelPlaceholder": "مثال: شخصي، عمل",
  ...
  "home.sessions.search.sessionsResult.two": "{{count}} session results",
  ...
  "home.sessions.search.messagesResult.two": "{{count}} message results",
  ...
  "session.tab.changes": "مراجعة",
  "session.tab.context": "سياق",
  "session.tab.unknown": "جلسة غير معروفة",
  "session.panel.fileBrowser": "المراجعة والملفات",
  ...
  "session.changes.filesChanged": "الملفات المتغيرة: {{count}}",
  "session.changes.change.one": "تغيير",
  "session.changes.change.other": "تغييرات",
  "session.changes.loadingChanges": "جارٍ تحميل التغييرات...",
  "session.changes.empty": "لا توجد تغييرات في هذه الجلسة بعد",
  "session.changes.noChanges": "لا توجد تغييرات",
  "session.changes.noUncommittedChanges": "لا توجد تغييرات غير مُودَعة بعد",
  "session.changes.noBranchChanges": "لا توجد تغييرات في الفرع بعد",
  "session.changes.noVcs": "لم يُكتشف نظام Git للتحكم في الإصدارات، لذا لن تُعرض التغييرات",
  "session.changes.noSnapshot": "تم تعطيل تتبع اللقطات في التكوين، لذا فإن تغييرات الجلسة غير متوفرة",
  ...
  "settings.general.section.titleGeneration": "إنشاء العناوين",
  ...
  "settings.general.row.titleModel.title": "نموذج العناوين",
  "settings.general.row.titleModel.description": "النموذج المستخدم لإنشاء عناوين الجلسات وإعادة إنشائها",
  "settings.general.row.titleModel.default": "الافتراضي (نموذج صغير)",
  "settings.general.row.titlePrompt.edit": "تعديل الموجه",
  ...
  "toast.title.regenerated": "تم تحديث عنوان الجلسة",
  "toast.title.failed": "تعذّر إنشاء عنوان الجلسة",
  "toast.title.keepExisting": "تم الاحتفاظ بالعنوان — تغيّر أثناء الإنشاء",
  ...
  "session.changes.noVcs.createGit.title": "إنشاء مستودع Git",
  "session.changes.noVcs.createGit.description": "تتبع ومراجعة والتراجع عن التغييرات في هذا المشروع",
  "session.changes.noVcs.createGit.actionLoading": "جارٍ إنشاء مستودع Git...",
  "session.changes.noVcs.createGit.action": "إنشاء مستودع Git",
