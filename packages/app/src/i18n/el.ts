export const dict = {
  ...
  "command.fileTree.toggle": "Εναλλαγή δέντρου αρχείου",  "command.terminal.new": "Νέο τερματικό",
  ...
  "command.browser.toggle": "Εναλλαγή προγράμματος περιήγησης",
  "browser.address.placeholder": "Αναζήτηση ή εισαγωγή διεύθυνσης",
  "browser.nav.back": "Πίσω",
  "browser.nav.forward": "Εμπρός",
  "browser.nav.reload": "Επαναφόρτωση",
  "browser.nav.stop": "Διακοπή",
  "browser.nav.newTab": "Νέα καρτέλα",
  ...
  "browser.panel.empty": "Δεν υπάρχουν ανοιχτές σελίδες",
  "browser.panel.unavailable": "Το πρόγραμμα περιήγησης είναι διαθέσιμο μόνο στην εφαρμογή επιτραπέζιου υπολογιστή",
  "browser.mode.fill": "Γέμισμα",
  "browser.mode.freeform": "Ελεύθερο",
  "browser.mode.preset": "Προεπιλογή",
  "browser.viewportMode": "Λειτουργία περιοχής προβολής",
  "browser.rotate": "Περιστροφή",
  "browser.aspectLock": "Κλείδωμα αναλογίας διαστάσεων",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "Σήματα",
  "browser.badges.toggle": "Εναλλαγή σημάτων στοιχείων",
  ...
  "browser.resize.left": "Αλλαγή μεγέθους από αριστερή άκρη",
  "browser.resize.right": "Αλλαγή μεγέθους από δεξιά άκρη",
  "browser.resize.bottom": "Αλλαγή μεγέθους από κάτω άκρη",
  "browser.resize.bottom-left": "Αλλαγή μεγέθους από κάτω αριστερή γωνία",
  "browser.resize.bottom-right": "Αλλαγή μεγέθους από κάτω δεξιά γωνία",
  "browser.crash.title": "Αυτή η σελίδα κατέρρευσε",
  "browser.crash.reload": "Επαναφόρτωση σελίδας",
  "browser.action.running": "Σε εξέλιξη",
  "browser.action.succeeded": "Επιτυχία",
  "browser.action.failed": "Αποτυχία",
  "browser.action.interrupted": "Διακόπηκε",
  "browser.summary.interactive": "Διαδραστικά",
  "browser.summary.forms": "Φόρμες",
  "browser.summary.consoleErrors": "Σφάλματα κονσόλας",
  "browser.summary.failedRequests": "Αποτυχημένα αιτήματα",
  ...
  "dialog.credential.manageKeys": "Διαχείριση κλειδιών API",
  "dialog.credential.title": "Κλειδιά OpenCode API",
  "dialog.credential.description": "Εναλλαγή μεταξύ των συνδεδεμένων κλειδιών OpenCode API ή διαχείριση των αποθηκευμένων.",
  "dialog.credential.active": "Ενεργό",
  "dialog.credential.select": "Εναλλαγή σε αυτό το κλειδί",
  "dialog.credential.rename": "Μετονομασία",
  "dialog.credential.remove": "Κατάργηση",
  "dialog.credential.add": "Προσθήκη κλειδιού API",
  "dialog.credential.rename.placeholder": "Ετικέτα",
  "dialog.credential.empty": "Δεν έχουν συνδεθεί ακόμα κλειδιά API.",
  "provider.connect.apiKey.labelName": "Ετικέτα",
  "provider.connect.apiKey.labelPlaceholder": "π.χ. Προσωπικό, Εργασία",
  ...
  "dialog.titlePrompt.default": "Προεπιλεγμένη προτροπή",
  "dialog.titlePrompt.token.previousTitle": "Αντικαθίσταται με τον τρέχοντα τίτλο συνόδου",
  "dialog.titlePrompt.token.conversation": "Επισυνάπτεται πάντα, ακόμη κι αν την παραλείψετε",
  "usage.go.title": "Χρήση OpenCode Go",
  "usage.window.5h": "5 ώρες",
  "usage.window.week": "Εβδομαδιαία",
  "usage.window.month": "Μηνιαία",
  "usage.calls.one": "{{count}} κλήση",
  "usage.calls.other": "{{count}} κλήσεις",
  "usage.reset": "Επαναφορά",
  "usage.clear": "Εκκαθάριση",
  "usage.reset.predicted": "Πρόβλεψη",
  ...
  "dialog.titlePrompt.title": "Προτροπή δημιουργίας τίτλου",
  "dialog.titlePrompt.description": "Οδηγίες για το μοντέλο τίτλων. Η συνομιλία επισυνάπτεται πάντα· το {previousTitle} αντικαθίσταται με τον τρέχοντα τίτλο.",
  "dialog.titlePrompt.placeholder": "Προσαρμοσμένες οδηγίες (κενό = προεπιλεγμένη προτροπή)",
  "dialog.titlePrompt.reset": "Επαναφορά προεπιλογής",
  ...
  "toast.title.regenerated": "Ο τίτλος της συνόδου ενημερώθηκε",
  "toast.title.failed": "Αποτυχία δημιουργίας τίτλου συνόδου",
  "toast.title.keepExisting": "Ο τίτλος διατηρήθηκε — άλλαξε κατά τη δημιουργία",
  ...
  "session.tab.changes": "Επισκόπηση",
  "session.tab.context": "Πλαίσιο",
  "session.tab.unknown": "Άγνωστη συνεδρία",
  "session.panel.fileBrowser": "Επισκόπηση και αρχεία",
  ...
  "session.changes.filesChanged": "Τα αρχεία άλλαξαν {{count}}",
  "session.changes.change.one": "Αλλαγή",
  "session.changes.change.other": "Αλλαγές",
  "session.changes.loadingChanges": "Φόρτωση αλλαγών...",
  "session.changes.empty": "Δεν υπάρχουν ακόμη αλλαγές σε αυτήν τη συνεδρία",
  "session.changes.noVcs": "Δεν εντοπίστηκε σύστημα ελέγχου έκδοσης Git, οι αλλαγές δεν εμφανίζονται",
  "session.changes.noVcs.createGit.title": "Δημιουργία αποθετηρίου Git",
  "session.changes.noVcs.createGit.description": "Παρακολούθηση, έλεγχος και αναίρεση αλλαγών σε αυτό το έργο",
  "session.changes.noVcs.createGit.actionLoading": "Δημιουργία αποθετηρίου Git...",
  "session.changes.noVcs.createGit.action": "Δημιουργία αποθετηρίου Git",
  ...
  "session.changes.noChanges": "Χωρίς αλλαγές",
  "session.changes.noUncommittedChanges": "Δεν υπάρχουν ακόμη μη δεσμευμένες αλλαγές",
  "session.changes.noBranchChanges": "Δεν υπάρχουν ακόμη αλλαγές κλάδου",
  ...
  "settings.general.section.titleGeneration": "Δημιουργία τίτλων",
  ...
  "settings.general.row.titleModel.title": "Μοντέλο τίτλων",
  "settings.general.row.titleModel.description": "Μοντέλο που χρησιμοποιείται για τη δημιουργία και αναδημιουργία τίτλων συνόδων",
  "settings.general.row.titleModel.default": "Προεπιλογή (μικρό μοντέλο)",
  "settings.general.row.titlePrompt.edit": "Επεξεργασία προτροπής",
