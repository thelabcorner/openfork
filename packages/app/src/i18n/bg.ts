export const dict = {
  ...
  "command.fileTree.toggle": "Превключване на файловото дърво",  "command.terminal.new": "Нов терминал",
  ...
  "dialog.credential.manageKeys": "Управление на API ключове",
  "dialog.credential.title": "OpenCode API ключове",
  "dialog.credential.description": "Превключвайте между свързаните OpenCode API ключове или управлявайте запазените.",
  "dialog.credential.active": "Активен",
  "dialog.credential.select": "Превключване към този ключ",
  "dialog.credential.rename": "Преименуване",
  "dialog.credential.remove": "Премахване",
  "dialog.credential.add": "Добавяне на API ключ",
  "dialog.credential.rename.placeholder": "Етикет",
  "dialog.credential.empty": "Все още няма свързани API ключове.",
  "provider.connect.apiKey.labelName": "Етикет",
  "provider.connect.apiKey.labelPlaceholder": "напр. Личен, Работен",
  ...
  "dialog.titlePrompt.default": "Подсказка по подразбиране",
  "dialog.titlePrompt.token.previousTitle": "Заменя се с текущото заглавие на сесията",
  "dialog.titlePrompt.token.conversation": "Винаги се прикачва, дори да го пропуснете",
  "usage.go.title": "Използване на OpenCode Go",
  "usage.window.5h": "5 часа",
  "usage.window.week": "Седмично",
  "usage.window.month": "Месечно",
  "usage.calls.one": "{{count}} повикване",
  "usage.calls.other": "{{count}} повиквания",
  "usage.reset": "Нулиране",
  "usage.clear": "Изчистване",
  "usage.reset.predicted": "Прогноза",
  ...
  "dialog.titlePrompt.title": "Подсказка за генериране на заглавие",
  "dialog.titlePrompt.description": "Инструкции за модела за заглавия. Разговорът винаги се прикачва; {previousTitle} се заменя с текущото заглавие.",
  "dialog.titlePrompt.placeholder": "Персонализирани инструкции (празно = подсказка по подразбиране)",
  "dialog.titlePrompt.reset": "Възстановяване по подразбиране",
  ...
  "toast.title.regenerated": "Заглавието на сесията е обновено",
  "toast.title.failed": "Неуспешно генериране на заглавие на сесия",
  "toast.title.keepExisting": "Заглавието е запазено — променило се е по време на генериране",
  ...
  "session.panel.fileBrowser": "Преглед и файлове",
  ...
  "session.changes.filesChanged": "Променени файлове {{count}}",
  "session.changes.change.one": "промяна",
  "session.changes.change.other": "Промени",
  "session.changes.loadingChanges": "Промените се зареждат...",
  "session.changes.empty": "Все още няма промени в тази сесия",
  "session.changes.noVcs": "Не е открита Git Система за контрол на версиите, промените не се показват",
  "session.changes.noVcs.createGit.title": "Създайте Git хранилище",
  "session.changes.noVcs.createGit.description": "Проследявайте, преглеждайте и отменяйте промените в този проект",
  "session.changes.noVcs.createGit.actionLoading": "Създаване на Git хранилище...",
  "session.changes.noVcs.createGit.action": "Създайте Git хранилище",
  ...
  "session.changes.noChanges": "Без промени",
  "session.changes.noUncommittedChanges": "Все още няма незавършени промени",
  "session.changes.noBranchChanges": "Все още няма промени в клона",
  ...
  "settings.general.section.titleGeneration": "Генериране на заглавия",
  ...
  "settings.general.row.titleModel.title": "Модел за заглавия",
  "settings.general.row.titleModel.description": "Модел, използван за генериране и прегенериране на заглавия на сесии",
  "settings.general.row.titleModel.default": "По подразбиране (малък модел)",
  "settings.general.row.titlePrompt.edit": "Редактиране на подсказката",
