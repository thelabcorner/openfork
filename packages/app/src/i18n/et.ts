export const dict = {
  ...
  "command.fileTree.toggle": "Failipuu sisse- ja väljalülitamine",  "command.terminal.new": "Uus terminal",
  ...
  "dialog.credential.manageKeys": "Halda API-võtmeid",
  "dialog.credential.title": "OpenCode API-võtmed",
  "dialog.credential.description": "Vaheta ühendatud OpenCode API-võtmete vahel või halda salvestatuid.",
  "dialog.credential.active": "Aktiivne",
  "dialog.credential.select": "Lülitu sellele võtmele",
  "dialog.credential.rename": "Nimeta ümber",
  "dialog.credential.remove": "Eemalda",
  "dialog.credential.add": "Lisa API-võti",
  "dialog.credential.rename.placeholder": "Silt",
  "dialog.credential.empty": "API-võtmeid pole veel ühendatud.",
  "provider.connect.apiKey.labelName": "Silt",
  "provider.connect.apiKey.labelPlaceholder": "nt Isiklik, Töö",
  ...
  "dialog.titlePrompt.default": "Vaikimisi viip",
  "dialog.titlePrompt.token.previousTitle": "Asendatakse praeguse seansi pealkirjaga",
  "dialog.titlePrompt.token.conversation": "Lisatakse alati, isegi kui jätate selle välja",
  "usage.go.title": "OpenCode Go kasutus",
  "usage.window.5h": "5 tundi",
  "usage.window.week": "Nädalas",
  "usage.window.month": "Kuus",
  "usage.calls.one": "{{count}} kõne",
  "usage.calls.other": "{{count}} kõnet",
  "usage.reset": "Lähtesta",
  "usage.clear": "Tühjenda",
  "usage.reset.predicted": "Prognoositud",
  ...
  "dialog.titlePrompt.title": "Pealkirja genereerimise viip",
  "dialog.titlePrompt.description": "Juhised pealkirjamudelile. Vestlus lisatakse alati; {previousTitle} asendatakse praeguse pealkirjaga.",
  "dialog.titlePrompt.placeholder": "Kohandatud juhised (tühi = vaikimisi viip)",
  "dialog.titlePrompt.reset": "Lähtesta vaikeväärtusele",
  ...
  "toast.title.regenerated": "Seansi pealkiri uuendatud",
  "toast.title.failed": "Seansi pealkirja genereerimine ebaõnnestus",
  "toast.title.keepExisting": "Pealkiri säilitatud — see muutus genereerimise ajal",
  ...
  "session.tab.changes": "Ülevaade",
  "session.tab.context": "Kontekst",
  "session.tab.unknown": "Tundmatu seanss",
  "session.panel.fileBrowser": "Ülevaatus ja failid",
  ...
  "session.changes.filesChanged": "Muudetud failid {{count}}",
  "session.changes.change.one": "Muuda",
  "session.changes.change.other": "Muudatused",
  "session.changes.loadingChanges": "Muudatuste laadimine...",
  "session.changes.empty": "Sellel seansil pole veel muudatusi",
  "session.changes.noVcs": "Ei tuvastatud Git Versioonikontrollisüsteemi, muudatusi ei kuvata",
  "session.changes.noVcs.createGit.title": "Loo Git hoidla",
  "session.changes.noVcs.createGit.description": "Selle projekti muudatuste jälgimine, ülevaatamine ja tagasivõtmine",
  "session.changes.noVcs.createGit.actionLoading": "Git hoidla loomine...",
  "session.changes.noVcs.createGit.action": "Loo Git hoidla",
  "session.changes.noSnapshot":
    "Hetketõmmise jälgimine on konfiguratsioonis keelatud, seega pole seansi muudatused saadaval",
  "session.changes.noChanges": "Muudatusi pole",
  "session.changes.noUncommittedChanges": "Tehmata muudatusi pole veel tehtud",
  "session.changes.noBranchChanges": "Filiaali muudatusi veel pole",
  ...
  "settings.general.section.titleGeneration": "Pealkirja genereerimine",
  ...
  "settings.general.row.titleModel.title": "Pealkirjamudel",
  "settings.general.row.titleModel.description": "Mudel, mida kasutatakse seansi pealkirjade genereerimiseks ja taastamiseks",
  "settings.general.row.titleModel.default": "Vaikimisi (väike mudel)",
  "settings.general.row.titlePrompt.edit": "Muuda viipa",
