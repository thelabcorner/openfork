export const dict = {
  ...
  "command.fileTree.toggle": "Mostrar u ocultar árbol de archivos",  "command.terminal.new": "Nueva terminal",
  ...
  "browser.address.placeholder": "Buscar o ingresar dirección",
  "browser.nav.back": "Atrás",
  "browser.nav.forward": "Adelante",
  "browser.nav.reload": "Recargar",
  "browser.nav.stop": "Detener",
  "browser.nav.newTab": "Nueva pestaña",
  ...
  "browser.panel.empty": "No hay páginas abiertas",
  "browser.panel.unavailable": "El navegador solo está disponible en la aplicación de escritorio",
  "browser.mode.fill": "Rellenar",
  "browser.mode.freeform": "Libre",
  "browser.mode.preset": "Preestablecido",
  "browser.viewportMode": "Modo de vista",
  "browser.rotate": "Rotar",
  "browser.aspectLock": "Bloquear relación de aspecto",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "Insignias",
  "browser.badges.toggle": "Alternar insignias de elementos",
  ...
  "browser.resize.left": "Redimensionar desde el borde izquierdo",
  "browser.resize.right": "Redimensionar desde el borde derecho",
  "browser.resize.bottom": "Redimensionar desde el borde inferior",
  "browser.resize.bottom-left": "Redimensionar desde la esquina inferior izquierda",
  "browser.resize.bottom-right": "Redimensionar desde la esquina inferior derecha",
  "browser.crash.title": "Esta página se bloqueó",
  "browser.crash.reload": "Recargar página",
  "browser.action.running": "En ejecución",
  "browser.action.succeeded": "Correcto",
  "browser.action.failed": "Fallido",
  "browser.action.interrupted": "Interrumpido",
  "browser.summary.interactive": "Interactivos",
  "browser.summary.forms": "Formularios",
  "browser.summary.consoleErrors": "Errores de consola",
  "browser.summary.failedRequests": "Solicitudes fallidas",
  ...
  "dialog.credential.manageKeys": "Administrar claves de API",
  "dialog.credential.title": "Claves de API de OpenCode",
  "dialog.credential.description": "Cambia entre tus claves de API de OpenCode conectadas o administra las guardadas.",
  "dialog.credential.active": "Activa",
  "dialog.credential.select": "Cambiar a esta clave",
  "dialog.credential.rename": "Renombrar",
  "dialog.credential.remove": "Eliminar",
  "dialog.credential.add": "Añadir clave de API",
  "dialog.credential.rename.placeholder": "Etiqueta",
  "dialog.credential.empty": "Aún no hay claves de API conectadas.",
  "provider.connect.apiKey.labelName": "Etiqueta",
  "provider.connect.apiKey.labelPlaceholder": "p. ej. Personal, Trabajo",
  ...
  "dialog.titlePrompt.default": "Prompt por defecto",
  "dialog.titlePrompt.token.previousTitle": "Se sustituye por el título actual de la sesión",
  "dialog.titlePrompt.token.conversation": "Siempre se adjunta, aunque lo omitas",
  "usage.go.title": "Uso de OpenCode Go",
  "usage.window.5h": "5 horas",
  "usage.window.week": "Semanal",
  "usage.window.month": "Mensual",
  "usage.calls.one": "{{count}} llamada",
  "usage.calls.other": "{{count}} llamadas",
  "usage.calls.many": "{{count}} llamadas",
  "usage.reset": "Restablecer",
  "usage.clear": "Borrar",
  ...
  "dialog.titlePrompt.title": "Prompt de generación de títulos",
  "dialog.titlePrompt.description": "Instrucciones para el modelo de títulos. La conversación siempre se adjunta; {previousTitle} se sustituye por el título actual.",
  "dialog.titlePrompt.placeholder": "Instrucciones personalizadas (vacío = prompt por defecto)",
  "dialog.titlePrompt.reset": "Restablecer el valor predeterminado",
  ...
  "session.tab.changes": "Revisión",
  "session.tab.context": "Contexto",
  "session.tab.unknown": "Sesión desconocida",
  "session.panel.fileBrowser": "Revisión y archivos",
  ...
  "session.changes.filesChanged": "Archivos modificados: {{count}}",
  "session.changes.change.one": "Cambio",
  "session.changes.change.other": "Cambios",
  "session.changes.loadingChanges": "Cargando cambios...",
  "session.changes.empty": "Aún no hay cambios en esta sesión",
  "session.changes.noVcs": "No se detectó ningún sistema de control de versiones Git; no se muestran los cambios",
  ...
  "session.changes.noChanges": "Sin cambios",
  "session.changes.noUncommittedChanges": "Aún no hay cambios sin confirmar",
  "session.changes.noBranchChanges": "Aún no hay cambios en la rama",
  ...
  "settings.general.section.titleGeneration": "Generación de títulos",
  ...
  "settings.general.row.titleModel.title": "Modelo de títulos",
  "settings.general.row.titleModel.description": "Modelo utilizado para generar y regenerar los títulos de las sesiones",
  "settings.general.row.titleModel.default": "Predeterminado (modelo pequeño)",
  "settings.general.row.titlePrompt.edit": "Editar prompt",
  ...
  "toast.title.regenerated": "Título de la sesión actualizado",
  "toast.title.failed": "No se pudo generar el título de la sesión",
  "toast.title.keepExisting": "Título conservado: cambió durante la generación",
  ...
  "session.changes.noVcs.createGit.title": "Crear repositorio Git",
  "session.changes.noVcs.createGit.description": "Rastrea, revisa y deshaz cambios en este proyecto",
  "session.changes.noVcs.createGit.actionLoading": "Creando repositorio Git...",
  "session.changes.noVcs.createGit.action": "Crear repositorio Git",
