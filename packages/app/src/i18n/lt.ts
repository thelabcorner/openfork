...
export const dict = {
  ...
  "command.fileTree.toggle": "Perjungti failų medį",  "command.terminal.new": "Naujas terminalas",
  ...
  "dialog.credential.manageKeys": "Tvarkyti API raktus",
  "dialog.credential.title": "OpenCode API raktai",
  "dialog.credential.description": "Perjunkite tarp prijungtų OpenCode API raktų arba tvarkykite išsaugotus.",
  "dialog.credential.active": "Aktyvus",
  "dialog.credential.select": "Perjungti į šį raktą",
  "dialog.credential.rename": "Pervadinti",
  "dialog.credential.remove": "Pašalinti",
  "dialog.credential.add": "Pridėti API raktą",
  "dialog.credential.rename.placeholder": "Etiketė",
  "dialog.credential.empty": "Prijungtų API raktų dar nėra.",
  "provider.connect.apiKey.labelName": "Etiketė",
  "provider.connect.apiKey.labelPlaceholder": "pvz., Asmeninis, Darbas",
  ...
  "dialog.titlePrompt.default": "Numatytasis raginimas",
  "dialog.titlePrompt.token.previousTitle": "Pakeičiamas dabartiniu sesijos pavadinimu",
  "dialog.titlePrompt.token.conversation": "Visada pridedama, net jei jos praleidžiate",
  "usage.go.title": "OpenCode Go naudojimas",
  "usage.window.5h": "5 valandos",
  "usage.window.week": "Kas savaitę",
  "usage.window.month": "Kas mėnesį",
  "usage.calls.one": "{{count}} skambutis",
  "usage.calls.other": "{{count}} skambučių",
  "usage.calls.few": "{{count}} skambučių",
  "usage.calls.many": "{{count}} skambučių",
  "usage.reset": "Atstatyti",
  "usage.clear": "Išvalyti",
  "usage.reset.predicted": "Numatyta",
  ...
  "dialog.titlePrompt.title": "Pavadinimo generavimo raginimas",
  "dialog.titlePrompt.description": "Instrukcijos pavadinimų modeliui. Pokalbis visada pridedamas; {previousTitle} pakeičiamas dabartiniu pavadinimu.",
  "dialog.titlePrompt.placeholder": "Pasirinktinės instrukcijos (tuščia = numatytasis raginimas)",
  "dialog.titlePrompt.reset": "Atkurti numatytąją reikšmę",
  ...
  "toast.title.regenerated": "Sesijos pavadinimas atnaujintas",
  "toast.title.failed": "Nepavyko sugeneruoti sesijos pavadinimo",
  "toast.title.keepExisting": "Pavadinimas išsaugotas — jis pasikeitė generuojant",
  ...
  "session.tab.changes": "Apžvalga",
  "session.tab.context": "Kontekstas",
  "session.tab.unknown": "Nežinomas seansas",
  "session.panel.fileBrowser": "Apžvalga ir failai",
  ...
  "session.changes.filesChanged": "Failai pakeisti {{count}}",
  "session.changes.change.one": "Keisti",
  "session.changes.change.other": "Pakeitimai",
  "session.changes.loadingChanges": "Įkeliami pakeitimai...",
  "session.changes.empty": "Pakeitimų šioje sesijoje dar nėra",
  "session.changes.noVcs": "Neaptikta Git versijos valdymo sistema, pakeitimai nerodomi",
  "session.changes.noVcs.createGit.title": "Sukurkite Git saugyklą",
  "session.changes.noVcs.createGit.description": "Stebėkite, peržiūrėkite ir anuliuokite šio projekto pakeitimus",
  "session.changes.noVcs.createGit.actionLoading": "Kuriama Git saugykla...",
  "session.changes.noVcs.createGit.action": "Sukurkite Git saugyklą",
  ...
  "session.changes.noChanges": "Jokių pakeitimų",
  "session.changes.noUncommittedChanges": "Dar nėra nepadarytų pakeitimų",
  "session.changes.noBranchChanges": "Šakoje pakeitimų dar nėra",
  ...
  "settings.general.section.titleGeneration": "Pavadinimų generavimas",
  ...
  "settings.general.row.titleModel.title": "Pavadinimų modelis",
  "settings.general.row.titleModel.description": "Modelis, naudojamas sesijų pavadinimams generuoti ir pergeneruoti",
  "settings.general.row.titleModel.default": "Numatytasis (mažas modelis)",
  "settings.general.row.titlePrompt.edit": "Redaguoti raginimą",
