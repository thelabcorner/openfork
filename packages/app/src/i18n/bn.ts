export const dict: Record<string, string> = {
  ...
  "command.fileTree.toggle": "ফাইল ট্রি টগল করুন",  "command.terminal.new": "নতুন টার্মিনাল",
  ...
  "dialog.credential.manageKeys": "API কী পরিচালনা করুন",
  "dialog.credential.title": "OpenCode API কী",
  "dialog.credential.description": "সংযুক্ত OpenCode API কীগুলির মধ্যে স্যুইচ করুন বা সংরক্ষিত কীগুলি পরিচালনা করুন।",
  "dialog.credential.active": "সক্রিয়",
  "dialog.credential.select": "এই কী-তে স্যুইচ করুন",
  "dialog.credential.rename": "নাম পরিবর্তন",
  "dialog.credential.remove": "সরান",
  "dialog.credential.add": "API কী যোগ করুন",
  "dialog.credential.rename.placeholder": "লেবেল",
  "dialog.credential.empty": "এখনও কোনো API কী সংযুক্ত নেই।",
  "provider.connect.apiKey.labelName": "লেবেল",
  "provider.connect.apiKey.labelPlaceholder": "যেমন: ব্যক্তিগত, কাজ",
  ...
  "dialog.titlePrompt.default": "ডিফল্ট প্রম্পট",
  "dialog.titlePrompt.token.previousTitle": "বর্তমান সেশন শিরোনাম দিয়ে প্রতিস্থাপিত হয়",
  "dialog.titlePrompt.token.conversation": "বাদ দিলেও সর্বদা সংযুক্ত থাকে",
  "usage.go.title": "OpenCode Go ব্যবহার",
  "usage.window.5h": "৫ ঘণ্টা",
  "usage.window.week": "সাপ্তাহিক",
  "usage.window.month": "মাসিক",
  "usage.calls.one": "{{count}} কল",
  "usage.calls.other": "{{count}} কল",
  "usage.reset": "রিসেট করুন",
  "usage.clear": "পরিষ্কার করুন",
  "usage.reset.predicted": "পূর্বাভাসিত",
  ...
  "dialog.titlePrompt.title": "শিরোনাম তৈরির প্রম্পট",
  "dialog.titlePrompt.description": "শিরোনাম মডেলের জন্য নির্দেশনা। কথোপকথন সর্বদা সংযুক্ত থাকে; {previousTitle} বর্তমান শিরোনাম দিয়ে প্রতিস্থাপিত হয়।",
  "dialog.titlePrompt.placeholder": "কাস্টম নির্দেশনা (খালি = ডিফল্ট প্রম্পট)",
  "dialog.titlePrompt.reset": "ডিফল্টে রিসেট করুন",
  ...
  "toast.title.regenerated": "সেশনের শিরোনাম আপডেট হয়েছে",
  "toast.title.failed": "সেশনের শিরোনাম তৈরি করা যায়নি",
  "toast.title.keepExisting": "শিরোনাম রাখা হয়েছে — তৈরির সময় এটি পরিবর্তিত হয়েছিল",
  ...
  "session.tab.changes": "পর্যালোচনা",
  "session.tab.context": "প্রসঙ্গ",
  "session.tab.unknown": "অজানা সেশন",
  "session.panel.fileBrowser": "পর্যালোচনা এবং ফাইল",
  ...
  "session.changes.filesChanged": "ফাইলগুলি পরিবর্তন করা হয়েছে {{count}}৷",
  "session.changes.change.one": "পরিবর্তন",
  "session.changes.change.other": "পরিবর্তন",
  "session.changes.loadingChanges": "পরিবর্তনগুলি লোড হচ্ছে...",
  "session.changes.empty": "এই সেশনে এখনও কোন পরিবর্তন নেই",
  "session.changes.noVcs": "কোন Git সংস্করণ নিয়ন্ত্রণ সিস্টেম সনাক্ত করা যায়নি, পরিবর্তনগুলি প্রদর্শিত হয় না",
  "session.changes.noVcs.createGit.title": "একটি Git সংগ্রহস্থল তৈরি করুন",
  ...
  "session.changes.noVcs.createGit.actionLoading": "Git সংগ্রহস্থল তৈরি করা হচ্ছে...",
  "session.changes.noVcs.createGit.action": "Git সংগ্রহস্থল তৈরি করুন",
  "session.changes.noSnapshot": "কনফিগারেশনে স্ন্যাপশট ট্র্যাকিং অক্ষম করা হয়েছে, তাই সেশন পরিবর্তনগুলি অনুপলব্ধ৷",
  "session.changes.noChanges": "কোনো পরিবর্তন নেই",
  "session.changes.noUncommittedChanges": "এখনও কোন অপ্রতিরোধ্য পরিবর্তন",
  "session.changes.noBranchChanges": "এখনো কোনো শাখা পরিবর্তন হয়নি",
  ...
  "settings.general.section.titleGeneration": "শিরোনাম তৈরি",
  ...
  "settings.general.row.titleModel.title": "শিরোনাম মডেল",
  "settings.general.row.titleModel.description": "সেশন শিরোনাম তৈরি ও পুনরায় তৈরি করতে ব্যবহৃত মডেল",
  "settings.general.row.titleModel.default": "ডিফল্ট (ছোট মডেল)",
  "settings.general.row.titlePrompt.edit": "প্রম্পট সম্পাদনা করুন",
