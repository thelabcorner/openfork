export const dict = {
  ...
  "command.fileTree.toggle": "درخت فایل را تغییر دهید",  "command.terminal.new": "ترمینال جدید",
  ...
  "command.browser.toggle": "تغییر وضعیت مرورگر",
  "browser.address.placeholder": "جستجو یا وارد کردن آدرس",
  "browser.nav.back": "بازگشت",
  "browser.nav.forward": "رفتن به جلو",
  "browser.nav.reload": "بارگذاری مجدد",
  "browser.nav.stop": "توقف",
  "browser.nav.newTab": "تب جدید",
  ...
  "browser.panel.empty": "هیچ صفحه‌ای باز نیست",
  "browser.panel.unavailable": "مرورگر فقط در برنامه دسکتاپ در دسترس است",
  "browser.mode.fill": "پر کردن",
  "browser.mode.freeform": "آزاد",
  "browser.mode.preset": "از پیش تنظیم شده",
  "browser.viewportMode": "حالت نمای دید",
  "browser.rotate": "چرخش",
  "browser.aspectLock": "قفل نسبت ابعاد",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "نشان‌ها",
  "browser.badges.toggle": "تغییر وضعیت نشان‌های عناصر",
  ...
  "browser.resize.left": "تغییر اندازه از لبه چپ",
  "browser.resize.right": "تغییر اندازه از لبه راست",
  "browser.resize.bottom": "تغییر اندازه از لبه پایین",
  "browser.resize.bottom-left": "تغییر اندازه از گوشه پایین چپ",
  "browser.resize.bottom-right": "تغییر اندازه از گوشه پایین راست",
  "browser.crash.title": "این صفحه از کار افتاد",
  "browser.crash.reload": "بارگذاری مجدد صفحه",
  "browser.action.running": "در حال اجرا",
  "browser.action.succeeded": "موفق",
  "browser.action.failed": "ناموفق",
  "browser.action.interrupted": "قطع شده",
  "browser.summary.interactive": "تعاملی",
  "browser.summary.forms": "فرم‌ها",
  "browser.summary.consoleErrors": "خطاهای کنسول",
  "browser.summary.failedRequests": "درخواست‌های ناموفق",
  ...
  "dialog.credential.manageKeys": "مدیریت کلیدهای API",
  "dialog.credential.title": "کلیدهای OpenCode API",
  "dialog.credential.description": "بین کلیدهای OpenCode API متصل جابه‌جا شوید یا کلیدهای ذخیره‌شده را مدیریت کنید.",
  "dialog.credential.active": "فعال",
  "dialog.credential.select": "جابه‌جایی به این کلید",
  "dialog.credential.rename": "تغییر نام",
  "dialog.credential.remove": "حذف",
  "dialog.credential.add": "افزودن کلید API",
  "dialog.credential.rename.placeholder": "برچسب",
  "dialog.credential.empty": "هنوز کلید API متصل نشده است.",
  "provider.connect.apiKey.labelName": "برچسب",
  "provider.connect.apiKey.labelPlaceholder": "مثلاً شخصی، کاری",
  ...
  "dialog.titlePrompt.default": "پرامپت پیش‌فرض",
  "dialog.titlePrompt.token.previousTitle": "با عنوان فعلی جلسه جایگزین می‌شود",
  "dialog.titlePrompt.token.conversation": "همیشه پیوست می‌شود، حتی اگر آن را حذف کنید",
  "usage.go.title": "مصرف OpenCode Go",
  "usage.window.5h": "۵ ساعت",
  "usage.window.week": "هفتگی",
  "usage.window.month": "ماهانه",
  "usage.calls.one": "{{count}} تماس",
  "usage.calls.other": "{{count}} تماس",
  "usage.reset": "بازنشانی",
  "usage.clear": "پاک کردن",
  "usage.reset.predicted": "پیش‌بینی‌شده",
  ...
  "dialog.titlePrompt.title": "پرامپت تولید عنوان",
  "dialog.titlePrompt.description": "دستورالعمل‌های مدل عنوان. گفتگو همیشه پیوست می‌شود؛ {previousTitle} با عنوان فعلی جایگزین می‌شود.",
  "dialog.titlePrompt.placeholder": "دستورالعمل‌های سفارشی (خالی = پرامپت پیش‌فرض)",
  "dialog.titlePrompt.reset": "بازنشانی به پیش‌فرض",
  ...
  "toast.title.regenerated": "عنوان جلسه به‌روزرسانی شد",
  "toast.title.failed": "تولید عنوان جلسه ناموفق بود",
  "toast.title.keepExisting": "عنوان حفظ شد — در هنگام تولید تغییر کرده بود",
  ...
  "session.tab.changes": "بررسی کنید",
  "session.tab.context": "زمینه",
  "session.tab.unknown": "جلسه ناشناخته",
  "session.panel.fileBrowser": "بررسی و فایل ها",
  ...
  "session.changes.filesChanged": "فایل ها تغییر کردند {{count}}",
  "session.changes.change.one": "تغییر دهید",
  "session.changes.change.other": "تغییرات",
  "session.changes.loadingChanges": "در حال بارگیری تغییرات...",
  "session.changes.empty": "هنوز هیچ تغییری در این جلسه وجود ندارد",
  "session.changes.noVcs": "هیچ سیستم کنترل نسخه Git شناسایی نشد، تغییرات نمایش داده نمی شود",
  "session.changes.noVcs.createGit.title": "یک مخزن Git ایجاد کنید",
  "session.changes.noVcs.createGit.description": "ردیابی، بررسی، و لغو تغییرات در این پروژه",
  "session.changes.noVcs.createGit.actionLoading": "ایجاد مخزن Git...",
  "session.changes.noVcs.createGit.action": "مخزن Git ایجاد کنید",
  "session.changes.noSnapshot": "ردیابی عکس فوری در پیکربندی غیرفعال است، بنابراین تغییرات جلسه در دسترس نیست",
  "session.changes.noChanges": "بدون تغییر",
  "session.changes.noUncommittedChanges": "هنوز هیچ تغییری انجام نشده است",
  "session.changes.noBranchChanges": "هنوز شعبه ای تغییر نکرده است",
  ...
  "settings.general.section.titleGeneration": "تولید عنوان",
  ...
  "settings.general.row.titleModel.title": "مدل عنوان",
  "settings.general.row.titleModel.description": "مدلی که برای تولید و بازتولید عنوان جلسه‌ها استفاده می‌شود",
  "settings.general.row.titleModel.default": "پیش‌فرض (مدل کوچک)",
  "settings.general.row.titlePrompt.edit": "ویرایش پرامپت",
