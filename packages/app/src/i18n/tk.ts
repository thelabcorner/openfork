export const dict = {
  ...
  "command.fileTree.toggle": "Faýl agajyny çalyşyň",  "command.terminal.new": "Täze terminal",
  ...
  "dialog.credential.manageKeys": "API açarlaryny dolandyrmak",
  "dialog.credential.title": "OpenCode API açarlary",
  "dialog.credential.description": "Birikdirilen OpenCode API açarlarynyň arasynda geçiň ýa-da saklananlary dolandyryň.",
  "dialog.credential.active": "Işjeň",
  "dialog.credential.select": "Bu açara geçiň",
  "dialog.credential.rename": "Adyny üýtgetmek",
  "dialog.credential.remove": "Aýyrmak",
  "dialog.credential.add": "API açary goşmak",
  "dialog.credential.rename.placeholder": "Bellik",
  "dialog.credential.empty": "Entek birikdirilen API açary ýok.",
  "provider.connect.apiKey.labelName": "Bellik",
  "provider.connect.apiKey.labelPlaceholder": "mys. Şahsy, Iş",
  ...
  "dialog.titlePrompt.default": "Bellenen prompt",
  "dialog.titlePrompt.token.previousTitle": "Häzirki sessiýa sözbaşy bilen çalşylýar",
  "dialog.titlePrompt.token.conversation": "Goýsaňyzam elmydama goşulýar",
  "usage.go.title": "OpenCode Go ulanyşy",
  "usage.window.5h": "5 sagat",
  "usage.window.week": "Hepdelik",
  "usage.window.month": "Aýlyk",
  "usage.calls.one": "{{count}} jaň",
  "usage.calls.other": "{{count}} jaň",
  "usage.reset": "Başdan başlatmak",
  "usage.clear": "Arassalamak",
  "usage.reset.predicted": "Çaklama",
  ...
  "dialog.titlePrompt.title": "Sözbaşy döretmek prompty",
  "dialog.titlePrompt.description": "Sözbaşy modeli üçin görkezmeler. Söhbetdeşlik elmydama goşulýar; {previousTitle} häzirki sözbaşy bilen çalşylýar.",
  "dialog.titlePrompt.placeholder": "Ýörite görkezmeler (boş = bellenen prompt)",
  "dialog.titlePrompt.reset": "Bellenen ýagdaýa gaýtarmak",
  ...
  "toast.title.regenerated": "Sessiýanyň sözbaşy täzelendi",
  "toast.title.failed": "Sessiýanyň sözbaşysyny döretmek başa barmady",
  "toast.title.keepExisting": "Sözbaşy saklandy — döredilende üýtgedi",
  ...
  "session.tab.changes": "Syn",
  "session.tab.context": "Kontekst",
  "session.tab.unknown": "Näbelli sessiýa",
  "session.panel.fileBrowser": "Gözden geçiriň we faýllary",
  ...
  "session.changes.filesChanged": "Faýllar üýtgedildi {{count}}",
  "session.changes.change.one": "Üýtget",
  "session.changes.change.other": "Üýtgeşmeler",
  "session.changes.loadingChanges": "Üýtgeşmeler ýüklenýär ...",
  "session.changes.empty": "Bu sessiýada entek üýtgeşme ýok",
  "session.changes.noVcs": "Git wersiýa dolandyryş ulgamy tapylmady, üýtgeşmeler görkezilmedi",
  "session.changes.noVcs.createGit.title": "Git ammary dörediň",
  "session.changes.noVcs.createGit.description": "Bu taslamadaky üýtgeşmeleri yzarlaň, gözden geçiriň we yzyna alyň",
  "session.changes.noVcs.createGit.actionLoading": "Git ammaryny döretmek ...",
  "session.changes.noVcs.createGit.action": "Git ammary dörediň",
  "session.changes.noSnapshot":
    "Snapshot yzarlamasy konfigurasiýada ýapyk, şonuň üçin sessiýa üýtgeşmeleri elýeterli däl",
  "session.changes.noChanges": "Üýtgeşme ýok",
  "session.changes.noUncommittedChanges": "Entek rugsat berilmedik üýtgeşmeler ýok",
  "session.changes.noBranchChanges": "Entek hiç hili şahamça üýtgemeýär",
  ...
  "settings.general.section.titleGeneration": "Sözbaşy döretmek",
  ...
  "settings.general.row.titleModel.title": "Sözbaşy modeli",
  "settings.general.row.titleModel.description": "Sessiýa sözbaşylaryny döretmek we täzeden döretmek üçin ulanylýan model",
  "settings.general.row.titleModel.default": "Bellenen (kiçi model)",
  "settings.general.row.titlePrompt.edit": "Prompty üýtgetmek",
