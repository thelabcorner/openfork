export const dict = {
  ...
  "command.fileTree.toggle": "Bật/tắt cây tệp",  "command.terminal.new": "Terminal mới",
  ...
  "command.browser.toggle": "Bật/tắt trình duyệt",
  "browser.address.placeholder": "Tìm kiếm hoặc nhập địa chỉ",
  "browser.nav.back": "Quay lại",
  "browser.nav.forward": "Tiến tới",
  "browser.nav.reload": "Tải lại",
  "browser.nav.stop": "Dừng",
  "browser.nav.newTab": "Tab mới",
  ...
  "browser.panel.empty": "Không có trang nào đang mở",
  "browser.panel.unavailable": "Trình duyệt chỉ khả dụng trong ứng dụng máy tính",
  "browser.mode.fill": "Lấp đầy",
  "browser.mode.freeform": "Tự do",
  "browser.mode.preset": "Cài sẵn",
  "browser.viewportMode": "Chế độ khung nhìn",
  "browser.rotate": "Xoay",
  "browser.aspectLock": "Khóa tỷ lệ khung hình",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "Huy hiệu",
  "browser.badges.toggle": "Bật/tắt huy hiệu phần tử",
  ...
  "browser.resize.left": "Thay đổi kích thước từ cạnh trái",
  "browser.resize.right": "Thay đổi kích thước từ cạnh phải",
  "browser.resize.bottom": "Thay đổi kích thước từ cạnh dưới",
  "browser.resize.bottom-left": "Thay đổi kích thước từ góc dưới bên trái",
  "browser.resize.bottom-right": "Thay đổi kích thước từ góc dưới bên phải",
  "browser.crash.title": "Trang này đã bị sập",
  "browser.crash.reload": "Tải lại trang",
  "browser.action.running": "Đang chạy",
  "browser.action.succeeded": "Thành công",
  "browser.action.failed": "Thất bại",
  "browser.action.interrupted": "Bị gián đoạn",
  "browser.summary.interactive": "Tương tác",
  "browser.summary.forms": "Biểu mẫu",
  "browser.summary.consoleErrors": "Lỗi bảng điều khiển",
  "browser.summary.failedRequests": "Yêu cầu thất bại",
  ...
  "dialog.credential.manageKeys": "Quản lý khóa API",
  "dialog.credential.title": "Khóa API OpenCode",
  "dialog.credential.description": "Chuyển đổi giữa các khóa API OpenCode đã kết nối hoặc quản lý các khóa đã lưu.",
  "dialog.credential.active": "Đang hoạt động",
  "dialog.credential.select": "Chuyển sang khóa này",
  "dialog.credential.rename": "Đổi tên",
  "dialog.credential.remove": "Xóa",
  "dialog.credential.add": "Thêm khóa API",
  "dialog.credential.rename.placeholder": "Nhãn",
  "dialog.credential.empty": "Chưa có khóa API nào được kết nối.",
  "provider.connect.apiKey.labelName": "Nhãn",
  "provider.connect.apiKey.labelPlaceholder": "vd: Cá nhân, Công việc",
  ...
  "dialog.titlePrompt.default": "Lời nhắc mặc định",
  "dialog.titlePrompt.token.previousTitle": "Được thay bằng tiêu đề phiên hiện tại",
  "dialog.titlePrompt.token.conversation": "Luôn được đính kèm, kể cả khi bạn bỏ qua",
  "usage.go.title": "Mức sử dụng OpenCode Go",
  "usage.window.5h": "5 giờ",
  "usage.window.week": "Hàng tuần",
  "usage.window.month": "Hàng tháng",
  "usage.calls.one": "{{count}} lần gọi",
  "usage.calls.other": "{{count}} lần gọi",
  "usage.reset": "Đặt lại",
  "usage.clear": "Xóa",
  "usage.reset.predicted": "Dự đoán",
  ...
  "dialog.titlePrompt.title": "Lời nhắc tạo tiêu đề",
  "dialog.titlePrompt.description": "Hướng dẫn cho mô hình tiêu đề. Hội thoại luôn được đính kèm; {previousTitle} được thay bằng tiêu đề hiện tại.",
  "dialog.titlePrompt.placeholder": "Hướng dẫn tùy chỉnh (để trống = lời nhắc mặc định)",
  "dialog.titlePrompt.reset": "Đặt lại về mặc định",
  ...
  "toast.title.regenerated": "Đã cập nhật tiêu đề phiên",
  "toast.title.failed": "Không thể tạo tiêu đề phiên",
  "toast.title.keepExisting": "Giữ nguyên tiêu đề — tiêu đề đã thay đổi trong lúc tạo",
  ...
  "session.changes.filesChanged": "Số tệp đã thay đổi: {{count}}",
  "session.changes.change.one": "Thay đổi",
  "session.changes.change.other": "Thay đổi",
  "session.changes.loadingChanges": "Đang tải các thay đổi...",
  "session.changes.empty": "Chưa có thay đổi nào trong phiên này",
  "session.changes.noVcs": "Không phát hiện hệ thống quản lý phiên bản Git nên không thể hiển thị thay đổi",
  "session.changes.noVcs.createGit.title": "Tạo kho lưu trữ Git",
  "session.changes.noVcs.createGit.description": "Theo dõi, xem xét và hoàn tác các thay đổi trong dự án này",
  "session.changes.noVcs.createGit.actionLoading": "Đang tạo kho lưu trữ Git...",
  "session.changes.noVcs.createGit.action": "Tạo kho lưu trữ Git",
  "session.changes.noSnapshot":
    "Theo dõi ảnh chụp nhanh bị tắt trong cấu hình, do đó các thay đổi về phiên không khả dụng",
  "session.changes.noChanges": "Không có thay đổi",
  "session.changes.noUncommittedChanges": "Chưa có thay đổi nào chưa commit",
  "session.changes.noBranchChanges": "Chưa có thay đổi nhánh",
  ...
  "settings.general.section.titleGeneration": "Tạo tiêu đề",
  ...
  "settings.general.row.titleModel.title": "Mô hình tiêu đề",
  "settings.general.row.titleModel.description": "Mô hình dùng để tạo và tạo lại tiêu đề phiên",
  "settings.general.row.titleModel.default": "Mặc định (mô hình nhỏ)",
  "settings.general.row.titlePrompt.edit": "Sửa lời nhắc",
