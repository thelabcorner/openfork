export const dict = {
  ...
  "command.fileTree.toggle": "फ़ाइल ट्री टॉगल करें",  "command.terminal.new": "नया टर्मिनल",
  ...
  "command.browser.toggle": "ब्राउज़र टॉगल करें",
  "browser.address.placeholder": "पता खोजें या दर्ज करें",
  "browser.nav.back": "पीछे",
  "browser.nav.forward": "आगे",
  "browser.nav.reload": "फिर से लोड करें",
  "browser.nav.stop": "रोकें",
  "browser.nav.newTab": "नया टैब",
  ...
  "browser.panel.empty": "कोई पेज नहीं खुला",
  "browser.panel.unavailable": "ब्राउज़र केवल डेस्कटॉप ऐप में उपलब्ध है",
  "browser.mode.fill": "भरें",
  "browser.mode.freeform": "मुक्त",
  "browser.mode.preset": "प्रीसेट",
  "browser.viewportMode": "व्यूपोर्ट मोड",
  "browser.rotate": "घुमाएँ",
  "browser.aspectLock": "पहलू अनुपात लॉक करें",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "बैज",
  "browser.badges.toggle": "तत्व बैज टॉगल करें",
  ...
  "browser.resize.left": "बाएँ किनारे से आकार बदलें",
  "browser.resize.right": "दाएँ किनारे से आकार बदलें",
  "browser.resize.bottom": "निचले किनारे से आकार बदलें",
  "browser.resize.bottom-left": "निचले बाएँ कोने से आकार बदलें",
  "browser.resize.bottom-right": "निचले दाएँ कोने से आकार बदलें",
  "browser.crash.title": "यह पेज क्रैश हो गया",
  "browser.crash.reload": "पेज फिर से लोड करें",
  "browser.action.running": "चालू",
  "browser.action.succeeded": "सफल",
  "browser.action.failed": "विफल",
  "browser.action.interrupted": "बाधित",
  "browser.summary.interactive": "इंटरैक्टिव",
  "browser.summary.forms": "फ़ॉर्म",
  "browser.summary.consoleErrors": "कंसोल त्रुटियाँ",
  "browser.summary.failedRequests": "विफल अनुरोध",
  ...
  "dialog.credential.manageKeys": "API कुंजियां प्रबंधित करें",
  "dialog.credential.title": "OpenCode API कुंजियां",
  "dialog.credential.description": "अपनी कनेक्टेड OpenCode API कुंजियों के बीच स्विच करें या सहेजी गई कुंजियों को प्रबंधित करें।",
  "dialog.credential.active": "सक्रिय",
  "dialog.credential.select": "इस कुंजी पर स्विच करें",
  "dialog.credential.rename": "नाम बदलें",
  "dialog.credential.remove": "हटाएं",
  "dialog.credential.add": "API कुंजी जोड़ें",
  "dialog.credential.rename.placeholder": "लेबल",
  "dialog.credential.empty": "अभी तक कोई API कुंजी कनेक्ट नहीं है।",
  "provider.connect.apiKey.labelName": "लेबल",
  "provider.connect.apiKey.labelPlaceholder": "जैसे: व्यक्तिगत, कार्य",
  ...
  "dialog.titlePrompt.default": "डिफ़ॉल्ट प्रॉम्प्ट",
  "dialog.titlePrompt.token.previousTitle": "वर्तमान सत्र शीर्षक से बदल दिया जाता है",
  "dialog.titlePrompt.token.conversation": "हमेशा जोड़ा जाता है, भले ही आप इसे छोड़ दें",
  "usage.go.title": "OpenCode Go उपयोग",
  "usage.window.5h": "5 घंटे",
  "usage.window.week": "साप्ताहिक",
  "usage.window.month": "मासिक",
  "usage.calls.one": "{{count}} कॉल",
  "usage.calls.other": "{{count}} कॉल",
  "usage.reset": "रीसेट करें",
  "usage.clear": "साफ़ करें",
  "usage.reset.predicted": "अनुमानित",
  ...
  "dialog.titlePrompt.title": "शीर्षक निर्माण प्रॉम्प्ट",
  "dialog.titlePrompt.description": "शीर्षक मॉडल के लिए निर्देश। बातचीत हमेशा जोड़ी जाती है; {previousTitle} को वर्तमान शीर्षक से बदल दिया जाता है।",
  "dialog.titlePrompt.placeholder": "कस्टम निर्देश (खाली = डिफ़ॉल्ट प्रॉम्प्ट)",
  "dialog.titlePrompt.reset": "डिफ़ॉल्ट पर रीसेट करें",
  ...
  "toast.title.regenerated": "सत्र का शीर्षक अपडेट किया गया",
  "toast.title.failed": "सत्र का शीर्षक बनाने में विफल",
  "toast.title.keepExisting": "शीर्षक रखा गया — यह निर्माण के दौरान बदल गया",
  ...
  "session.tab.changes": "समीक्षा",
  "session.tab.context": "कॉन्टेक्स्ट",
  "session.tab.unknown": "अज्ञात सेशन",
  "session.panel.fileBrowser": "समीक्षा और फ़ाइलें",
  ...
  "session.changes.filesChanged": "बदली गई फ़ाइलें: {{count}}",
  "session.changes.change.one": "परिवर्तन",
  "session.changes.change.other": "परिवर्तन",
  "session.changes.loadingChanges": "परिवर्तन लोड हो रहे हैं...",
  "session.changes.empty": "इस सेशन में अभी तक कोई बदलाव नहीं हुआ है",
  "session.changes.noVcs": "कोई Git संस्करण नियंत्रण प्रणाली नहीं पाई गई, परिवर्तन प्रदर्शित नहीं हुए",
  "session.changes.noVcs.createGit.title": "एक Git रिपॉजिटरी बनाएं",
  "session.changes.noVcs.createGit.description":
    "इस प्रोजेक्ट में परिवर्तनों को ट्रैक करें, समीक्षा करें और पूर्ववत करें",
  "session.changes.noVcs.createGit.actionLoading": "Git रिपॉजिटरी बनाई जा रही है...",
  "session.changes.noVcs.createGit.action": "Git रिपॉजिटरी बनाएं",
  "session.changes.noSnapshot": "कॉन्फ़िगरेशन में स्नैपशॉट ट्रैकिंग अक्षम है, इसलिए सेशन परिवर्तन अनुपलब्ध हैं",
  "session.changes.noChanges": "कोई परिवर्तन नहीं",
  "session.changes.noUncommittedChanges": "अभी तक कोई अप्रतिबद्ध परिवर्तन नहीं",
  "session.changes.noBranchChanges": "अभी तक शाखा में कोई परिवर्तन नहीं",
  ...
  "settings.general.section.titleGeneration": "शीर्षक निर्माण",
  ...
  "settings.general.row.titleModel.title": "शीर्षक मॉडल",
  "settings.general.row.titleModel.description": "सत्र शीर्षक बनाने और दोबारा बनाने के लिए उपयोग किया जाने वाला मॉडल",
  "settings.general.row.titleModel.default": "डिफ़ॉल्ट (छोटा मॉडल)",
  "settings.general.row.titlePrompt.edit": "प्रॉम्प्ट संपादित करें",
