...
export const dict = {
  ...
  "command.fileTree.toggle": "Dosya ağacını aç/kapat",  "command.terminal.new": "Yeni terminal",
  ...
  "command.browser.toggle": "Tarayıcıyı aç/kapat",
  "browser.address.placeholder": "Adres ara veya gir",
  "browser.nav.back": "Geri",
  "browser.nav.forward": "İleri",
  "browser.nav.reload": "Yenile",
  "browser.nav.stop": "Durdur",
  "browser.nav.newTab": "Yeni sekme",
  ...
  "browser.panel.empty": "Açık sayfa yok",
  "browser.panel.unavailable": "Tarayıcı yalnızca masaüstü uygulamasında kullanılabilir",
  "browser.mode.fill": "Doldur",
  "browser.mode.freeform": "Serbest",
  "browser.mode.preset": "Hazır ayar",
  "browser.viewportMode": "Görünüm modu",
  "browser.rotate": "Döndür",
  "browser.aspectLock": "En-boy oranını kilitle",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "Rozetler",
  "browser.badges.toggle": "Öğe rozetlerini aç/kapat",
  ...
  "browser.resize.left": "Sol kenardan yeniden boyutlandır",
  "browser.resize.right": "Sağ kenardan yeniden boyutlandır",
  "browser.resize.bottom": "Alt kenardan yeniden boyutlandır",
  "browser.resize.bottom-left": "Sol alt köşeden yeniden boyutlandır",
  "browser.resize.bottom-right": "Sağ alt köşeden yeniden boyutlandır",
  "browser.crash.title": "Bu sayfa çöktü",
  "browser.crash.reload": "Sayfayı yenile",
  "browser.action.running": "Çalışıyor",
  "browser.action.succeeded": "Başarılı",
  "browser.action.failed": "Başarısız",
  "browser.action.interrupted": "Kesildi",
  "browser.summary.interactive": "Etkileşimli",
  "browser.summary.forms": "Formlar",
  "browser.summary.consoleErrors": "Konsol hataları",
  "browser.summary.failedRequests": "Başarısız istekler",
  ...
  "dialog.credential.manageKeys": "API anahtarlarını yönet",
  "dialog.credential.title": "OpenCode API anahtarları",
  "dialog.credential.description": "Bağlı OpenCode API anahtarları arasında geçiş yapın veya kaydettiklerinizi yönetin.",
  "dialog.credential.active": "Etkin",
  "dialog.credential.select": "Bu anahtara geç",
  "dialog.credential.rename": "Yeniden adlandır",
  "dialog.credential.remove": "Kaldır",
  "dialog.credential.add": "API anahtarı ekle",
  "dialog.credential.rename.placeholder": "Etiket",
  "dialog.credential.empty": "Henüz bağlı API anahtarı yok.",
  "provider.connect.apiKey.labelName": "Etiket",
  "provider.connect.apiKey.labelPlaceholder": "örn. Kişisel, İş",
  ...
  "dialog.titlePrompt.default": "Varsayılan istem",
  "dialog.titlePrompt.token.previousTitle": "Geçerli oturum başlığıyla değiştirilir",
  "dialog.titlePrompt.token.conversation": "Atlasan bile her zaman eklenir",
  "usage.go.title": "OpenCode Go kullanımı",
  "usage.window.5h": "5 saat",
  "usage.window.week": "Haftalık",
  "usage.window.month": "Aylık",
  "usage.calls.one": "{{count}} çağrı",
  "usage.calls.other": "{{count}} çağrı",
  "usage.reset": "Sıfırla",
  "usage.clear": "Temizle",
  "usage.reset.predicted": "Tahmin",
  ...
  "dialog.titlePrompt.title": "Başlık oluşturma istemi",
  "dialog.titlePrompt.description": "Başlık modeli için talimatlar. Sohbet her zaman eklenir; {previousTitle}, geçerli başlıkla değiştirilir.",
  "dialog.titlePrompt.placeholder": "Özel talimatlar (boş = varsayılan istem)",
  "dialog.titlePrompt.reset": "Varsayılana sıfırla",
  ...
  "session.tab.changes": "İnceleme",
  "session.tab.context": "Bağlam",
  "session.tab.unknown": "Bilinmeyen Oturum",
  "session.panel.fileBrowser": "İnceleme ve dosyalar",
  ...
  "session.changes.filesChanged": "{{count}} dosya değişti",
  "session.changes.change.one": "Değişiklik",
  "session.changes.change.other": "Değişiklik",
  "session.changes.loadingChanges": "Değişiklikler yükleniyor...",
  "session.changes.empty": "Bu oturumda henüz değişiklik yok",
  "session.changes.noVcs": "Git VCS algılanamadı, oturum değişiklikleri tespit edilemeyecek",
  ...
  "session.changes.noChanges": "Değişiklik yok",
  "session.changes.noUncommittedChanges": "Henüz işlenmemiş değişiklik yok",
  "session.changes.noBranchChanges": "Henüz dal değişikliği yok",
  ...
  "settings.general.section.titleGeneration": "Başlık oluşturma",
  ...
  "settings.general.row.titleModel.title": "Başlık modeli",
  "settings.general.row.titleModel.description": "Oturum başlıklarını oluşturmak ve yeniden oluşturmak için kullanılan model",
  "settings.general.row.titleModel.default": "Varsayılan (küçük model)",
  "settings.general.row.titlePrompt.edit": "İstemi düzenle",
  ...
  "toast.title.regenerated": "Oturum başlığı güncellendi",
  "toast.title.failed": "Oturum başlığı oluşturulamadı",
  "toast.title.keepExisting": "Başlık korundu — oluşturma sırasında değişti",
  ...
  "session.changes.noVcs.createGit.title": "Git deposu oluştur",
  "session.changes.noVcs.createGit.description": "Bu projedeki değişiklikleri takip et, incele ve geri al",
  "session.changes.noVcs.createGit.actionLoading": "Git deposu oluşturuluyor...",
  "session.changes.noVcs.createGit.action": "Git deposu oluştur",
