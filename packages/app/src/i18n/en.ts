...
export const dict = {
  ...
  "projectExplorer.editor.saveUnavailable.description": "Backend support for writing files is in progress. Your changes are kept in this tab.",
  ...
  "command.fileTree.toggle": "Toggle file tree",  "command.context.toggle": "Toggle context",
  ...
  "provider.connect.claudeSubscription.description": "Claude Subscription uses the official Claude CLI. No API key is entered or stored by OpenCode.",
  "provider.connect.claudeSubscription.return": "Run this command in a terminal, complete the CLI login, then return here to use Claude Subscription.",
  "provider.connect.toast.claudeSubscription.title": "Claude Subscription ready",
  "provider.connect.toast.claudeSubscription.description": "OpenCode will use your existing Claude CLI login automatically.",
  ...
  "dialog.credential.description": "Switch between your connected OpenCode API keys, or manage the ones you have saved.",
  ...
  "models.compare.pricingNote": "Prices are per 1M tokens. Cheapest is input + output blended; cache and tiered pricing may vary.",
  ...
  "model.tooltip.usageYield.hint": "Standardized coding-agent requests per $1 (Usage Yield V2, median of 16 Go workloads)",
