export const dict = {
  ...
  "command.fileTree.toggle": "Fayl ağacını aç/bağla",  "command.terminal.new": "Yeni terminal",
  ...
  "dialog.credential.manageKeys": "API açarlarını idarə et",
  "dialog.credential.title": "OpenCode API açarları",
  "dialog.credential.description": "Qoşulmuş OpenCode API açarları arasında keçin və ya saxlananları idarə edin.",
  "dialog.credential.active": "Aktiv",
  "dialog.credential.select": "Bu açara keç",
  "dialog.credential.rename": "Yenidən adlandır",
  "dialog.credential.remove": "Sil",
  "dialog.credential.add": "API açarı əlavə et",
  "dialog.credential.rename.placeholder": "Etiket",
  "dialog.credential.empty": "Hələ qoşulmuş API açarı yoxdur.",
  "provider.connect.apiKey.labelName": "Etiket",
  "provider.connect.apiKey.labelPlaceholder": "məs. Şəxsi, İş",
  ...
  "dialog.titlePrompt.token.previousTitle": "Cari sessiya başlığı ilə əvəz olunur",
  "dialog.titlePrompt.token.conversation": "Buraxsanız da həmişə əlavə olunur",
  "usage.go.title": "OpenCode Go istifadəsi",
  "usage.window.5h": "5 saat",
  "usage.window.week": "Həftəlik",
  "usage.window.month": "Aylıq",
  "usage.calls.one": "{{count}} zəng",
  "usage.calls.other": "{{count}} zəng",
  "usage.reset": "Sıfırla",
  "usage.clear": "Təmizlə",
  "usage.reset.predicted": "Proqnozlaşdırılan",
  ...
  "dialog.titlePrompt.title": "Başlıq yaratma promptu",
  "dialog.titlePrompt.description": "Başlıq modeli üçün təlimatlar. Söhbət həmişə əlavə olunur; {previousTitle} cari başlıqla əvəz olunur.",
  "dialog.titlePrompt.placeholder": "Xüsusi təlimatlar (boş = standart prompt)",
  "dialog.titlePrompt.reset": "Standarta sıfırla",
  ...
  "toast.title.regenerated": "Sessiya başlığı yeniləndi",
  "toast.title.failed": "Sessiya başlığı yaradıla bilmədi",
  "toast.title.keepExisting": "Başlıq saxlanıldı — yaratma zamanı dəyişdi",
  ...
  "session.tab.changes": "İcmal",
  "session.tab.context": "Kontekst",
  "session.tab.unknown": "Naməlum sessiya",
  "session.panel.fileBrowser": "İcmal və fayllar",
  ...
  "session.changes.filesChanged": "{{count}} fayl dəyişdi",
  "session.changes.change.one": "Dəyişiklik",
  "session.changes.change.other": "Dəyişikliklər",
  "session.changes.loadingChanges": "Dəyişikliklər yüklənir...",
  "session.changes.empty": "Bu sessiyada hələ dəyişiklik yoxdur",
  "session.changes.noVcs": "Git versiyaya nəzarət sistemi aşkarlanmadı; sessiya dəyişiklikləri göstərilməyəcək",
  "session.changes.noVcs.createGit.title": "Git repozitoriyası yaradın",
  "session.changes.noVcs.createGit.description": "Bu layihədə dəyişiklikləri izləyin, nəzərdən keçirin və ləğv edin",
  "session.changes.noVcs.createGit.actionLoading": "Git repozitoriyası yaradılır...",
  "session.changes.noVcs.createGit.action": "Git repozitoriyası yaradın",
  ...
  "session.changes.noChanges": "Dəyişiklik yoxdur",
  "session.changes.noUncommittedChanges": "Hələ commit edilməmiş dəyişiklik yoxdur",
  "session.changes.noBranchChanges": "Hələ branch dəyişikliyi yoxdur",
  ...
  "settings.general.section.titleGeneration": "Başlıq yaradılması",
  ...
  "settings.general.row.titleModel.title": "Başlıq modeli",
  "settings.general.row.titleModel.description": "Sessiya başlıqlarını yaratmaq və yenidən yaratmaq üçün istifadə olunan model",
  "settings.general.row.titleModel.default": "Standart (kiçik model)",
  "settings.general.row.titlePrompt.edit": "Prompti redaktə et",
