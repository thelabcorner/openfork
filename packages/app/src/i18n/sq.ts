export const dict = {
  ...
  "command.fileTree.toggle": "Ndrysho pemën e skedarit",  "command.terminal.new": "Terminali i ri",
  ...
  "dialog.credential.manageKeys": "Menaxho çelësat API",
  "dialog.credential.title": "Çelësat OpenCode API",
  "dialog.credential.description": "Kalo midis çelësave OpenCode API të lidhur ose menaxho të ruajturit.",
  "dialog.credential.active": "Aktiv",
  "dialog.credential.select": "Kalo te ky çelës",
  "dialog.credential.rename": "Ri-emërto",
  "dialog.credential.remove": "Hiq",
  "dialog.credential.add": "Shto çelës API",
  "dialog.credential.rename.placeholder": "Etiketë",
  "dialog.credential.empty": "Ende nuk ka çelësa API të lidhur.",
  "provider.connect.apiKey.labelName": "Etiketë",
  "provider.connect.apiKey.labelPlaceholder": "p.sh. Personal, Punë",
  ...
  "dialog.titlePrompt.default": "Prompt parazgjedhur",
  "dialog.titlePrompt.token.previousTitle": "Zëvendësohet me titullin aktual të sesionit",
  "dialog.titlePrompt.token.conversation": "Bashkëngjitet gjithmonë, edhe nëse e lini jashtë",
  "usage.go.title": "Përdorimi i OpenCode Go",
  "usage.window.5h": "5 orë",
  "usage.window.week": "Javore",
  "usage.window.month": "Mujore",
  "usage.calls.one": "{{count}} thirrje",
  "usage.calls.other": "{{count}} thirrje",
  "usage.reset": "Rivendos",
  "usage.clear": "Pastro",
  "usage.reset.predicted": "Parashikuar",
  ...
  "dialog.titlePrompt.title": "Prompt për gjenerimin e titullit",
  "dialog.titlePrompt.description": "Udhëzime për modelin e titujve. Biseda bashkëngjitet gjithmonë; {previousTitle} zëvendësohet me titullin aktual.",
  "dialog.titlePrompt.placeholder": "Udhëzime të personalizuara (bosh = prompt parazgjedhur)",
  "dialog.titlePrompt.reset": "Rivendos te parazgjedhura",
  ...
  "toast.title.regenerated": "Titulli i sesionit u përditësua",
  "toast.title.failed": "Dështoi gjenerimi i titullit të sesionit",
  "toast.title.keepExisting": "Titulli u ruajt — ndryshoi gjatë gjenerimit",
  ...
  "session.tab.changes": "Rishikimi",
  "session.tab.context": "Konteksti",
  "session.tab.unknown": "Sesion i panjohur",
  "session.panel.fileBrowser": "Rishikimi dhe dosjet",
  ...
  "session.changes.filesChanged": "Skedarët u ndryshuan {{count}}",
  "session.changes.change.one": "Ndryshimi",
  "session.changes.change.other": "Ndryshimet",
  "session.changes.loadingChanges": "Ndryshimet po ngarkohen...",
  "session.changes.empty": "Ende nuk ka ndryshime në këtë seancë",
  "session.changes.noVcs": "Nuk u zbulua sistemi i kontrollit të versionit Git, ndryshimet nuk shfaqen",
  "session.changes.noVcs.createGit.title": "Krijoni një depo Git",
  "session.changes.noVcs.createGit.description": "Gjurmoni, rishikoni dhe anuloni ndryshimet në këtë projekt",
  "session.changes.noVcs.createGit.actionLoading": "Krijimi i depove Git...",
  "session.changes.noVcs.createGit.action": "Krijo depo Git",
  ...
  "session.changes.noChanges": "Nuk ka ndryshime",
  "session.changes.noUncommittedChanges": "Ende nuk ka ndryshime të pazgjedhura",
  "session.changes.noBranchChanges": "Ende nuk ka ndryshime në degë",
  ...
  "settings.general.section.titleGeneration": "Gjenerimi i titujve",
  ...
  "settings.general.row.titleModel.title": "Modeli i titujve",
  "settings.general.row.titleModel.description": "Modeli i përdorur për të gjeneruar dhe rigjeneruar titujt e sesioneve",
  "settings.general.row.titleModel.default": "Parazgjedhur (model i vogël)",
  "settings.general.row.titlePrompt.edit": "Ndrysho promptin",
