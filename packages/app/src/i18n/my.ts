export const dict = {
  ...
  "command.fileTree.toggle": "ဖိုင်သစ်ပြောင်းရန်",  "command.terminal.new": "Terminal အသစ်",
  ...
  "dialog.credential.manageKeys": "API သော့များကို စီမံရန်",
  "dialog.credential.title": "OpenCode API သော့များ",
  "dialog.credential.description": "ချိတ်ဆက်ထားသော OpenCode API သော့များကြား ပြောင်းပါ သို့မဟုတ် သိမ်းထားသော သော့များကို စီမံပါ။",
  "dialog.credential.active": "အသုံးပြုနေ",
  "dialog.credential.select": "ဤသော့သို့ ပြောင်းရန်",
  "dialog.credential.rename": "အမည်ပြောင်း",
  "dialog.credential.remove": "ဖယ်ရှား",
  "dialog.credential.add": "API သော့ထည့်ရန်",
  "dialog.credential.rename.placeholder": "တံဆိပ်",
  "dialog.credential.empty": "API သော့ ချိတ်ဆက်ထားခြင်း မရှိသေးပါ။",
  "provider.connect.apiKey.labelName": "တံဆိပ်",
  "provider.connect.apiKey.labelPlaceholder": "ဥပမာ- ကိုယ်ရေးကိုယ်တာ၊ အလုပ်",
  ...
  "dialog.titlePrompt.default": "ပုံမှန် ပရောမ့်တ်",
  "dialog.titlePrompt.token.previousTitle": "လက်ရှိ ဆက်ရှင် ခေါင်းစဉ်ဖြင့် အစားထိုးသည်",
  "dialog.titlePrompt.token.conversation": "ချန်လှပ်ထားလျှင်ပင် အမြဲ ပူးတွဲသည်",
  "usage.go.title": "OpenCode Go အသုံးပြုမှု",
  "usage.window.5h": "၅ နာရီ",
  "usage.window.week": "အပတ်စဉ်",
  "usage.window.month": "လစဉ်",
  "usage.calls.one": "{{count}} ခေါ်ဆိုမှု",
  "usage.calls.other": "{{count}} ခေါ်ဆိုမှု",
  "usage.reset": "ပြန်လည်သတ်မှတ်",
  "usage.clear": "ရှင်းလင်း",
  "usage.reset.predicted": "ခန့်မှန်းထား",
  ...
  "dialog.titlePrompt.title": "ခေါင်းစဉ် ထုတ်လုပ်သည့် ပရောမ့်တ်",
  "dialog.titlePrompt.description": "ခေါင်းစဉ် မော်ဒယ်အတွက် ညွှန်ကြားချက်များ။ စကားဝိုင်းကို အမြဲ ပူးတွဲထားသည်။ {previousTitle} ကို လက်ရှိ ခေါင်းစဉ်ဖြင့် အစားထိုးသည်။",
  "dialog.titlePrompt.placeholder": "စိတ်ကြိုက် ညွှန်ကြားချက်များ (ဗလာ = ပုံမှန် ပရောမ့်တ်)",
  "dialog.titlePrompt.reset": "ပုံမှန်သို့ ပြန်လည်သတ်မှတ်ရန်",
  ...
  "toast.title.regenerated": "ဆက်ရှင် ခေါင်းစဉ် အပ်ဒိတ်လုပ်ပြီးပြီ",
  "toast.title.failed": "ဆက်ရှင် ခေါင်းစဉ် ထုတ်လုပ်ရန် မအောင်မြင်ပါ",
  "toast.title.keepExisting": "ခေါင်းစဉ် ထိန်းသိမ်းထားသည် — ထုတ်လုပ်နေစဉ် ပြောင်းလဲသွားသည်",
  ...
  "session.tab.changes": "သုံးသပ်ချက်",
  "session.tab.context": "ဆက်စပ်အကြောင်းအရာ",
  "session.tab.unknown": "အမည်မသိ ဆက်ရှင်",
  "session.panel.fileBrowser": "ပြန်လည်သုံးသပ်ခြင်းနှင့် ဖိုင်များ",
  ...
  "session.changes.filesChanged": "ဖိုင်များကို {{count}} ပြောင်းထားသည်။",
  "session.changes.change.one": "ပြောင်းလဲခြင်း။",
  "session.changes.change.other": "ပြောင်းလဲမှုများ",
  "session.changes.loadingChanges": "အပြောင်းအလဲများကို ဖွင့်နေသည်...",
  "session.changes.empty": "ဤစက်ရှင်တွင် ပြောင်းလဲမှုမရှိသေးပါ။",
  "session.changes.noVcs": "မည်သည့် Git ဗားရှင်းထိန်းချုပ်မှုစနစ်မှ ရှာမတွေ့ပါ၊ အပြောင်းအလဲများကို မပြသပါ။",
  "session.changes.noVcs.createGit.title": "Git repository တစ်ခုဖန်တီးပါ။",
  "session.changes.noVcs.createGit.description": "ဤပရောဂျက်ရှိ အပြောင်းအလဲများကို ခြေရာခံ၊ သုံးသပ်ပြီး ပြန်ဖျက်ပါ။",
  "session.changes.noVcs.createGit.actionLoading": "Git repository ကို ဖန်တီးနေသည်...",
  "session.changes.noVcs.createGit.action": "Git repository ဖန်တီးပါ။",
  ...
  "session.changes.noChanges": "အပြောင်းအလဲမရှိပါ။",
  "session.changes.noUncommittedChanges": "ကတိကဝတ်မပြုထားသော အပြောင်းအလဲများ မရှိသေးပါ။",
  "session.changes.noBranchChanges": "ဌာနခွဲပြောင်းလဲမှုမရှိသေးပါ။",
  ...
  "settings.general.section.titleGeneration": "ခေါင်းစဉ် ထုတ်လုပ်ခြင်း",
  ...
  "settings.general.row.titleModel.title": "ခေါင်းစဉ် မော်ဒယ်",
  "settings.general.row.titleModel.description": "ဆက်ရှင် ခေါင်းစဉ်များ ထုတ်လုပ်ရန်နှင့် ပြန်လည်ထုတ်လုပ်ရန် အသုံးပြုသည့် မော်ဒယ်",
  "settings.general.row.titleModel.default": "ပုံမှန် (မော်ဒယ်ငယ်)",
  "settings.general.row.titlePrompt.edit": "ပရောမ့်တ် တည်းဖြတ်ရန်",
