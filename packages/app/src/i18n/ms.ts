export const dict = {
  ...
  "command.fileTree.toggle": "Togol pokok fail",  "command.terminal.new": "Terminal baharu",
  ...
  "dialog.credential.manageKeys": "Urus kunci API",
  "dialog.credential.title": "Kunci API OpenCode",
  "dialog.credential.description": "Tukar antara kunci API OpenCode yang disambungkan atau urus yang disimpan.",
  "dialog.credential.active": "Aktif",
  "dialog.credential.select": "Tukar ke kunci ini",
  "dialog.credential.rename": "Namakan semula",
  "dialog.credential.remove": "Alih keluar",
  "dialog.credential.add": "Tambah kunci API",
  "dialog.credential.rename.placeholder": "Label",
  "dialog.credential.empty": "Belum ada kunci API yang disambungkan.",
  "provider.connect.apiKey.labelName": "Label",
  "provider.connect.apiKey.labelPlaceholder": "cth. Peribadi, Kerja",
  ...
  "dialog.titlePrompt.default": "Prompt lalai",
  "dialog.titlePrompt.token.previousTitle": "Digantikan dengan tajuk sesi semasa",
  "dialog.titlePrompt.token.conversation": "Sentiasa dilampirkan, walaupun anda meninggalkannya",
  ...
  "usage.reset": "Tetapkan semula",
  "usage.clear": "Kosongkan",
  "usage.reset.predicted": "Diramal",
  ...
  "dialog.titlePrompt.title": "Prompt penjanaan tajuk",
  "dialog.titlePrompt.description": "Arahan untuk model tajuk. Perbualan sentiasa dilampirkan; {previousTitle} digantikan dengan tajuk semasa.",
  "dialog.titlePrompt.placeholder": "Arahan tersuai (kosong = prompt lalai)",
  "dialog.titlePrompt.reset": "Tetapkan semula kepada lalai",
  ...
  "toast.title.regenerated": "Tajuk sesi dikemas kini",
  "toast.title.failed": "Gagal menjana tajuk sesi",
  "toast.title.keepExisting": "Tajuk dikekalkan — ia berubah semasa penjanaan",
  ...
  "session.changes.filesChanged": "{{count}} Fail Diubah",
  ...
  "session.changes.empty": "Belum ada perubahan dalam sesi ini",
  "session.changes.noVcs": "Tiada Sistem Kawalan Versi Git dikesan, perubahan tidak dipaparkan",
  "session.changes.noVcs.createGit.title": "Cipta repositori Git",
  "session.changes.noVcs.createGit.description": "Jejak, semak dan undur perubahan dalam projek ini",
  "session.changes.noVcs.createGit.actionLoading": "Mencipta repositori Git...",
  "session.changes.noVcs.createGit.action": "Cipta repositori Git",
  "session.changes.noSnapshot": "Penjejakan snapshot dilumpuhkan dalam tetapan, jadi perubahan sesi tidak tersedia",
  "session.changes.noChanges": "Tiada perubahan",
  "session.changes.noUncommittedChanges": "Belum ada perubahan belum komited",
  "session.changes.noBranchChanges": "Belum ada perubahan cawangan",
  ...
  "settings.general.section.titleGeneration": "Penjanaan tajuk",
  ...
  "settings.general.row.titleModel.title": "Model tajuk",
  "settings.general.row.titleModel.description": "Model yang digunakan untuk menjana dan menjana semula tajuk sesi",
  "settings.general.row.titleModel.default": "Lalai (model kecil)",
