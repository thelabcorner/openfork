export const dict = {
  ...
  "command.fileTree.toggle": "Basculer l'arborescence des fichiers",  "command.terminal.new": "Nouveau terminal",
  ...
  "command.browser.toggle": "Basculer le navigateur",
  "browser.address.placeholder": "Rechercher ou saisir une adresse",
  "browser.nav.back": "Précédent",
  "browser.nav.forward": "Suivant",
  "browser.nav.reload": "Actualiser",
  "browser.nav.stop": "Arrêter",
  "browser.nav.newTab": "Nouvel onglet",
  ...
  "browser.panel.empty": "Aucune page ouverte",
  "browser.panel.unavailable": "Le navigateur est uniquement disponible dans l'application de bureau",
  "browser.mode.fill": "Remplir",
  "browser.mode.freeform": "Libre",
  "browser.mode.preset": "Préréglage",
  "browser.viewportMode": "Mode d'affichage",
  "browser.rotate": "Pivoter",
  "browser.aspectLock": "Verrouiller le rapport hauteur/largeur",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "Badges",
  "browser.badges.toggle": "Basculer les badges d'éléments",
  ...
  "browser.resize.left": "Redimensionner depuis le bord gauche",
  "browser.resize.right": "Redimensionner depuis le bord droit",
  "browser.resize.bottom": "Redimensionner depuis le bord inférieur",
  "browser.resize.bottom-left": "Redimensionner depuis le coin inférieur gauche",
  "browser.resize.bottom-right": "Redimensionner depuis le coin inférieur droit",
  "browser.crash.title": "Cette page a planté",
  "browser.crash.reload": "Recharger la page",
  "browser.action.running": "En cours",
  "browser.action.succeeded": "Réussi",
  "browser.action.failed": "Échoué",
  "browser.action.interrupted": "Interrompu",
  "browser.summary.interactive": "Interactifs",
  "browser.summary.forms": "Formulaires",
  "browser.summary.consoleErrors": "Erreurs de console",
  "browser.summary.failedRequests": "Requêtes échouées",
  ...
  "dialog.credential.manageKeys": "Gérer les clés API",
  "dialog.credential.title": "Clés API OpenCode",
  "dialog.credential.description": "Basculez entre vos clés API OpenCode connectées ou gérez celles que vous avez enregistrées.",
  "dialog.credential.active": "Active",
  "dialog.credential.select": "Passer à cette clé",
  "dialog.credential.rename": "Renommer",
  "dialog.credential.remove": "Supprimer",
  "dialog.credential.add": "Ajouter une clé API",
  "dialog.credential.rename.placeholder": "Libellé",
  "dialog.credential.empty": "Aucune clé API connectée pour le moment.",
  "provider.connect.apiKey.labelName": "Libellé",
  "provider.connect.apiKey.labelPlaceholder": "p. ex. Personnel, Travail",
  ...
  "dialog.titlePrompt.default": "Prompt par défaut",
  "dialog.titlePrompt.token.previousTitle": "Remplacé par le titre actuel de la session",
  "dialog.titlePrompt.token.conversation": "Toujours joint, même si vous l'omettez",
  "usage.go.title": "Utilisation d'OpenCode Go",
  "usage.window.5h": "5 heures",
  "usage.window.week": "Hebdomadaire",
  "usage.window.month": "Mensuel",
  "usage.calls.one": "{{count}} appel",
  "usage.calls.other": "{{count}} appels",
  "usage.calls.many": "{{count}} appels",
  "usage.reset": "Réinitialiser",
  "usage.clear": "Effacer",
  "usage.reset.predicted": "Prévu",
  ...
  "dialog.titlePrompt.title": "Prompt de génération de titre",
  "dialog.titlePrompt.description": "Instructions pour le modèle de titre. La conversation est toujours jointe ; {previousTitle} est remplacé par le titre actuel.",
  "dialog.titlePrompt.placeholder": "Instructions personnalisées (vide = prompt par défaut)",
  "dialog.titlePrompt.reset": "Rétablir le défaut",
  ...
  "session.tab.changes": "Revue",
  "session.tab.context": "Contexte",
  "session.tab.unknown": "Session inconnue",
  "session.panel.fileBrowser": "Revue et fichiers",
  ...
  "session.changes.filesChanged": "{{count}} fichiers modifiés",
  "session.changes.change.one": "Modification",
  "session.changes.change.other": "Modifications",
  "session.changes.loadingChanges": "Chargement des modifications...",
  "session.changes.empty": "Aucune modification dans cette session pour l'instant",
  "session.changes.noChanges": "Aucune modification",
  "session.changes.noUncommittedChanges": "Aucune modification non validée pour l'instant",
  "session.changes.noBranchChanges": "Aucune modification de branche pour l'instant",
  "session.changes.noVcs": "Aucun système de gestion de versions Git détecté ; modifications non affichées",
  ...
  "settings.general.section.titleGeneration": "Génération de titre",
  ...
  "settings.general.row.titleModel.title": "Modèle de titre",
  "settings.general.row.titleModel.description": "Modèle utilisé pour générer et régénérer les titres de session",
  "settings.general.row.titleModel.default": "Par défaut (petit modèle)",
  "settings.general.row.titlePrompt.edit": "Modifier le prompt",
  ...
  "toast.title.regenerated": "Titre de la session mis à jour",
  "toast.title.failed": "Échec de la génération du titre de la session",
  "toast.title.keepExisting": "Titre conservé : il a changé pendant la génération",
  ...
  "session.changes.noVcs.createGit.title": "Créer un dépôt Git",
  "session.changes.noVcs.createGit.description": "Suivre, examiner et annuler les modifications dans ce projet",
  "session.changes.noVcs.createGit.actionLoading": "Création du dépôt Git...",
  "session.changes.noVcs.createGit.action": "Créer un dépôt Git",
