export const dict: Record<string, string> = {
  ...
  "command.fileTree.toggle": "फाइल रूख टगल गर्नुहोस्",  "command.terminal.new": "नयाँ टर्मिनल",
  ...
  "dialog.credential.manageKeys": "API कुञ्जीहरू व्यवस्थापन गर्नुहोस्",
  "dialog.credential.title": "OpenCode API कुञ्जीहरू",
  "dialog.credential.description": "जडान गरिएका OpenCode API कुञ्जीहरूबीच स्विच गर्नुहोस् वा सुरक्षित गरिएकाहरू व्यवस्थापन गर्नुहोस्।",
  "dialog.credential.active": "सक्रिय",
  "dialog.credential.select": "यो कुञ्जीमा स्विच गर्नुहोस्",
  "dialog.credential.rename": "नाम बदल्नुहोस्",
  "dialog.credential.remove": "हटाउनुहोस्",
  "dialog.credential.add": "API कुञ्जी थप्नुहोस्",
  "dialog.credential.rename.placeholder": "लेबल",
  "dialog.credential.empty": "अहिलेसम्म कुनै API कुञ्जी जडान भएको छैन।",
  "provider.connect.apiKey.labelName": "लेबल",
  "provider.connect.apiKey.labelPlaceholder": "जस्तै: व्यक्तिगत, काम",
  ...
  "dialog.titlePrompt.default": "पूर्वनिर्धारित प्रम्प्ट",
  "dialog.titlePrompt.token.previousTitle": "हालको सत्र शीर्षकले प्रतिस्थापन हुन्छ",
  "dialog.titlePrompt.token.conversation": "छोड्दा पनि सधैं संलग्न हुन्छ",
  "usage.go.title": "OpenCode Go प्रयोग",
  "usage.window.5h": "५ घण्टा",
  "usage.window.week": "साप्ताहिक",
  "usage.window.month": "मासिक",
  "usage.calls.one": "{{count}} कल",
  "usage.calls.other": "{{count}} कलहरू",
  "usage.reset": "रिसेट गर्नुहोस्",
  "usage.clear": "खाली गर्नुहोस्",
  ...
  "dialog.titlePrompt.title": "शीर्षक निर्माण प्रम्प्ट",
  "dialog.titlePrompt.description": "शीर्षक मोडेलका लागि निर्देशनहरू। कुराकानी सधैं संलग्न हुन्छ; {previousTitle} हालको शीर्षकले प्रतिस्थापन हुन्छ।",
  "dialog.titlePrompt.placeholder": "अनुकूल निर्देशनहरू (खाली = पूर्वनिर्धारित प्रम्प्ट)",
  "dialog.titlePrompt.reset": "पूर्वनिर्धारितमा रिसेट गर्नुहोस्",
  ...
  "toast.title.regenerated": "सत्र शीर्षक अद्यावधिक गरियो",
  "toast.title.failed": "सत्र शीर्षक उत्पन्न गर्न असफल",
  "toast.title.keepExisting": "शीर्षक राखियो — निर्माणका क्रममा परिवर्तन भयो",
  ...
  "session.tab.changes": "समीक्षा गर्नुहोस्",
  "session.tab.context": "सन्दर्भ",
  "session.tab.unknown": "अज्ञात सत्र",
  "session.panel.fileBrowser": "समीक्षा र फाइलहरू",
  ...
  "session.changes.filesChanged": "फाइलहरू परिवर्तन गरियो {{count}}",
  "session.changes.change.one": "परिवर्तन गर्नुहोस्",
  "session.changes.change.other": "परिवर्तनहरू",
  "session.changes.loadingChanges": "परिवर्तनहरू लोड गर्दै...",
  "session.changes.empty": "यस सत्रमा अझै कुनै परिवर्तन छैन",
  "session.changes.noVcs": "कुनै Git संस्करण नियन्त्रण प्रणाली पत्ता लागेन, परिवर्तनहरू प्रदर्शित भएन",
  "session.changes.noVcs.createGit.title": "एउटा Git भण्डार सिर्जना गर्नुहोस्",
  ...
  "session.changes.noVcs.createGit.actionLoading": "Git भण्डार सिर्जना गर्दै...",
  "session.changes.noVcs.createGit.action": "Git भण्डार सिर्जना गर्नुहोस्",
  "session.changes.noSnapshot":
    "स्न्यापसट ट्र्याकिङ कन्फिगरेसनमा असक्षम गरिएको छ, त्यसैले सत्र परिवर्तनहरू उपलब्ध छैनन्",
  "session.changes.noChanges": "कुनै परिवर्तन छैन",
  "session.changes.noUncommittedChanges": "अहिलेसम्म कुनै पनि असीमित परिवर्तनहरू छैनन्",
  "session.changes.noBranchChanges": "अझै शाखा परिवर्तन भएको छैन",
  ...
  "settings.general.row.titleModel.title": "शीर्षक मोडेल",
  "settings.general.row.titleModel.description": "सत्र शीर्षकहरू उत्पन्न र पुनः उत्पन्न गर्न प्रयोग गरिने मोडेल",
  "settings.general.row.titleModel.default": "पूर्वनिर्धारित (सानो मोडेल)",
  "settings.general.row.titlePrompt.edit": "प्रम्प्ट सम्पादन गर्नुहोस्",
