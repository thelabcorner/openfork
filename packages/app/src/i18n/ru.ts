export const dict = {
  ...
  "command.fileTree.toggle": "Переключить дерево файлов",  "command.terminal.new": "Новый терминал",
  ...
  "command.browser.toggle": "Переключить браузер",
  "browser.address.placeholder": "Поиск или ввод адреса",
  "browser.nav.back": "Назад",
  "browser.nav.forward": "Вперёд",
  "browser.nav.reload": "Перезагрузить",
  "browser.nav.stop": "Остановить",
  "browser.nav.newTab": "Новая вкладка",
  ...
  "browser.panel.empty": "Нет открытых страниц",
  "browser.panel.unavailable": "Браузер доступен только в настольном приложении",
  "browser.mode.fill": "Заполнить",
  "browser.mode.freeform": "Свободный",
  "browser.mode.preset": "Пресет",
  "browser.viewportMode": "Режим области просмотра",
  "browser.rotate": "Повернуть",
  "browser.aspectLock": "Зафиксировать пропорции",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "Значки",
  "browser.badges.toggle": "Переключить значки элементов",
  ...
  "browser.resize.left": "Изменить размер от левого края",
  "browser.resize.right": "Изменить размер от правого края",
  "browser.resize.bottom": "Изменить размер от нижнего края",
  "browser.resize.bottom-left": "Изменить размер от левого нижнего угла",
  "browser.resize.bottom-right": "Изменить размер от правого нижнего угла",
  "browser.crash.title": "Страница аварийно завершилась",
  "browser.crash.reload": "Перезагрузить страницу",
  "browser.action.running": "Выполняется",
  "browser.action.succeeded": "Успешно",
  "browser.action.failed": "Не удалось",
  "browser.action.interrupted": "Прервано",
  "browser.summary.interactive": "Интерактивные",
  "browser.summary.forms": "Формы",
  "browser.summary.consoleErrors": "Ошибки консоли",
  "browser.summary.failedRequests": "Неудачные запросы",
  ...
  "dialog.credential.manageKeys": "Управление ключами API",
  "dialog.credential.title": "Ключи API OpenCode",
  "dialog.credential.description": "Переключайтесь между подключёнными ключами API OpenCode или управляйте сохранёнными.",
  "dialog.credential.active": "Активен",
  "dialog.credential.select": "Переключиться на этот ключ",
  "dialog.credential.rename": "Переименовать",
  "dialog.credential.remove": "Удалить",
  "dialog.credential.add": "Добавить ключ API",
  "dialog.credential.rename.placeholder": "Метка",
  "dialog.credential.empty": "Ключи API ещё не подключены.",
  "provider.connect.apiKey.labelName": "Метка",
  "provider.connect.apiKey.labelPlaceholder": "напр. Личный, Рабочий",
  ...
  "dialog.titlePrompt.default": "Промпт по умолчанию",
  "dialog.titlePrompt.token.previousTitle": "Заменяется текущим заголовком сеанса",
  "dialog.titlePrompt.token.conversation": "Прикрепляется всегда, даже если опустить",
  "usage.go.title": "Использование OpenCode Go",
  "usage.window.5h": "5 часов",
  "usage.window.week": "Неделя",
  "usage.window.month": "Месяц",
  "usage.calls.one": "{{count}} вызов",
  "usage.calls.other": "{{count}} вызовов",
  "usage.calls.few": "{{count}} вызовов",
  "usage.calls.many": "{{count}} вызовов",
  "usage.reset": "Сбросить",
  "usage.clear": "Очистить",
  "usage.reset.predicted": "Прогноз",
  ...
  "dialog.titlePrompt.title": "Промпт генерации заголовка",
  "dialog.titlePrompt.description": "Инструкции для модели заголовков. Разговор всегда прикрепляется; {previousTitle} заменяется текущим заголовком.",
  "dialog.titlePrompt.placeholder": "Свои инструкции (пусто = промпт по умолчанию)",
  "dialog.titlePrompt.reset": "Сбросить к значению по умолчанию",
  ...
  "session.tab.changes": "Обзор",
  "session.tab.context": "Контекст",
  "session.tab.unknown": "Неизвестная сессия",
  "session.panel.fileBrowser": "Обзор и файлы",
  ...
  "session.changes.filesChanged": "Изменено файлов: {{count}}",
  "session.changes.change.one": "Изменение",
  "session.changes.change.other": "Изменения",
  "session.changes.loadingChanges": "Загрузка изменений...",
  "session.changes.empty": "Изменений в этой сессии пока нет",
  "session.changes.noVcs": "Система контроля версий Git не обнаружена, изменения не отображаются",
  "session.changes.noSnapshot": "Отслеживание снимков отключено в настройках, поэтому изменения сессии недоступны",
  "session.changes.noChanges": "Нет изменений",
  "session.changes.noUncommittedChanges": "Пока нет незафиксированных изменений",
  "session.changes.noBranchChanges": "Пока нет изменений в ветке",
  ...
  "settings.general.section.titleGeneration": "Генерация заголовков",
  ...
  "settings.general.row.titleModel.title": "Модель заголовков",
  "settings.general.row.titleModel.description": "Модель для генерации и повторной генерации заголовков сеансов",
  "settings.general.row.titleModel.default": "По умолчанию (маленькая модель)",
  "settings.general.row.titlePrompt.edit": "Изменить промпт",
  ...
  "toast.title.regenerated": "Заголовок сеанса обновлён",
  "toast.title.failed": "Не удалось сгенерировать заголовок сеанса",
  "toast.title.keepExisting": "Заголовок сохранён — он изменился во время генерации",
  ...
  "session.changes.noVcs.createGit.title": "Создать репозиторий Git",
  "session.changes.noVcs.createGit.description": "Отслеживайте, просматривайте и отменяйте изменения в этом проекте",
  "session.changes.noVcs.createGit.actionLoading": "Создание репозитория Git...",
  "session.changes.noVcs.createGit.action": "Создать репозиторий Git",
