...
export const dict = {
  ...
  "command.fileTree.toggle": "Skiptu um skráartré",  "command.terminal.new": "Nýr skjáhermir",
  ...
  "dialog.credential.manageKeys": "Stjórna API-lyklum",
  "dialog.credential.title": "OpenCode API-lyklar",
  "dialog.credential.description": "Skiptu á milli tengdra OpenCode API-lykla eða stjórnaðu þeim sem vistaðir eru.",
  "dialog.credential.active": "Virkur",
  "dialog.credential.select": "Skipta yfir í þennan lykil",
  "dialog.credential.rename": "Endurnefna",
  "dialog.credential.remove": "Fjarlægja",
  "dialog.credential.add": "Bæta við API-lykli",
  "dialog.credential.rename.placeholder": "Miði",
  "dialog.credential.empty": "Engir API-lyklar tengdir enn.",
  "provider.connect.apiKey.labelName": "Miði",
  "provider.connect.apiKey.labelPlaceholder": "t.d. Persónulegur, Vinna",
  ...
  "dialog.titlePrompt.default": "Sjálfgefin skipun",
  "dialog.titlePrompt.token.previousTitle": "Skipt út fyrir núverandi titil lotu",
  "dialog.titlePrompt.token.conversation": "Alltaf hengt við, jafnvel þótt þú sleppir því",
  "usage.go.title": "Notkun OpenCode Go",
  "usage.window.5h": "5 klukkustundir",
  "usage.window.week": "Vikulega",
  "usage.window.month": "Mánaðarlega",
  "usage.calls.one": "{{count}} kall",
  "usage.calls.other": "{{count}} köll",
  "usage.reset": "Endurstilla",
  "usage.clear": "Hreinsa",
  "usage.reset.predicted": "Spáð",
  ...
  "dialog.titlePrompt.title": "Skipun titilmyndunar",
  "dialog.titlePrompt.description": "Leiðbeiningar fyrir titillíkanið. Samtalið er alltaf hengt við; {previousTitle} er skipt út fyrir núverandi titil.",
  "dialog.titlePrompt.placeholder": "Sérsniðnar leiðbeiningar (tómt = sjálfgefin skipun)",
  "dialog.titlePrompt.reset": "Endurstilla í sjálfgefið",
  ...
  "toast.title.regenerated": "Titill lotu uppfærður",
  "toast.title.failed": "Mistókst að búa til titil lotu",
  "toast.title.keepExisting": "Titill varðveittur — hann breyttist meðan á myndun stóð",
  ...
  "session.tab.changes": "Upprifjun",
  "session.tab.context": "Samhengi",
  "session.tab.unknown": "Óþekkt lota",
  "session.panel.fileBrowser": "Yfirferð og skrár",
  ...
  "session.changes.filesChanged": "Skráum breytt {{count}}",
  "session.changes.change.one": "Breyta",
  "session.changes.change.other": "Breytingar",
  "session.changes.loadingChanges": "Hleður breytingum...",
  "session.changes.empty": "Engar breytingar á þessu þingi ennþá",
  "session.changes.noVcs": "Ekkert Git útgáfustýringarkerfi fannst, breytingar ekki birtar",
  "session.changes.noVcs.createGit.title": "Búðu til Git geymslu",
  "session.changes.noVcs.createGit.description": "Fylgstu með, skoðaðu og afturkallaðu breytingar á þessu verkefni",
  "session.changes.noVcs.createGit.actionLoading": "Býr til Git geymslu...",
  "session.changes.noVcs.createGit.action": "Búðu til Git geymslu",
  "session.changes.noSnapshot":
    "Slökkt er á skyndimyndarakningu í stillingum, þannig að lotubreytingar eru ekki tiltækar",
  "session.changes.noChanges": "Engar breytingar",
  "session.changes.noUncommittedChanges": "Engar óbundnar breytingar ennþá",
  "session.changes.noBranchChanges": "Engar greinarbreytingar ennþá",
  ...
  "settings.general.section.titleGeneration": "Titilmyndun",
  ...
  "settings.general.row.titleModel.title": "Titillíkan",
  "settings.general.row.titleModel.description": "Líkan notað til að búa til og endurskapa titla lota",
  "settings.general.row.titleModel.default": "Sjálfgefið (lítið líkan)",
  "settings.general.row.titlePrompt.edit": "Breyta skipun",
