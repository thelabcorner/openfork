export const dict = {
  ...
  "command.fileTree.toggle": "Alihkan pohon berkas",  "command.terminal.new": "Terminal baru",
  ...
  "command.browser.toggle": "Alihkan browser",
  "browser.address.placeholder": "Cari atau masukkan alamat",
  "browser.nav.back": "Mundur",
  "browser.nav.forward": "Maju",
  "browser.nav.reload": "Muat ulang",
  "browser.nav.stop": "Berhenti",
  "browser.nav.newTab": "Tab baru",
  ...
  "browser.panel.empty": "Tidak ada halaman terbuka",
  "browser.panel.unavailable": "Browser hanya tersedia di aplikasi desktop",
  "browser.mode.fill": "Isi",
  "browser.mode.freeform": "Bebas",
  "browser.mode.preset": "Prasetel",
  "browser.viewportMode": "Mode viewport",
  "browser.rotate": "Putar",
  "browser.aspectLock": "Kunci rasio aspek",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "Lencana",
  "browser.badges.toggle": "Alihkan lencana elemen",
  ...
  "browser.resize.left": "Ubah ukuran dari tepi kiri",
  "browser.resize.right": "Ubah ukuran dari tepi kanan",
  "browser.resize.bottom": "Ubah ukuran dari tepi bawah",
  "browser.resize.bottom-left": "Ubah ukuran dari sudut kiri bawah",
  "browser.resize.bottom-right": "Ubah ukuran dari sudut kanan bawah",
  "browser.crash.title": "Halaman ini mogok",
  "browser.crash.reload": "Muat ulang halaman",
  "browser.action.running": "Berjalan",
  "browser.action.succeeded": "Berhasil",
  "browser.action.failed": "Gagal",
  "browser.action.interrupted": "Terputus",
  "browser.summary.interactive": "Interaktif",
  "browser.summary.forms": "Formulir",
  "browser.summary.consoleErrors": "Kesalahan konsol",
  "browser.summary.failedRequests": "Permintaan gagal",
  ...
  "dialog.credential.manageKeys": "Kelola kunci API",
  "dialog.credential.title": "Kunci API OpenCode",
  "dialog.credential.description": "Beralih di antara kunci API OpenCode yang terhubung atau kelola yang tersimpan.",
  "dialog.credential.active": "Aktif",
  "dialog.credential.select": "Beralih ke kunci ini",
  "dialog.credential.rename": "Ubah nama",
  "dialog.credential.remove": "Hapus",
  "dialog.credential.add": "Tambahkan kunci API",
  "dialog.credential.rename.placeholder": "Label",
  "dialog.credential.empty": "Belum ada kunci API yang terhubung.",
  "provider.connect.apiKey.labelName": "Label",
  "provider.connect.apiKey.labelPlaceholder": "mis. Pribadi, Kerja",
  ...
  "dialog.titlePrompt.default": "Prompt bawaan",
  "dialog.titlePrompt.token.previousTitle": "Diganti dengan judul sesi saat ini",
  "dialog.titlePrompt.token.conversation": "Selalu dilampirkan, meski Anda menghilangkannya",
  "usage.go.title": "Penggunaan OpenCode Go",
  "usage.window.5h": "5 jam",
  "usage.window.week": "Mingguan",
  "usage.window.month": "Bulanan",
  "usage.calls.one": "{{count}} panggilan",
  "usage.calls.other": "{{count}} panggilan",
  "usage.reset": "Setel ulang",
  "usage.clear": "Bersihkan",
  "usage.reset.predicted": "Diprediksi",
  ...
  "dialog.titlePrompt.title": "Prompt pembuatan judul",
  "dialog.titlePrompt.description": "Instruksi untuk model judul. Percakapan selalu dilampirkan; {previousTitle} diganti dengan judul saat ini.",
  "dialog.titlePrompt.placeholder": "Instruksi khusus (kosong = prompt bawaan)",
  "dialog.titlePrompt.reset": "Kembalikan ke bawaan",
  ...
  "toast.title.regenerated": "Judul sesi diperbarui",
  "toast.title.failed": "Gagal membuat judul sesi",
  "toast.title.keepExisting": "Judul dipertahankan — berubah saat proses pembuatan",
  ...
  "session.tab.changes": "Tinjauan",
  "session.tab.context": "Konteks",
  "session.tab.unknown": "Sesi Tidak Dikenal",
  "session.panel.fileBrowser": "Tinjauan dan berkas",
  ...
  "session.changes.filesChanged": "{{count}} Berkas Berubah",
  "session.changes.change.one": "Perubahan",
  "session.changes.change.other": "Perubahan",
  "session.changes.loadingChanges": "Memuat perubahan...",
  "session.changes.empty": "Belum ada perubahan di sesi ini",
  "session.changes.noVcs": "Tidak ada sistem kontrol versi Git yang terdeteksi, perubahan tidak ditampilkan",
  "session.changes.noVcs.createGit.title": "Buat repositori Git",
  "session.changes.noVcs.createGit.description": "Lacak, tinjau, dan urungkan perubahan di proyek ini",
  "session.changes.noVcs.createGit.actionLoading": "Membuat repositori Git...",
  "session.changes.noVcs.createGit.action": "Buat repositori Git",
  "session.changes.noSnapshot":
    "Pelacakan snapshot dinonaktifkan di konfigurasi, sehingga perubahan sesi tidak tersedia",
  "session.changes.noChanges": "Tidak ada perubahan",
  "session.changes.noUncommittedChanges": "Belum ada perubahan yang belum dikomit",
  "session.changes.noBranchChanges": "Belum ada perubahan cabang",
  ...
  "settings.general.section.titleGeneration": "Pembuatan judul",
  ...
  "settings.general.row.titleModel.title": "Model judul",
  "settings.general.row.titleModel.description": "Model yang digunakan untuk membuat dan membuat ulang judul sesi",
  "settings.general.row.titleModel.default": "Bawaan (model kecil)",
