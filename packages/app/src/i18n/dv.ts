export const dict = {
  ...
  "command.fileTree.toggle": "ޓޮގްލް ފައިލް ޓްރީ",  "command.terminal.new": "އައު ޓާމިނަލް",
  ...
  "dialog.credential.manageKeys": "އޭޕީއައި ކީތައް ހެދުން",
  "dialog.credential.title": "އޯޕެންކޯޑް އޭޕީއައި ކީތައް",
  "dialog.credential.description": "ގުޅިފައިވާ އޯޕެންކޯޑް އޭޕީއައި ކީތަކާ ދެމެދު ބަދަލުކުރާށެވެ، ނުވަތަ ސައިވްކޮށްފައިވާ ކީތައް ހެދާށެވެ.",
  "dialog.credential.active": "ހީވާގި",
  "dialog.credential.select": "މި ކީއަށް ބަދަލުކުރާށެވެ",
  "dialog.credential.rename": "ނަން ބަދަލުކުރާށެވެ",
  "dialog.credential.remove": "ނެއްޓުން",
  "dialog.credential.add": "އޭޕީއައި ކީއެއް އިތުރުކުރާށެވެ",
  "dialog.credential.rename.placeholder": "ލޭބަލް",
  "dialog.credential.empty": "އަދި އޭޕީއައި ކީތަކެއް ގުޅިފައެއް ނެތެވެ.",
  "provider.connect.apiKey.labelName": "ލޭބަލް",
  "provider.connect.apiKey.labelPlaceholder": "މިސާލު: ޝަޚްސީ، ވަޒީފާ",
  ...
  "dialog.titlePrompt.default": "ޑިފޯލްޓް ޕްރޮމްޕްޓް",
  "dialog.titlePrompt.token.previousTitle": "މިހާރުގެ ސެޝަން ސުރުހީއާ ބަދަލުވެއެވެ",
  "dialog.titlePrompt.token.conversation": "އެއް ކަމުގައިވެސް ހަމައެއްކޮށް ގުޅޭނެއެވެ",
  "usage.go.title": "OpenCode Go ބޭނުންކުރުން",
  "usage.window.5h": "5 ގަޑި",
  "usage.window.week": "ހަފުތާއަކު",
  "usage.window.month": "މަހަކު",
  "usage.calls.one": "{{count}} ކޯލް",
  "usage.calls.other": "{{count}} ކޯލް",
  "usage.reset": "ރީސެޓް",
  "usage.clear": "ސާފު",
  "usage.reset.predicted": "ކުރިމަތިކޮށްގެން",
  ...
  "dialog.titlePrompt.title": "ސުރުހީ އުފެއްދުމުގެ ޕްރޮމްޕްޓް",
  "dialog.titlePrompt.description": "ސުރުހީ މޮޑެލަށް އަންގައިދިނުން. މުހާތަބާ ހަމައެއްކޮށް ގުޅޭނެ؛ {previousTitle} އެކީ މިހާރުގެ ސުރުހީއާ ބަދަލުވާނެ.",
  "dialog.titlePrompt.placeholder": "އަމިއްލަ އަންގައިދިނުން (ހުސް = ޑިފޯލްޓް ޕްރޮމްޕްޓް)",
  "dialog.titlePrompt.reset": "ޑިފޯލްޓަށް ރީސެޓް ކުރޭ",
  ...
  "toast.title.regenerated": "ސެޝަން ސުރުހީ އަޕްޑޭޓް ކުރެވުނު",
  "toast.title.failed": "ސެޝަން ސުރުހީ އުފެއްދުމަށް ނުކުޅެދުނު",
  "toast.title.keepExisting": "ސުރުހީ ބެހެއްޓިފައި — އުފެއްދުމުގައި އެ ބަދަލުވެފައި ވެއްޖެ",
  ...
  "session.tab.changes": "ރިވިއު",
  "session.tab.context": "ކޮންޓެކްސްޓް",
  "session.tab.unknown": "ނޭނގޭ ސެޝަނެއް",
  "session.panel.fileBrowser": "ރިވިއުކޮށް ފައިލްކުރުން",
  ...
  "session.changes.filesChanged": "ފައިލްތައް ބަދަލުވެއްޖެ {{count}}",
  "session.changes.change.one": "ބަދަލު",
  "session.changes.change.other": "ބަދަލުތައް",
  "session.changes.loadingChanges": "ބަދަލުތައް ލޯޑް ކުރަނީ...",
  "session.changes.empty": "މި ޖަލްސާއަށް އަދި ބަދަލެއް ނާދެއެވެ",
  "session.changes.noVcs": "Git ވަރޝަން ކޮންޓްރޯލް ސިސްޓަމެއް ނުފެނި، ބަދަލުތައް ނުފެނެއެވެ",
  "session.changes.noVcs.createGit.title": "Git ރިޕޮޒިޓަރީއެއް އުފެއްދުން",
  "session.changes.noVcs.createGit.description": "މި މަޝްރޫޢަށް އަންނަ ބަދަލުތައް ޓްރެކްކޮށް، ރިވިއުކޮށް، އަންޑޯކުރުން",
  "session.changes.noVcs.createGit.actionLoading": "Git ރިޕޮޒިޓަރީ އުފެއްދުމުގެ މަސައްކަތް...",
  "session.changes.noVcs.createGit.action": "Git ރިޕޮޒިޓަރީ އުފެއްދުން",
  "session.changes.noSnapshot":
    "ކޮންފިގްގައި ސްނެޕްޝޮޓް ޓްރެކިންގ ޑިސެބިލް ކޮށްފައި ހުރުމުން ސެޝަން ބަދަލުތައް ނުލިބެއެވެ",
  "session.changes.noChanges": "އެއްވެސް ބަދަލެއް ނާދެއެވެ",
  "session.changes.noUncommittedChanges": "އަދި ކޮމިޓް ނުކުރާ ބަދަލެއް ނާދެއެވެ",
  "session.changes.noBranchChanges": "އަދި އެއްވެސް ބްރާންޗަކަށް ބަދަލެއް ނާދެއެވެ",
  ...
  "settings.general.section.titleGeneration": "ސުރުހީ އުފެއްދުން",
  ...
  "settings.general.row.titleModel.title": "ސުރުހީ މޮޑެލް",
  "settings.general.row.titleModel.description": "ސެޝަން ތަކުގެ ސުރުހިތައް އުފެއްދުމާއި އަނެއްކާ އުފެއްދުމަށް ބޭނުންކުރާ މޮޑެލް",
  "settings.general.row.titleModel.default": "ޑިފޯލްޓް (ކުދި މޮޑެލް)",
  "settings.general.row.titlePrompt.edit": "ޕްރޮމްޕްޓް އެޑިޓް ކުރޭ",
