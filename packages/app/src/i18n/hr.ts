...
export const dict = {
  ...
  "command.fileTree.toggle": "Uključi/isključi stablo datoteka",  "command.terminal.new": "Novi terminal",
  ...
  "dialog.credential.manageKeys": "Upravljaj API ključevima",
  "dialog.credential.title": "OpenCode API ključevi",
  "dialog.credential.description": "Prebacujte se između povezanih OpenCode API ključeva ili upravljajte spremljenima.",
  "dialog.credential.active": "Aktivan",
  "dialog.credential.select": "Prebaci na ovaj ključ",
  "dialog.credential.rename": "Preimenuj",
  "dialog.credential.remove": "Ukloni",
  "dialog.credential.add": "Dodaj API ključ",
  "dialog.credential.rename.placeholder": "Oznaka",
  "dialog.credential.empty": "Još nema povezanih API ključeva.",
  "provider.connect.apiKey.labelName": "Oznaka",
  "provider.connect.apiKey.labelPlaceholder": "npr. Osobni, Posao",
  ...
  "dialog.titlePrompt.default": "Zadani prompt",
  "dialog.titlePrompt.token.previousTitle": "Zamjenjuje se trenutnim naslovom sesije",
  "dialog.titlePrompt.token.conversation": "Uvijek se prilaže, čak i ako ga izostavite",
  "usage.go.title": "Korištenje OpenCode Go",
  "usage.window.5h": "5 sati",
  "usage.window.week": "Tjedno",
  "usage.window.month": "Mjesečno",
  "usage.calls.one": "{{count}} poziv",
  "usage.calls.other": "{{count}} poziva",
  "usage.calls.few": "{{count}} poziva",
  "usage.reset": "Resetiraj",
  "usage.clear": "Očisti",
  "usage.reset.predicted": "Predviđeno",
  ...
  "dialog.titlePrompt.title": "Prompt za generiranje naslova",
  "dialog.titlePrompt.description": "Upute za model naslova. Razgovor se uvijek prilaže; {previousTitle} se zamjenjuje trenutnim naslovom.",
  "dialog.titlePrompt.placeholder": "Vlastite upute (prazno = zadani prompt)",
  "dialog.titlePrompt.reset": "Vrati na zadano",
  ...
  "toast.title.regenerated": "Naslov sesije ažuriran",
  "toast.title.failed": "Generiranje naslova sesije nije uspjelo",
  "toast.title.keepExisting": "Naslov zadržan — promijenio se tijekom generiranja",
  ...
  "session.panel.fileBrowser": "Pregled i datoteke",
  ...
  "session.changes.filesChanged": "Datoteke promijenjene {{count}}",
  "session.changes.change.one": "Promijeniti",
  "session.changes.change.other": "Promjene",
  "session.changes.loadingChanges": "Učitavanje promjena...",
  "session.changes.empty": "Još nema promjena u ovoj sesiji",
  "session.changes.noVcs": "Sustav kontrole verzija Git nije otkriven, promjene nisu prikazane",
  "session.changes.noVcs.createGit.title": "Napravite Git spremište",
  "session.changes.noVcs.createGit.description": "Pratite, pregledajte i poništite promjene u ovom projektu",
  "session.changes.noVcs.createGit.actionLoading": "Stvaranje Git repozitorija...",
  "session.changes.noVcs.createGit.action": "Napravi Git spremište",
  "session.changes.noSnapshot": "Praćenje snimke onemogućeno je u konfiguraciji, tako da promjene sesije nisu dostupne",
  "session.changes.noChanges": "Nema promjena",
  "session.changes.noUncommittedChanges": "Još nema neizvršenih promjena",
  "session.changes.noBranchChanges": "Još nema promjena grane",
  ...
  "settings.general.section.titleGeneration": "Generiranje naslova",
  ...
  "settings.general.row.titleModel.title": "Model naslova",
  "settings.general.row.titleModel.description": "Model koji se koristi za generiranje i ponovno generiranje naslova sesija",
  "settings.general.row.titleModel.default": "Zadano (mali model)",
  "settings.general.row.titlePrompt.edit": "Uredi prompt",
