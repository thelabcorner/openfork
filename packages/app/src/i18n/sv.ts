export const dict = {
  ...
  "command.fileTree.toggle": "Växla filträdet",  "command.terminal.new": "Ny terminal",
  ...
  "command.browser.toggle": "Växla webbläsare",
  "browser.address.placeholder": "Sök eller ange adress",
  "browser.nav.back": "Tillbaka",
  "browser.nav.forward": "Framåt",
  "browser.nav.reload": "Ladda om",
  "browser.nav.stop": "Stoppa",
  "browser.nav.newTab": "Ny flik",
  ...
  "browser.panel.empty": "Inga sidor öppna",
  "browser.panel.unavailable": "Webbläsaren är endast tillgänglig i skrivbordsappen",
  "browser.mode.fill": "Fyll",
  "browser.mode.freeform": "Fri",
  "browser.mode.preset": "Förinställning",
  "browser.viewportMode": "Visningsläge",
  "browser.rotate": "Rotera",
  "browser.aspectLock": "Lås bildförhållande",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "Märken",
  "browser.badges.toggle": "Växla elementmärken",
  ...
  "browser.resize.left": "Ändra storlek från vänsterkanten",
  "browser.resize.right": "Ändra storlek från högerkanten",
  "browser.resize.bottom": "Ändra storlek från nederkanten",
  "browser.resize.bottom-left": "Ändra storlek från nedre vänstra hörnet",
  "browser.resize.bottom-right": "Ändra storlek från nedre högra hörnet",
  "browser.crash.title": "Den här sidan kraschade",
  "browser.crash.reload": "Ladda om sidan",
  "browser.action.running": "Körs",
  "browser.action.succeeded": "Lyckades",
  "browser.action.failed": "Misslyckades",
  "browser.action.interrupted": "Avbruten",
  "browser.summary.interactive": "Interaktiva",
  "browser.summary.forms": "Formulär",
  "browser.summary.consoleErrors": "Konsolfel",
  "browser.summary.failedRequests": "Misslyckade förfrågningar",
  ...
  "dialog.credential.manageKeys": "Hantera API-nycklar",
  "dialog.credential.title": "OpenCode API-nycklar",
  "dialog.credential.description": "Växla mellan dina anslutna OpenCode API-nycklar eller hantera de sparade.",
  "dialog.credential.active": "Aktiv",
  "dialog.credential.select": "Växla till den här nyckeln",
  "dialog.credential.rename": "Byt namn",
  "dialog.credential.remove": "Ta bort",
  "dialog.credential.add": "Lägg till API-nyckel",
  "dialog.credential.rename.placeholder": "Etikett",
  "dialog.credential.empty": "Inga API-nycklar anslutna än.",
  "provider.connect.apiKey.labelName": "Etikett",
  "provider.connect.apiKey.labelPlaceholder": "t.ex. Personlig, Arbete",
  ...
  "dialog.titlePrompt.token.previousTitle": "Ersätts med den aktuella sessionstiteln",
  "dialog.titlePrompt.token.conversation": "Bifogas alltid, även om du utelämnar det",
  "usage.go.title": "OpenCode Go-användning",
  "usage.window.5h": "5 timmar",
  "usage.window.week": "Veckovis",
  "usage.window.month": "Månadsvis",
  "usage.calls.one": "{{count}} anrop",
  "usage.calls.other": "{{count}} anrop",
  "usage.reset": "Återställ",
  "usage.clear": "Rensa",
  "usage.reset.predicted": "Förväntat",
  ...
  "dialog.titlePrompt.title": "Prompt för titelgenerering",
  "dialog.titlePrompt.description": "Instruktioner för titelmodellen. Konversationen bifogas alltid; {previousTitle} ersätts med den aktuella titeln.",
  "dialog.titlePrompt.placeholder": "Egna instruktioner (tomt = standardprompt)",
  "dialog.titlePrompt.reset": "Återställ till standard",
  ...
  "toast.title.regenerated": "Sessionstiteln uppdaterades",
  "toast.title.failed": "Det gick inte att generera sessionstiteln",
  "toast.title.keepExisting": "Titeln behölls — den ändrades under genereringen",
  ...
  "session.tab.changes": "Granskning",
  "session.tab.context": "Kontext",
  "session.tab.unknown": "Okänd session",
  "session.panel.fileBrowser": "Granskning och filer",
  ...
  "session.changes.filesChanged": "Ändrade filer: {{count}}",
  "session.changes.change.one": "Ändring",
  "session.changes.change.other": "Ändringar",
  "session.changes.loadingChanges": "Läser in ändringar...",
  "session.changes.empty": "Inga ändringar i denna session ännu",
  "session.changes.noVcs": "Inget Git-versionskontrollsystem upptäcktes, ändringar visas inte",
  "session.changes.noVcs.createGit.title": "Skapa ett Git-arkiv",
  "session.changes.noVcs.createGit.description": "Spåra, granska och ångra ändringar i det här projektet",
  "session.changes.noVcs.createGit.actionLoading": "Skapar Git-arkiv...",
  "session.changes.noVcs.createGit.action": "Skapa Git-arkiv",
  ...
  "session.changes.noChanges": "Inga ändringar",
  "session.changes.noUncommittedChanges": "Inga ändringar som inte har checkats in ännu",
  "session.changes.noBranchChanges": "Inga grenändringar ännu",
  ...
  "settings.general.row.titleModel.description": "Modell som genererar och återskapar sessionstitlar",
  "settings.general.row.titleModel.default": "Standard (liten modell)",
  "settings.general.row.titlePrompt.edit": "Redigera prompt",
