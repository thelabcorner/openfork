export const dict: Record<string, string> = {
  ...
  "command.fileTree.toggle": "ගොනු ගස ටොගල් කරන්න",  "command.terminal.new": "නව පර්යන්තය",
  ...
  "dialog.credential.manageKeys": "API යතුරු කළමනාකරණය",
  "dialog.credential.title": "OpenCode API යතුරු",
  "dialog.credential.description": "සම්බන්ධිත OpenCode API යතුරු අතර මාරු වන්න හෝ සුරකින ලද ඒවා කළමනාකරණය කරන්න.",
  "dialog.credential.active": "ක්රියාකාරී",
  "dialog.credential.select": "මෙම යතුරට මාරු වන්න",
  "dialog.credential.rename": "නැවත නම් කරන්න",
  "dialog.credential.remove": "ඉවත් කරන්න",
  "dialog.credential.add": "API යතුරක් එක් කරන්න",
  "dialog.credential.rename.placeholder": "ලේබලය",
  "dialog.credential.empty": "තවම API යතුරු සම්බන්ධ වී නොමැත.",
  "provider.connect.apiKey.labelName": "ලේබලය",
  "provider.connect.apiKey.labelPlaceholder": "උදා: පුද්ගලික, වැඩ",
  ...
  "dialog.titlePrompt.default": "පෙරනිමි විමසුම",
  "dialog.titlePrompt.token.previousTitle": "වත්මන් සැසි මාතෘකාවෙන් ප්රතිස්ථාපනය වේ",
  "dialog.titlePrompt.token.conversation": "එය අත්හැරියත් සැමවිටම අමුණා ඇත",
  "usage.go.title": "OpenCode Go භාවිතය",
  "usage.window.5h": "පැය 5",
  "usage.window.week": "සතිපතා",
  "usage.window.month": "මාසික",
  "usage.calls.one": "{{count}} ඇමතුම",
  "usage.calls.other": "{{count}} ඇමතුම්",
  "usage.reset": "නැවත සකසන්න",
  "usage.clear": "හිස් කරන්න",
  "usage.reset.predicted": "පුරෝකථනය",
  ...
  "dialog.titlePrompt.title": "මාතෘකා උත්පාදන විමසුම",
  "dialog.titlePrompt.description": "මාතෘකා ආකෘතිය සඳහා උපදෙස්. සංවාදය සැමවිටම අමුණා ඇත; {previousTitle} වත්මන් මාතෘකාවෙන් ප්රතිස්ථාපනය වේ.",
  "dialog.titlePrompt.placeholder": "අභිරුචි උපදෙස් (හිස් = පෙරනිමි විමසුම)",
  "dialog.titlePrompt.reset": "පෙරනිමියට නැවත සකසන්න",
  ...
  "toast.title.regenerated": "සැසි මාතෘකාව යාවත්කාලීන කරන ලදී",
  "toast.title.failed": "සැසි මාතෘකාව උත්පාදනය කිරීමට අසමත් විය",
  "toast.title.keepExisting": "මාතෘකාව රඳවා ඇත — උත්පාදනය අතරතුර එය වෙනස් විය",
  ...
  "session.tab.changes": "සමාලෝචනය කරන්න",
  "session.tab.context": "සන්දර්භය",
  "session.tab.unknown": "නොදන්නා සැසිය",
  "session.panel.fileBrowser": "සමාලෝචනය සහ ගොනු",
  ...
  "session.changes.filesChanged": "ගොනු {{count}} වෙනස් කරන ලදී",
  "session.changes.change.one": "වෙනස් කරන්න",
  "session.changes.change.other": "වෙනස්කම්",
  "session.changes.loadingChanges": "වෙනස්කම් පූරණය කරමින්...",
  "session.changes.empty": "මෙම සැසියේ තවමත් වෙනස්කම් නොමැත",
  "session.changes.noVcs": "Git අනුවාද පාලන පද්ධතියක් අනාවරණය වී නැත, වෙනස්කම් දර්ශනය නොවේ",
  "session.changes.noVcs.createGit.title": "Git ගබඩාවක් සාදන්න",
  "session.changes.noVcs.createGit.description": "මෙම ව්‍යාපෘතියේ වෙනස්කම් හඹා යන්න, සමාලෝචනය කරන්න, සහ පසුගමනය කරන්න",
  "session.changes.noVcs.createGit.actionLoading": "Git ගබඩාව නිර්මාණය කරමින්...",
  "session.changes.noVcs.createGit.action": "Git ගබඩාවක් සාදන්න",
  "session.changes.noSnapshot": "Snapshot ලුහුබැඳීම වින්‍යාසය තුළ අබල කර ඇත, එබැවින් සැසි වෙනස්කම් නොමැත",
  "session.changes.noChanges": "වෙනස්කම් නොමැත",
  "session.changes.noUncommittedChanges": "තවමත් කැප නොකළ වෙනස්කම් නොමැත",
  "session.changes.noBranchChanges": "තවම ශාඛාවේ වෙනසක් නැත",
  ...
  "settings.general.section.titleGeneration": "මාතෘකා උත්පාදනය",
  ...
  "settings.general.row.titleModel.title": "මාතෘකා ආකෘතිය",
  "settings.general.row.titleModel.description": "සැසි මාතෘකා උත්පාදනය සහ නැවත උත්පාදනය සඳහා භාවිතා කරන ආකෘතිය",
  "settings.general.row.titleModel.default": "පෙරනිමිය (කුඩා ආකෘතිය)",
  "settings.general.row.titlePrompt.edit": "විමසුම සංස්කරණය කරන්න",
