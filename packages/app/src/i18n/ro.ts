export const dict = {
  ...
  "command.fileTree.toggle": "Comută arborele de fișiere",  "command.terminal.new": "Terminal nou",
  ...
  "command.browser.toggle": "Comută browserul",
  "browser.address.placeholder": "Caută sau introdu o adresă",
  "browser.nav.back": "Înapoi",
  "browser.nav.forward": "Înainte",
  "browser.nav.reload": "Reîncarcă",
  "browser.nav.stop": "Oprește",
  "browser.nav.newTab": "Filă nouă",
  ...
  "browser.panel.empty": "Nicio pagină deschisă",
  "browser.panel.unavailable": "Browserul este disponibil doar în aplicația desktop",
  "browser.mode.fill": "Umple",
  "browser.mode.freeform": "Liber",
  "browser.mode.preset": "Prestabilit",
  "browser.viewportMode": "Mod vizualizare",
  "browser.rotate": "Rotește",
  "browser.aspectLock": "Blochează raportul de aspect",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "Insigne",
  "browser.badges.toggle": "Comută insigne de elemente",
  ...
  "browser.resize.left": "Redimensionează de la marginea stângă",
  "browser.resize.right": "Redimensionează de la marginea dreaptă",
  "browser.resize.bottom": "Redimensionează de la marginea de jos",
  "browser.resize.bottom-left": "Redimensionează din colțul stânga-jos",
  "browser.resize.bottom-right": "Redimensionează din colțul dreapta-jos",
  "browser.crash.title": "Această pagină s-a prăbușit",
  "browser.crash.reload": "Reîncarcă pagina",
  "browser.action.running": "În curs",
  "browser.action.succeeded": "Reușit",
  "browser.action.failed": "Eșuat",
  "browser.action.interrupted": "Întrerupt",
  "browser.summary.interactive": "Interactive",
  "browser.summary.forms": "Formulare",
  "browser.summary.consoleErrors": "Erori de consolă",
  "browser.summary.failedRequests": "Cereri eșuate",
  ...
  "dialog.credential.manageKeys": "Gestionează cheile API",
  "dialog.credential.title": "Chei OpenCode API",
  "dialog.credential.description": "Comută între cheile OpenCode API conectate sau gestionează-le pe cele salvate.",
  "dialog.credential.active": "Activ",
  "dialog.credential.select": "Comută la această cheie",
  "dialog.credential.rename": "Redenumește",
  "dialog.credential.remove": "Elimină",
  "dialog.credential.add": "Adaugă cheie API",
  "dialog.credential.rename.placeholder": "Etichetă",
  "dialog.credential.empty": "Nu există încă chei API conectate.",
  "provider.connect.apiKey.labelName": "Etichetă",
  "provider.connect.apiKey.labelPlaceholder": "ex. Personal, Serviciu",
  ...
  "dialog.titlePrompt.default": "Prompt implicit",
  "dialog.titlePrompt.token.previousTitle": "Înlocuit cu titlul curent al sesiunii",
  "dialog.titlePrompt.token.conversation": "Atașată întotdeauna, chiar dacă o omiteți",
  "usage.go.title": "Utilizare OpenCode Go",
  "usage.window.5h": "5 ore",
  "usage.window.week": "Săptămânal",
  "usage.window.month": "Lunar",
  "usage.calls.one": "{{count}} apel",
  "usage.calls.other": "{{count}} apeluri",
  "usage.calls.few": "{{count}} apeluri",
  "usage.reset": "Resetează",
  "usage.clear": "Șterge",
  "usage.reset.predicted": "Prevăzut",
  ...
  "dialog.titlePrompt.title": "Prompt pentru generarea titlului",
  "dialog.titlePrompt.description": "Instrucțiuni pentru modelul de titluri. Conversația este întotdeauna atașată; {previousTitle} este înlocuit cu titlul curent.",
  "dialog.titlePrompt.placeholder": "Instrucțiuni personalizate (gol = prompt implicit)",
  "dialog.titlePrompt.reset": "Resetează la implicit",
  ...
  "toast.title.regenerated": "Titlul sesiunii a fost actualizat",
  "toast.title.failed": "Generarea titlului sesiunii a eșuat",
  "toast.title.keepExisting": "Titlu păstrat — s-a schimbat în timpul generării",
  ...
  "session.tab.changes": "Revizuire",
  "session.tab.context": "Context",
  "session.tab.unknown": "Sesiune necunoscută",
  "session.panel.fileBrowser": "Revizuire și fișiere",
  ...
  "session.changes.filesChanged": "{{count}} fișiere modificate",
  "session.changes.change.one": "Modificare",
  "session.changes.change.other": "Modificări",
  "session.changes.loadingChanges": "Se încarcă modificările...",
  "session.changes.empty": "Nicio modificare în această sesiune încă",
  "session.changes.noVcs":
    "Nu a fost detectat niciun sistem de control al versiunilor Git, modificările nu sunt afișate",
  "session.changes.noVcs.createGit.title": "Creează un depozit Git",
  "session.changes.noVcs.createGit.description": "Urmărește, revizuiește și anulează modificările din acest proiect",
  "session.changes.noVcs.createGit.actionLoading": "Se creează depozitul Git...",
  "session.changes.noVcs.createGit.action": "Creează depozit Git",
  ...
  "session.changes.noChanges": "Nicio modificare",
  "session.changes.noUncommittedChanges": "Nicio modificare necomisă încă",
  "session.changes.noBranchChanges": "Nicio modificare pe ramură încă",
  ...
  "settings.general.section.titleGeneration": "Generarea titlurilor",
  ...
  "settings.general.row.titleModel.title": "Model de titluri",
  "settings.general.row.titleModel.description": "Model folosit pentru generarea și regenerarea titlurilor de sesiune",
  "settings.general.row.titleModel.default": "Implicit (model mic)",
  "settings.general.row.titlePrompt.edit": "Editează promptul",
