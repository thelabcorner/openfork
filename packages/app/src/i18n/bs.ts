export const dict = {
  ...
  "command.fileTree.toggle": "Prikaži/sakrij stablo datoteka",  "command.terminal.new": "Novi terminal",
  ...
  "session.changes.filesChanged": "Izmijenjeno {{count}} datoteka",
  "session.changes.change.one": "Izmjena",
  "session.changes.change.other": "Izmjene",
  "session.changes.loadingChanges": "Učitavanje izmjena...",
  "session.changes.empty": "Još nema izmjena u ovoj sesiji",
  "session.changes.noVcs": "Nije otkriven Git sistem za kontrolu verzija, pa se promjene ne prikazuju",
  "session.changes.noSnapshot":
    "Praćenje snimaka (snapshot) je onemogućeno u konfiguraciji, pa promjene sesije nisu dostupne",
  "session.changes.noChanges": "Nema izmjena",
  "session.changes.noUncommittedChanges": "Još nema promjena koje nisu commitovane",
  "session.changes.noBranchChanges": "Još nema promjena na grani",
  ...
  "toast.title.failed": "Generisanje naslova sesije nije uspjelo",
  "toast.title.keepExisting": "Naslov zadržan — promijenio se tokom generisanja",
  ...
  "session.changes.noVcs.createGit.title": "Kreiraj Git repozitorij",
  "session.changes.noVcs.createGit.description": "Prati, pregledaj i poništi promjene u ovom projektu",
  "session.changes.noVcs.createGit.actionLoading": "Kreiranje Git repozitorija...",
  "session.changes.noVcs.createGit.action": "Kreiraj Git repozitorij",
