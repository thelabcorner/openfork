export const dict = {
  ...
  "command.fileTree.toggle": "فائل ٹری نوں ٹوگل کرو",  "command.terminal.new": "نواں ٹرمینل",
  ...
  "dialog.credential.manageKeys": "API ਕੁੰਜੀਆਂ ਪ੍ਰਬੰਧਿਤ ਕਰੋ",
  "dialog.credential.title": "OpenCode API ਕੁੰਜੀਆਂ",
  "dialog.credential.description": "ਆਪਣੀਆਂ ਕਨੈਕਟ ਕੀਤੀਆਂ OpenCode API ਕੁੰਜੀਆਂ ਵਿਚਕਾਰ ਸਵਿਚ ਕਰੋ ਜਾਂ ਸੁਰੱਖਿਅਤ ਕੁੰਜੀਆਂ ਦਾ ਪ੍ਰਬੰਧ ਕਰੋ।",
  "dialog.credential.active": "ਸਰਗਰਮ",
  "dialog.credential.select": "ਇਸ ਕੁੰਜੀ 'ਤੇ ਸਵਿਚ ਕਰੋ",
  "dialog.credential.rename": "ਨਾਮ ਬਦਲੋ",
  "dialog.credential.remove": "ਹਟਾਓ",
  "dialog.credential.add": "API ਕੁੰਜੀ ਜੋੜੋ",
  "dialog.credential.rename.placeholder": "ਲੇਬਲ",
  "dialog.credential.empty": "ਅਜੇ ਕੋਈ API ਕੁੰਜੀ ਕਨੈਕਟ ਨਹੀਂ ਹੈ।",
  "provider.connect.apiKey.labelName": "ਲੇਬਲ",
  "provider.connect.apiKey.labelPlaceholder": "ਜਿਵੇਂ ਨਿੱਜੀ, ਕੰਮ",
  ...
  "dialog.titlePrompt.default": "ਡਿਫੌਲਟ ਪ੍ਰੌਮਪਟ",
  "dialog.titlePrompt.token.previousTitle": "ਮੌਜੂਦਾ ਸੈਸ਼ਨ ਸਿਰਲੇਖ ਨਾਲ ਬਦਲਿਆ ਜਾਂਦਾ ਹੈ",
  "dialog.titlePrompt.token.conversation": "ਹਮੇਸ਼ਾ ਜੋੜਿਆ ਜਾਂਦਾ ਹੈ, ਭਾਵੇਂ ਤੁਸੀਂ ਇਸਨੂੰ ਛੱਡ ਦਿਓ",
  "usage.go.title": "OpenCode Go ਵਰਤੋਂ",
  "usage.window.5h": "5 ਘੰਟੇ",
  "usage.window.week": "ਹਫਤਾਵਾਰੀ",
  "usage.window.month": "ਮਾਸਿਕ",
  "usage.calls.one": "{{count}} ਕਾਲ",
  "usage.calls.other": "{{count}} ਕਾਲਾਂ",
  "usage.reset": "ਰੀਸੈੱਟ ਕਰੋ",
  "usage.clear": "ਸਾਫ਼ ਕਰੋ",
  "usage.reset.predicted": "ਅਨੁਮਾਨਿਤ",
  ...
  "dialog.titlePrompt.title": "ਸਿਰਲੇਖ ਨਿਰਮਾਣ ਪ੍ਰੌਮਪਟ",
  "dialog.titlePrompt.description": "ਸਿਰਲੇਖ ਮਾਡਲ ਲਈ ਹਦਾਇਤਾਂ। ਗੱਲਬਾਤ ਹਮੇਸ਼ਾ ਜੋੜੀ ਜਾਂਦੀ ਹੈ; {previousTitle} ਨੂੰ ਮੌਜੂਦਾ ਸਿਰਲੇਖ ਨਾਲ ਬਦਲਿਆ ਜਾਂਦਾ ਹੈ।",
  "dialog.titlePrompt.placeholder": "ਕਸਟਮ ਹਦਾਇਤਾਂ (ਖਾਲੀ = ਡਿਫੌਲਟ ਪ੍ਰੌਮਪਟ)",
  "dialog.titlePrompt.reset": "ਡਿਫੌਲਟ 'ਤੇ ਰੀਸੈੱਟ ਕਰੋ",
  ...
  "toast.title.regenerated": "ਸੈਸ਼ਨ ਦਾ ਸਿਰਲੇਖ ਅੱਪਡੇਟ ਕੀਤਾ ਗਿਆ",
  "toast.title.failed": "ਸੈਸ਼ਨ ਦਾ ਸਿਰਲੇਖ ਬਣਾਉਣ ਵਿੱਚ ਅਸਫਲ",
  "toast.title.keepExisting": "ਸਿਰਲੇਖ ਰੱਖਿਆ ਗਿਆ — ਨਿਰਮਾਣ ਦੌਰਾਨ ਇਹ ਬਦਲ ਗਿਆ",
  ...
  "session.tab.changes": "جائزہ",
  "session.tab.context": "تناظر",
  "session.tab.unknown": "نامعلوم سیشن",
  "session.panel.fileBrowser": "جائزہ تے فائلاں",
  ...
  "session.changes.filesChanged": "بدلیاں فائلاں {{count}}",
  "session.changes.change.one": "تبدیلی",
  "session.changes.change.other": "تبدیلیاں",
  "session.changes.loadingChanges": "تبدیلیاں لوڈ ہو رہیاں نیں...",
  "session.changes.empty": "اس سیشن وچ حالے تک کوئی تبدیلی نئیں",
  "session.changes.noVcs": "کوئی Git ورژن کنٹرول سسٹم نئیں لبھیا، تبدیلیاں نئیں وکھائیاں گئیاں",
  "session.changes.noVcs.createGit.title": "اک Git ریپازٹری بناؤ",
  "session.changes.noVcs.createGit.description": "اس منصوبے چ تبدیلیاں نو ٹریک کرو، جائزہ لوو تے کالعدم کرو",
  "session.changes.noVcs.createGit.actionLoading": "Git ریپازٹری بنانا...",
  "session.changes.noVcs.createGit.action": "Git ریپازٹری بناؤ",
  "session.changes.noSnapshot": "ترتیب وچ سنیپ شاٹ ٹریکنگ غیر فعال اے، اس لیی سیشن تبدیلیاں دستیاب نئیں نیں",
  "session.changes.noChanges": "کوئی تبدیلی نئیں",
  "session.changes.noUncommittedChanges": "ہلے کوئی ان کمٹڈ تبدیلی نئیں",
  "session.changes.noBranchChanges": "ہلے تیکر کوئی برانچ نئیں بدلی",
  ...
  "settings.general.section.titleGeneration": "ਸਿਰਲੇਖ ਨਿਰਮਾਣ",
  ...
  "settings.general.row.titleModel.title": "ਸਿਰਲੇਖ ਮਾਡਲ",
  "settings.general.row.titleModel.description": "ਸੈਸ਼ਨ ਸਿਰਲੇਖ ਬਣਾਉਣ ਅਤੇ ਦੁਬਾਰਾ ਬਣਾਉਣ ਲਈ ਵਰਤਿਆ ਜਾਣ ਵਾਲਾ ਮਾਡਲ",
  "settings.general.row.titleModel.default": "ਡਿਫੌਲਟ (ਛੋਟਾ ਮਾਡਲ)",
  "settings.general.row.titlePrompt.edit": "ਪ੍ਰੌਮਪਟ ਸੰਪਾਦਿਤ ਕਰੋ",
