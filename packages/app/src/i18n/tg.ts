export const dict = {
  ...
  "command.fileTree.toggle": "Гузариш кардани дарахти файл",  "command.terminal.new": "Терминали нав",
  ...
  "dialog.credential.manageKeys": "Идоракунии калидҳои API",
  "dialog.credential.title": "Калидҳои OpenCode API",
  "dialog.credential.description": "Байни калидҳои пайвастшудаи OpenCode API иваз кунед ё нигоҳдоштаҳоро идора кунед.",
  "dialog.credential.active": "Фаъол",
  "dialog.credential.select": "Гузариш ба ин калид",
  "dialog.credential.rename": "Тағйири ном",
  "dialog.credential.remove": "Хориҷ кардан",
  "dialog.credential.add": "Иловаи калиди API",
  "dialog.credential.rename.placeholder": "Нишона",
  "dialog.credential.empty": "Ҳанӯз калидҳои API пайваст нашудаанд.",
  "provider.connect.apiKey.labelName": "Нишона",
  "provider.connect.apiKey.labelPlaceholder": "мас. Шахсӣ, Кор",
  ...
  "dialog.titlePrompt.default": "Промпти пешфарз",
  "dialog.titlePrompt.token.previousTitle": "Бо унвони ҷории сессия иваз мешавад",
  "dialog.titlePrompt.token.conversation": "Ҳамеша замима мешавад, ҳатто агар онро тарк кунед",
  "usage.go.title": "Истифодаи OpenCode Go",
  "usage.window.5h": "5 соат",
  "usage.window.week": "Ҳафтаина",
  "usage.window.month": "Моҳона",
  "usage.calls.one": "{{count}} занг",
  "usage.calls.other": "{{count}} занг",
  "usage.reset": "Бозгардондан",
  "usage.clear": "Тоза кардан",
  "usage.reset.predicted": "Пешгӯишуда",
  ...
  "dialog.titlePrompt.title": "Промпти тавлиди унвон",
  "dialog.titlePrompt.description": "Дастурҳо барои модели унвон. Суҳбат ҳамеша замима мешавад; {previousTitle} бо унвони ҷорӣ иваз мешавад.",
  "dialog.titlePrompt.placeholder": "Дастурҳои фармоишӣ (холӣ = промпти пешфарз)",
  "dialog.titlePrompt.reset": "Баргардондан ба пешфарз",
  ...
  "toast.title.regenerated": "Унвони сессия нав карда шуд",
  "toast.title.failed": "Тавлиди унвони сессия муяссар нашуд",
  "toast.title.keepExisting": "Унвон нигоҳ дошта шуд — ҳангоми тавлид тағйир ёфт",
  ...
  "session.tab.changes": "Барраси",
  "session.tab.context": "Контекст",
  "session.tab.unknown": "Сеанси номаълум",
  "session.panel.fileBrowser": "Барраси ва файлҳо",
  ...
  "session.changes.filesChanged": "Файлҳо тағир дода шуданд {{count}}",
  "session.changes.change.one": "Тағйир",
  "session.changes.change.other": "Тағйирот",
  "session.changes.loadingChanges": "Тағйирот бор карда мешавад...",
  "session.changes.empty": "Дар ин иҷлосия ҳанӯз тағирот нест",
  "session.changes.noVcs": "Не Git Системаи Идоракунии Версия ошкор нашудааст, тағирот нишон дода нашудааст",
  "session.changes.noVcs.createGit.title": "Анбори Git эҷод кунед",
  "session.changes.noVcs.createGit.description": "Тағиротро дар ин лоиҳа пайгирӣ кунед, баррасӣ кунед ва бекор кунед",
  "session.changes.noVcs.createGit.actionLoading": "Эҷоди Git анбор...",
  "session.changes.noVcs.createGit.action": "Эҷоди Git репозиторий",
  "session.changes.noSnapshot":
    "Дар конфигуратсия пайгирии аксҳо ғайрифаъол аст, аз ин рӯ тағиротҳои сессия дастрас нестанд",
  "session.changes.noChanges": "Тағйирот нест",
  "session.changes.noUncommittedChanges": "Ҳанӯз ягон тағйироти беэътиборнашуда",
  "session.changes.noBranchChanges": "То ҳол ягон филиал тағир наёфтааст",
  ...
  "settings.general.section.titleGeneration": "Тавлиди унвон",
  ...
  "settings.general.row.titleModel.title": "Модели унвон",
  "settings.general.row.titleModel.description": "Моделе, ки барои тавлид ва тавлиди такрории унвонҳои сессия истифода мешавад",
  "settings.general.row.titleModel.default": "Пешфарз (модели хурд)",
  "settings.general.row.titlePrompt.edit": "Таҳрири промпт",
