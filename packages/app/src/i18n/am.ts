export const dict = {
  ...
  "command.fileTree.toggle": "ፋይል ዛፍን ቀይር",  "command.terminal.new": "አዲስ ተርሚናል",
  ...
  "dialog.credential.manageKeys": "የAPI ቁልፎችን ያቀናብሩ",
  "dialog.credential.title": "የOpenCode API ቁልፎች",
  "dialog.credential.description": "በተገናኙት የOpenCode API ቁልፎች መካከል ይቀያይሩ ወይም የተቀመጡትን ያቀናብሩ።",
  "dialog.credential.active": "ንቁ",
  "dialog.credential.select": "ወደዚህ ቁልፍ ቀይር",
  "dialog.credential.rename": "እንደገና ሰይም",
  "dialog.credential.remove": "አስወግድ",
  "dialog.credential.add": "የAPI ቁልፍ ጨምር",
  "dialog.credential.rename.placeholder": "መለያ",
  "dialog.credential.empty": "እስካሁን ምንም የAPI ቁልፎች አልተገናኙም።",
  "provider.connect.apiKey.labelName": "መለያ",
  "provider.connect.apiKey.labelPlaceholder": "ለምሳሌ ግላዊ፣ ሥራ",
  ...
  "dialog.titlePrompt.default": "ነባሪ ፕሮምፕት",
  "dialog.titlePrompt.token.previousTitle": "በአሁኑ ክፍለ ጊዜ ርዕስ ይተካል",
  "dialog.titlePrompt.token.conversation": "ቢተዉትም ሁልጊዜ ይያያዛል",
  "usage.go.title": "የOpenCode Go አጠቃቀም",
  "usage.window.5h": "5 ሰዓታት",
  "usage.window.week": "ሳምንታዊ",
  "usage.window.month": "ወርሃዊ",
  "usage.calls.one": "{{count}} ጥሪ",
  "usage.calls.other": "{{count}} ጥሪዎች",
  "usage.reset": "ዳግም አስጀምር",
  "usage.clear": "አጽዳ",
  "usage.reset.predicted": "የተተነበየ",
  ...
  "dialog.titlePrompt.title": "ርዕስ የማመንጨት ፕሮምፕት",
  "dialog.titlePrompt.description": "ለርዕስ ሞዴሉ መመሪያዎች። ውይይቱ ሁልጊዜ ተያይዟል፤ {previousTitle} በአሁኑ ርዕስ ይተካል።",
  "dialog.titlePrompt.placeholder": "ብጁ መመሪያዎች (ባዶ = ነባሪ ፕሮምፕት)",
  "dialog.titlePrompt.reset": "ወደ ነባሪ ዳግም አስጀምር",
  ...
  "toast.title.regenerated": "የክፍለ ጊዜ ርዕስ ተዘምኗል",
  "toast.title.failed": "የክፍለ ጊዜ ርዕስ ማመንጨት አልተሳካም",
  "toast.title.keepExisting": "ርዕሱ ተጠብቋል — በማመንጨት ጊዜ ተለውጧል",
  ...
  "session.tab.changes": "ግምገማ",
  "session.tab.context": "አውድ",
  "session.tab.unknown": "ያልታወቀ ክፍለ ጊዜ",
  "session.panel.fileBrowser": "ግምገማ እና ፋይሎች",
  ...
  "session.changes.filesChanged": "የተቀየሩ ፋይሎች {{count}}",
  "session.changes.change.one": "ለውጥ",
  "session.changes.change.other": "ለውጦች",
  "session.changes.loadingChanges": "ለውጦችን በመጫን ላይ...",
  "session.changes.empty": "በዚህ ክፍለ ጊዜ ምንም ለውጦች የሉም",
  "session.changes.noVcs": "ምንም Git የስሪት ቁጥጥር ስርዓት አልተገኘም፣ ለውጦች አይታዩም",
  "session.changes.noVcs.createGit.title": "Git ማከማቻ ፍጠር",
  "session.changes.noVcs.createGit.description": "በዚህ ፕሮጀክት ላይ ለውጦችን ይከታተሉ፣ ይገምግሙ እና ይቀልብሱ",
  "session.changes.noVcs.createGit.actionLoading": "Git ማከማቻ በመፍጠር ላይ...",
  "session.changes.noVcs.createGit.action": "Git ማከማቻ ፍጠር",
  "session.changes.noSnapshot": "የቅጽበታዊ ገጽ እይታን መከታተል በውቅረት ውስጥ ተሰናክሏል፣ስለዚህ የክፍለ-ጊዜ ለውጦች አይገኙም",
  "session.changes.noChanges": "ምንም ለውጦች የሉም",
  "session.changes.noUncommittedChanges": "ገና ምንም ያልተደረጉ ለውጦች የሉም",
  "session.changes.noBranchChanges": "ገና ምንም ቅርንጫፍ ምንም ለውጥ የለም",
  ...
  "settings.general.section.titleGeneration": "የርዕስ ማመንጨት",
  ...
  "settings.general.row.titleModel.title": "ርዕስ ሞዴል",
  "settings.general.row.titleModel.description": "የክፍለ ጊዜ ርዕሶችን ለማመንጨት እና እንደገና ለማመንጨት የሚያገለግል ሞዴል",
  "settings.general.row.titleModel.default": "ነባሪ (ትንሽ ሞዴል)",
  "settings.general.row.titlePrompt.edit": "ፕሮምፕት አርትዕ",
