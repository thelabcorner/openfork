export const dict = {
  ...
  "command.fileTree.toggle": "Alternar árvore de arquivos",  "command.terminal.new": "Novo terminal",
  ...
  "browser.address.placeholder": "Pesquisar ou digitar endereço",
  "browser.nav.back": "Voltar",
  "browser.nav.forward": "Avançar",
  "browser.nav.reload": "Recarregar",
  "browser.nav.stop": "Parar",
  "browser.nav.newTab": "Nova aba",
  ...
  "browser.panel.empty": "Nenhuma página aberta",
  "browser.panel.unavailable": "O navegador está disponível apenas no aplicativo de desktop",
  "browser.mode.fill": "Preencher",
  "browser.mode.freeform": "Livre",
  "browser.mode.preset": "Predefinido",
  "browser.viewportMode": "Modo de viewport",
  "browser.rotate": "Girar",
  "browser.aspectLock": "Bloquear proporção",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "Selos",
  "browser.badges.toggle": "Alternar selos de elementos",
  ...
  "browser.resize.left": "Redimensionar pela borda esquerda",
  "browser.resize.right": "Redimensionar pela borda direita",
  "browser.resize.bottom": "Redimensionar pela borda inferior",
  "browser.resize.bottom-left": "Redimensionar pelo canto inferior esquerdo",
  "browser.resize.bottom-right": "Redimensionar pelo canto inferior direito",
  "browser.crash.title": "Esta página travou",
  "browser.crash.reload": "Recarregar página",
  "browser.action.running": "Em execução",
  "browser.action.succeeded": "Concluído",
  "browser.action.failed": "Falhou",
  "browser.action.interrupted": "Interrompido",
  "browser.summary.interactive": "Interativos",
  "browser.summary.forms": "Formulários",
  "browser.summary.consoleErrors": "Erros de console",
  "browser.summary.failedRequests": "Solicitações com falha",
  ...
  "dialog.credential.manageKeys": "Merañ alc'hwezioù API",
  "dialog.credential.title": "Alc'hwezioù OpenCode API",
  "dialog.credential.description": "Treuzit etre hoc'h alc'hwezioù OpenCode API liammet pe merait ar re enrollet.",
  "dialog.credential.active": "Aktif",
  "dialog.credential.select": "Tremen d'an alc'hwez-mañ",
  "dialog.credential.rename": "Adanv",
  "dialog.credential.remove": "Lemel",
  "dialog.credential.add": "Ouzhpennañ un alc'hwez API",
  "dialog.credential.rename.placeholder": "Tikedenn",
  "dialog.credential.empty": "Alc'hwez API ebet liammet c'hoazh.",
  "provider.connect.apiKey.labelName": "Tikedenn",
  "provider.connect.apiKey.labelPlaceholder": "d.s. Personel, Labour",
  ...
  "dialog.titlePrompt.default": "Prompt dre ziouer",
  "dialog.titlePrompt.token.previousTitle": "Erlec'hiet gant titl bremañ ar sontañ",
  "dialog.titlePrompt.token.conversation": "Stag atav, mem ma lezit anezhañ a-gostez",
  "usage.go.title": "Implij OpenCode Go",
  "usage.window.5h": "5 eur",
  "usage.window.week": "Bepenn",
  "usage.window.month": "Be miz",
  "usage.calls.one": "{{count}} galv",
  "usage.calls.other": "{{count}} galv",
  "usage.calls.many": "{{count}} galv",
  "usage.reset": "Adlakaat",
  "usage.clear": "Riñsañ",
  "usage.reset.predicted": "Diouganet",
  ...
  "dialog.titlePrompt.title": "Prompt genel titl",
  "dialog.titlePrompt.description": "Ali evit dil an titloù. Ar gaozeadenn a zo stag atav; {previousTitle} a zo erlec'hiet gant an titl bremañ.",
  "dialog.titlePrompt.placeholder": "Ali personelaet (goullo = prompt dre ziouer)",
  "dialog.titlePrompt.reset": "Adlakaat dre ziouer",
  ...
  "session.tab.changes": "Revisão",
  "session.tab.context": "Contexto",
  "session.tab.unknown": "Sessão desconhecida",
  "session.panel.fileBrowser": "Revisão e arquivos",
  ...
  "session.changes.filesChanged": "{{count}} arquivos alterados",
  "session.changes.change.one": "Alteração",
  "session.changes.change.other": "Alterações",
  "session.changes.loadingChanges": "Carregando alterações...",
  "session.changes.empty": "Nenhuma alteração nesta sessão ainda",
  "session.changes.noVcs": "Nenhum Sistema de Controle de Versão Git detectado, alterações não exibidas",
  ...
  "session.changes.noChanges": "Sem alterações",
  "session.changes.noUncommittedChanges": "Ainda não há alterações sem commit",
  "session.changes.noBranchChanges": "Ainda não há alterações na branch",
  ...
  "settings.general.section.titleGeneration": "Genel diltitloù",
  ...
  "settings.general.row.titleModel.title": "Dil titl",
  "settings.general.row.titleModel.description": "Dil implijet da c'henel hag adgenel titloù ar sontañ",
  "settings.general.row.titleModel.default": "Dre ziouer (dil bihan)",
  "settings.general.row.titlePrompt.edit": "Kemmañ ar brompt",
  ...
  "toast.title.regenerated": "Titl ar sontañ hizivaet",
  "toast.title.failed": "C'hwitadenn war c'henel titl ar sontañ",
  "toast.title.keepExisting": "Titl miret — kemmet e oa e-pad ar genel",
  ...
  "session.changes.noVcs.createGit.title": "Criar um repositório Git",
  "session.changes.noVcs.createGit.description": "Rastreie, revise e desfaça alterações neste projeto",
  "session.changes.noVcs.createGit.actionLoading": "Criando repositório Git...",
  "session.changes.noVcs.createGit.action": "Criar repositório Git",
