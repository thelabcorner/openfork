export const dict = {
  ...
  "command.fileTree.toggle": "فائل ٹری دکھائیں یا چھپائیں",  "command.terminal.new": "نیا ٹرمینل",
  ...
  "dialog.credential.manageKeys": "API کلیدیں منظم کریں",
  "dialog.credential.title": "OpenCode API کلیدیں",
  "dialog.credential.description": "منسلک OpenCode API کلیدوں کے درمیان سوئچ کریں یا محفوظ شدہ کلیدوں کو منظم کریں۔",
  "dialog.credential.active": "فعال",
  "dialog.credential.select": "اس کلید پر سوئچ کریں",
  "dialog.credential.rename": "نام تبدیل کریں",
  "dialog.credential.remove": "ہٹائیں",
  "dialog.credential.add": "API کلید شامل کریں",
  "dialog.credential.rename.placeholder": "لیبل",
  "dialog.credential.empty": "ابھی کوئی API کلید منسلک نہیں ہے۔",
  "provider.connect.apiKey.labelName": "لیبل",
  "provider.connect.apiKey.labelPlaceholder": "مثلاً ذاتی، کام",
  ...
  "dialog.titlePrompt.default": "طے شدہ پرامپٹ",
  "dialog.titlePrompt.token.previousTitle": "موجودہ سیشن عنوان سے بدل دیا جاتا ہے",
  "dialog.titlePrompt.token.conversation": "ہمیشہ منسلک ہوتا ہے، چاہے آپ اسے چھوڑ دیں",
  "usage.go.title": "OpenCode Go کا استعمال",
  "usage.window.5h": "5 گھنٹے",
  "usage.window.week": "ہفتہ وار",
  "usage.window.month": "ماہانہ",
  "usage.calls.one": "{{count}} کال",
  "usage.calls.other": "{{count}} کالز",
  "usage.reset": "ری سیٹ کریں",
  "usage.clear": "صاف کریں",
  "usage.reset.predicted": "پیش گوئی",
  ...
  "dialog.titlePrompt.title": "عنوان کی تخلیق کا پرامپٹ",
  "dialog.titlePrompt.description": "عنوان ماڈل کے لیے ہدایات۔ گفتگو ہمیشہ منسلک ہوتی ہے؛ {previousTitle} کو موجودہ عنوان سے بدل دیا جاتا ہے۔",
  "dialog.titlePrompt.placeholder": "اپنی مرضی کی ہدایات (خالی = طے شدہ پرامپٹ)",
  "dialog.titlePrompt.reset": "طے شدہ پر ری سیٹ کریں",
  ...
  "toast.title.regenerated": "سیشن کا عنوان اپ ڈیٹ ہو گیا",
  "toast.title.failed": "سیشن کا عنوان بنانے میں ناکامی",
  "toast.title.keepExisting": "عنوان برقرار رکھا گیا — یہ تخلیق کے دوران بدل گیا",
  ...
  "session.tab.changes": "جائزہ لیں",
  "session.tab.context": "سیاق و سباق",
  "session.tab.unknown": "نامعلوم سیشن",
  "session.panel.fileBrowser": "جائزہ اور فائلیں۔",
  ...
  "session.changes.filesChanged": "تبدیل شدہ فائلیں: {{count}}",
  "session.changes.change.one": "تبدیلی",
  "session.changes.change.other": "تبدیلیاں",
  "session.changes.loadingChanges": "تبدیلیاں لوڈ ہو رہی ہیں...",
  "session.changes.empty": "اس سیشن میں ابھی تک کوئی تبدیلی نہیں آئی",
  "session.changes.noVcs": "Git ورژن کنٹرول سسٹم کا پتہ نہیں چلا، تبدیلیاں ظاہر نہیں کی گئیں۔",
  "session.changes.noVcs.createGit.title": "ایک Git ذخیرہ بنائیں",
  "session.changes.noVcs.createGit.description":
    "اس پروجیکٹ میں تبدیلیوں کو ٹریک کریں، ان کا جائزہ لیں اور ان کو کالعدم کریں۔",
  "session.changes.noVcs.createGit.actionLoading": "Git ذخیرہ تخلیق کیا جا رہا ہے...",
  "session.changes.noVcs.createGit.action": "Git ذخیرہ تخلیق کریں۔",
  ...
  "session.changes.noChanges": "کوئی تبدیلی نہیں۔",
  "session.changes.noUncommittedChanges": "ابھی تک کوئی غیر ارتکاب تبدیلیاں نہیں ہیں۔",
  "session.changes.noBranchChanges": "ابھی تک برانچ میں کوئی تبدیلی نہیں ہے۔",
  ...
  "settings.general.section.titleGeneration": "عنوان کی تخلیق",
  ...
  "settings.general.row.titleModel.title": "عنوان ماڈل",
  "settings.general.row.titleModel.description": "ماڈل جو سیشن کے عنوانات بنانے اور دوبارہ بنانے کے لیے استعمال ہوتا ہے",
  "settings.general.row.titleModel.default": "پہلے سے طے شدہ (چھوٹا ماڈل)",
  "settings.general.row.titlePrompt.edit": "پرامپٹ میں ترمیم کریں",
