export const dict = {
  ...
  "command.fileTree.toggle": "Fayl daraxtini almashtirish",  "command.terminal.new": "Yangi terminal",
  ...
  "dialog.credential.manageKeys": "API kalitlarini boshqarish",
  "dialog.credential.title": "OpenCode API kalitlari",
  "dialog.credential.description": "Ulangan OpenCode API kalitlari o'rtasida almashing yoki saqlanganlarini boshqaring.",
  "dialog.credential.active": "Faol",
  "dialog.credential.select": "Ushbu kalitga o'tish",
  "dialog.credential.rename": "Qayta nomlash",
  "dialog.credential.remove": "O'chirish",
  "dialog.credential.add": "API kalitini qo'shish",
  "dialog.credential.rename.placeholder": "Yorliq",
  "dialog.credential.empty": "Hali ulangan API kalitlari yo'q.",
  "provider.connect.apiKey.labelName": "Yorliq",
  "provider.connect.apiKey.labelPlaceholder": "mas. Shaxsiy, Ish",
  ...
  "dialog.titlePrompt.default": "Standart prompt",
  "dialog.titlePrompt.token.previousTitle": "Joriy seans sarlavhasi bilan almashtiriladi",
  "dialog.titlePrompt.token.conversation": "Tashlab qo'ysangiz ham har doim biriktiriladi",
  "usage.go.title": "OpenCode Go'dan foydalanish",
  "usage.window.5h": "5 soat",
  "usage.window.week": "Haftalik",
  "usage.window.month": "Oylik",
  "usage.calls.one": "{{count}} qo'ng'iroq",
  "usage.calls.other": "{{count}} qo'ng'iroq",
  "usage.reset": "Qayta tiklash",
  "usage.clear": "Tozalash",
  "usage.reset.predicted": "Bashorat qilingan",
  ...
  "dialog.titlePrompt.title": "Sarlavha yaratish prompti",
  "dialog.titlePrompt.description": "Sarlavha modeli uchun ko'rsatmalar. Suhbat har doim biriktiriladi; {previousTitle} joriy sarlavha bilan almashtiriladi.",
  "dialog.titlePrompt.placeholder": "Maxsus ko'rsatmalar (bo'sh = standart prompt)",
  "dialog.titlePrompt.reset": "Standartga qaytarish",
  ...
  "toast.title.regenerated": "Seans sarlavhasi yangilandi",
  "toast.title.failed": "Seans sarlavhasini yaratib bo'lmadi",
  "toast.title.keepExisting": "Sarlavha saqlandi — yaratish paytida o'zgardi",
  ...
  "session.tab.changes": "Koʻrib chiqish",
  "session.tab.context": "Kontekst",
  "session.tab.unknown": "Noma'lum sessiya",
  "session.panel.fileBrowser": "Ko'rib chiqish va fayllar",
  ...
  "session.changes.filesChanged": "Fayllar o'zgartirildi {{count}}",
  "session.changes.change.one": "O'zgartirish",
  "session.changes.change.other": "O'zgarishlar",
  "session.changes.loadingChanges": "Oʻzgarishlar yuklanmoqda...",
  "session.changes.empty": "Bu sessiyada hali oʻzgarishlar yoʻq",
  "session.changes.noVcs": "Git versiyasini boshqarish tizimi aniqlanmadi, o'zgarishlar ko'rsatilmadi",
  "session.changes.noVcs.createGit.title": "Git omborini yarating",
  "session.changes.noVcs.createGit.description":
    "Ushbu loyihadagi oʻzgarishlarni kuzating, koʻrib chiqing va bekor qiling",
  "session.changes.noVcs.createGit.actionLoading": "Git ombori yaratilmoqda...",
  "session.changes.noVcs.createGit.action": "Git omborini yarating",
  "session.changes.noSnapshot":
    "Snapshot kuzatish konfiguratsiyada oʻchirilgan, shuning uchun sessiya oʻzgarishlari mavjud emas",
  "session.changes.noChanges": "Oʻzgarishlar yoʻq",
  "session.changes.noUncommittedChanges": "Hali tasdiqlanmagan o'zgarishlar yo'q",
  "session.changes.noBranchChanges": "Hozircha filial o'zgarmadi",
  ...
  "settings.general.section.titleGeneration": "Sarlavha yaratish",
  ...
  "settings.general.row.titleModel.title": "Sarlavha modeli",
  "settings.general.row.titleModel.description": "Seans sarlavhalarini yaratish va qayta yaratish uchun ishlatiladigan model",
  "settings.general.row.titleModel.default": "Standart (kichik model)",
  "settings.general.row.titlePrompt.edit": "Promptni tahrirlash",
