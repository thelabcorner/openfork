export const dict = {
  ...
  "command.fileTree.toggle": "បិទបើកមែកធាងឯកសារ",  "command.terminal.new": "ស្ថានីយថ្មី។",
  ...
  "dialog.credential.manageKeys": "គ្រប់គ្រងសោ API",
  "dialog.credential.title": "សោ OpenCode API",
  "dialog.credential.description": "ប្តូររវាងសោ OpenCode API ដែលបានតភ្ជាប់ ឬគ្រប់គ្រងសោដែលបានរក្សាទុក។",
  "dialog.credential.active": "សកម្ម",
  "dialog.credential.select": "ប្តូរទៅសោនេះ",
  "dialog.credential.rename": "ប្តូរឈ្មោះ",
  "dialog.credential.remove": "ដកចេញ",
  "dialog.credential.add": "បន្ថែមសោ API",
  "dialog.credential.rename.placeholder": "ស្លាក",
  "dialog.credential.empty": "មិនទាន់មានសោ API ដែលបានតភ្ជាប់ទេ។",
  "provider.connect.apiKey.labelName": "ស្លាក",
  "provider.connect.apiKey.labelPlaceholder": "ឧ. ផ្ទាល់ខ្លួន, ការងារ",
  ...
  "dialog.titlePrompt.default": "ពាក្យបញ្ជាលំនាំដើម",
  "dialog.titlePrompt.token.previousTitle": "ជំនួសដោយចំណងជើងវគ្គបច្ចុប្បន្ន",
  "dialog.titlePrompt.token.conversation": "តែងតែភ្ជាប់ ទោះបីជាអ្នកមិនបញ្ចូលក៏ដោយ",
  "usage.go.title": "ការប្រើប្រាស់ OpenCode Go",
  "usage.window.5h": "៥ ម៉ោង",
  "usage.window.week": "ប្រចាំសប្តាហ៍",
  "usage.window.month": "ប្រចាំខែ",
  "usage.calls.one": "{{count}} ការហៅ",
  "usage.calls.other": "{{count}} ការហៅ",
  "usage.reset": "កំណត់ឡើងវិញ",
  "usage.clear": "សម្អាត",
  "usage.reset.predicted": "បានព្យាករ",
  ...
  "dialog.titlePrompt.title": "ពាក្យបញ្ជាបង្កើតចំណងជើង",
  "dialog.titlePrompt.description": "សេចក្តីណែនាំសម្រាប់គំរូចំណងជើង។ ការសន្ទនាតែងតែត្រូវបានភ្ជាប់។ {previousTitle} ត្រូវបានជំនួសដោយចំណងជើងបច្ចុប្បន្ន។",
  "dialog.titlePrompt.placeholder": "សេចក្តីណែនាំផ្ទាល់ខ្លួន (ទទេ = ពាក្យបញ្ជាលំនាំដើម)",
  "dialog.titlePrompt.reset": "កំណត់ឡើងវិញទៅលំនាំដើម",
  ...
  "toast.title.regenerated": "បានធ្វើបច្ចុប្បន្នភាពចំណងជើងវគ្គ",
  "toast.title.failed": "មិនអាចបង្កើតចំណងជើងវគ្គបានទេ",
  "toast.title.keepExisting": "រក្សាចំណងជើង — វាបានផ្លាស់ប្តូរអំឡុងពេលបង្កើត",
  ...
  "session.tab.changes": "ពិនិត្យ",
  "session.tab.context": "បរិបទ",
  "session.tab.unknown": "សម័យមិនស្គាល់",
  "session.panel.fileBrowser": "ពិនិត្យ និងឯកសារ",
  ...
  "session.changes.filesChanged": "ឯកសារបានផ្លាស់ប្តូរ {{count}}",
  "session.changes.change.one": "ការផ្លាស់ប្តូរ",
  "session.changes.change.other": "ការផ្លាស់ប្តូរ",
  "session.changes.loadingChanges": "កំពុងផ្ទុកការផ្លាស់ប្តូរ...",
  "session.changes.empty": "មិនមានការផ្លាស់ប្តូរនៅក្នុងសម័យនេះនៅឡើយទេ",
  "session.changes.noVcs": "គ្មានប្រព័ន្ធគ្រប់គ្រងកំណែ Git ត្រូវបានរកឃើញទេ ការផ្លាស់ប្តូរមិនត្រូវបានបង្ហាញទេ។",
  "session.changes.noVcs.createGit.title": "បង្កើតឃ្លាំង Git",
  "session.changes.noVcs.createGit.description": "តាមដាន ពិនិត្យ និងបោះបង់ការផ្លាស់ប្ដូរនៅក្នុងគម្រោងនេះ។",
  "session.changes.noVcs.createGit.actionLoading": "ការបង្កើតឃ្លាំង Git...",
  "session.changes.noVcs.createGit.action": "បង្កើតឃ្លាំង Git",
  "session.changes.noSnapshot": "ការតាមដានរូបថតត្រូវបានបិទនៅក្នុងការកំណត់ ដូច្នេះការផ្លាស់ប្តូរវេនមិនអាចប្រើបានទេ",
  "session.changes.noChanges": "គ្មានការផ្លាស់ប្តូរទេ។",
  "session.changes.noUncommittedChanges": "មិនទាន់មានការផ្លាស់ប្តូរដែលមិនទាន់បានកំណត់នៅឡើយ",
  "session.changes.noBranchChanges": "មិនទាន់មានការផ្លាស់ប្តូរសាខានៅឡើយទេ",
  ...
  "settings.general.section.titleGeneration": "ការបង្កើតចំណងជើង",
  ...
  "settings.general.row.titleModel.title": "គំរូចំណងជើង",
  "settings.general.row.titleModel.description": "គំរូដែលប្រើសម្រាប់បង្កើត និងបង្កើតឡើងវិញនូវចំណងជើងវគ្គ",
  "settings.general.row.titleModel.default": "លំនាំដើម (គំរូតូច)",
  "settings.general.row.titlePrompt.edit": "កែសម្រួលពាក្យបញ្ជា",
