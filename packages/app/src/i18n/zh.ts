...
export const dict = {
  ...
  "browser.panel.empty": "没有打开的页面",
  "browser.panel.unavailable": "浏览器仅在桌面应用中可用",
  "browser.mode.fill": "填充",
  "browser.mode.freeform": "自由",
  "browser.mode.preset": "预设",
  "browser.viewportMode": "视口模式",
  "browser.rotate": "旋转",
  "browser.aspectLock": "锁定宽高比",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "徽章",
  "browser.badges.toggle": "切换元素徽章",
  ...
  "browser.resize.left": "从左侧边缘调整大小",
  "browser.resize.right": "从右侧边缘调整大小",
  "browser.resize.bottom": "从底部边缘调整大小",
  "browser.resize.bottom-left": "从左下角调整大小",
  "browser.resize.bottom-right": "从右下角调整大小",
  "browser.crash.title": "此页面已崩溃",
  "browser.crash.reload": "重新加载页面",
  "browser.action.running": "运行中",
  "browser.action.succeeded": "成功",
  "browser.action.failed": "失败",
  "browser.action.interrupted": "已中断",
  "browser.summary.interactive": "可交互",
  "browser.summary.forms": "表单",
  "browser.summary.consoleErrors": "控制台错误",
  "browser.summary.failedRequests": "失败的请求",
  ...
  "dialog.credential.manageKeys": "管理 API 密钥",
  "dialog.credential.title": "OpenCode API 密钥",
  "dialog.credential.description": "在已连接的 OpenCode API 密钥之间切换，或管理已保存的密钥。",
  "dialog.credential.active": "启用",
  "dialog.credential.select": "切换到该密钥",
  "dialog.credential.rename": "重命名",
  "dialog.credential.remove": "移除",
  "dialog.credential.add": "添加 API 密钥",
  "dialog.credential.rename.placeholder": "标签",
  "dialog.credential.empty": "尚未连接 API 密钥。",
  "provider.connect.apiKey.labelName": "标签",
  "provider.connect.apiKey.labelPlaceholder": "例如：个人、工作",
  ...
  "dialog.titlePrompt.default": "默认提示词",
  "dialog.titlePrompt.token.previousTitle": "替换为当前会话标题",
  "dialog.titlePrompt.token.conversation": "始终附加，即使省略",
  "usage.go.title": "OpenCode Go 用量",
  "usage.window.5h": "5 小时",
  "usage.window.week": "每周",
  "usage.window.month": "每月",
  "usage.calls.one": "{{count}} 次调用",
  "usage.calls.other": "{{count}} 次调用",
  "usage.reset": "重置",
  "usage.clear": "清除",
  "usage.reset.predicted": "预测",
  ...
  "dialog.titlePrompt.title": "标题生成提示词",
  "dialog.titlePrompt.description": "用于标题模型的说明。对话始终会被附加；{previousTitle} 会替换为当前标题。",
  "dialog.titlePrompt.placeholder": "自定义说明（留空 = 默认提示词）",
  "dialog.titlePrompt.reset": "重置为默认值",
  ...
  "session.tab.changes": "审查",
  "session.tab.context": "上下文",
  "session.tab.unknown": "未知会话",
  "session.panel.fileBrowser": "审查和文件",
  ...
  "session.changes.filesChanged": "{{count}} 个文件已更改",
  "session.changes.change.one": "更改",
  "session.changes.change.other": "更改",
  "session.changes.loadingChanges": "正在加载更改...",
  "session.changes.empty": "此会话暂无更改",
  "session.changes.noVcs": "未检测到 Git，无法显示更改",
  "session.changes.noSnapshot": "配置中已禁用快照跟踪，因此会话更改不可用",
  "session.changes.noChanges": "无更改",
  "session.changes.noUncommittedChanges": "尚无未提交的更改",
  "session.changes.noBranchChanges": "尚无分支更改",
  ...
  "settings.general.section.titleGeneration": "标题生成",
  ...
  "settings.general.row.titleModel.title": "标题模型",
  "settings.general.row.titleModel.description": "用于生成和重新生成会话标题的模型",
  "settings.general.row.titleModel.default": "默认（小型模型）",
  "settings.general.row.titlePrompt.edit": "编辑提示词",
  ...
  "toast.title.regenerated": "会话标题已更新",
  "toast.title.failed": "生成会话标题失败",
  "toast.title.keepExisting": "已保留标题 — 生成期间标题发生了变化",
  ...
  "session.changes.noVcs.createGit.title": "创建 Git 仓库",
  "session.changes.noVcs.createGit.description": "在此项目中跟踪、审查和撤消更改",
  "session.changes.noVcs.createGit.actionLoading": "正在创建 Git 仓库...",
  "session.changes.noVcs.createGit.action": "创建 Git 仓库",
