export const dict = {
  ...
  "command.fileTree.toggle": "Перемкнути дерево файлів",  "command.terminal.new": "Новий термінал",
  ...
  "command.browser.toggle": "Перемкнути браузер",
  "browser.address.placeholder": "Пошук або введення адреси",
  "browser.nav.back": "Назад",
  "browser.nav.forward": "Вперед",
  "browser.nav.reload": "Перезавантажити",
  "browser.nav.stop": "Зупинити",
  "browser.nav.newTab": "Нова вкладка",
  ...
  "browser.panel.empty": "Немає відкритих сторінок",
  "browser.panel.unavailable": "Браузер доступний лише в настільному застосунку",
  "browser.mode.fill": "Заповнити",
  "browser.mode.freeform": "Вільний",
  "browser.mode.preset": "Пресет",
  "browser.viewportMode": "Режим області перегляду",
  "browser.rotate": "Повернути",
  "browser.aspectLock": "Зафіксувати пропорції",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "Значки",
  "browser.badges.toggle": "Перемкнути значки елементів",
  ...
  "browser.resize.left": "Змінити розмір від лівого краю",
  "browser.resize.right": "Змінити розмір від правого краю",
  "browser.resize.bottom": "Змінити розмір від нижнього краю",
  "browser.resize.bottom-left": "Змінити розмір від нижнього лівого кута",
  "browser.resize.bottom-right": "Змінити розмір від нижнього правого кута",
  "browser.crash.title": "Сторінку завершено аварійно",
  "browser.crash.reload": "Перезавантажити сторінку",
  "browser.action.running": "Виконується",
  "browser.action.succeeded": "Успішно",
  "browser.action.failed": "Не вдалося",
  "browser.action.interrupted": "Перервано",
  "browser.summary.interactive": "Інтерактивні",
  "browser.summary.forms": "Форми",
  "browser.summary.consoleErrors": "Помилки консолі",
  "browser.summary.failedRequests": "Невдалі запити",
  ...
  "dialog.credential.manageKeys": "Керувати ключами API",
  "dialog.credential.title": "Ключі API OpenCode",
  "dialog.credential.description": "Перемикайтеся між підключеними ключами API OpenCode або керуйте збереженими.",
  "dialog.credential.active": "Активний",
  "dialog.credential.select": "Перемкнутися на цей ключ",
  "dialog.credential.rename": "Перейменувати",
  "dialog.credential.remove": "Видалити",
  "dialog.credential.add": "Додати ключ API",
  "dialog.credential.rename.placeholder": "Мітка",
  "dialog.credential.empty": "Ключі API ще не підключено.",
  "provider.connect.apiKey.labelName": "Мітка",
  "provider.connect.apiKey.labelPlaceholder": "напр. Особистий, Робочий",
  ...
  "dialog.titlePrompt.default": "Промпт за замовчуванням",
  "dialog.titlePrompt.token.previousTitle": "Замінюється поточним заголовком сеансу",
  "dialog.titlePrompt.token.conversation": "Додається завжди, навіть якщо його пропустити",
  "usage.go.title": "Використання OpenCode Go",
  "usage.window.5h": "5 годин",
  "usage.window.week": "Тижнево",
  "usage.window.month": "Щомісяця",
  "usage.calls.one": "{{count}} виклик",
  "usage.calls.other": "{{count}} викликів",
  "usage.calls.few": "{{count}} викликів",
  "usage.calls.many": "{{count}} викликів",
  "usage.reset": "Скинути",
  "usage.clear": "Очистити",
  ...
  "dialog.titlePrompt.title": "Промпт генерації заголовка",
  "dialog.titlePrompt.description": "Інструкції для моделі заголовків. Розмову завжди додано; {previousTitle} замінюється поточним заголовком.",
  "dialog.titlePrompt.placeholder": "Власні інструкції (порожньо = промпт за замовчуванням)",
  "dialog.titlePrompt.reset": "Скинути до стандартного",
  ...
  "toast.title.regenerated": "Заголовок сеансу оновлено",
  "toast.title.failed": "Не вдалося згенерувати заголовок сеансу",
  "toast.title.keepExisting": "Заголовок збережено — він змінився під час генерації",
  ...
  "session.tab.changes": "Огляд",
  "session.tab.context": "Контекст",
  "session.tab.unknown": "Невідома сесія",
  "session.panel.fileBrowser": "Огляд і файли",
  ...
  "session.changes.filesChanged": "Змінено файлів: {{count}}",
  "session.changes.change.one": "Зміна",
  "session.changes.change.other": "Зміни",
  "session.changes.loadingChanges": "Завантаження змін...",
  "session.changes.empty": "У цій сесії ще немає змін",
  "session.changes.noVcs": "Систему контролю версій Git не виявлено, зміни не відображаються",
  "session.changes.noVcs.createGit.title": "Створити Git-репозиторій",
  "session.changes.noVcs.createGit.description": "Відстежуйте, переглядайте та скасовуйте зміни в цьому проєкті",
  "session.changes.noVcs.createGit.actionLoading": "Створення Git-репозиторію...",
  "session.changes.noVcs.createGit.action": "Створити Git-репозиторій",
  "session.changes.noSnapshot": "Відстеження знімків вимкнено в конфігурації, тому зміни сесії недоступні",
  "session.changes.noChanges": "Немає змін",
  "session.changes.noUncommittedChanges": "Ще немає незафіксованих змін",
  "session.changes.noBranchChanges": "Ще немає змін у гілці",
  ...
  "settings.general.section.titleGeneration": "Генерація заголовків",
  ...
  "settings.general.row.titleModel.title": "Модель заголовків",
  "settings.general.row.titleModel.description": "Модель для генерації та повторної генерації заголовків сеансів",
  "settings.general.row.titleModel.default": "За замовчуванням (маленька модель)",
  "settings.general.row.titlePrompt.edit": "Змінити промпт",
