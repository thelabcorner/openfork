export const dict = {
  ...
  "command.fileTree.toggle": "Вклучете го дрвото на датотеки",  "command.terminal.new": "Нов терминал",
  ...
  "dialog.credential.manageKeys": "Управување со API клучеви",
  "dialog.credential.title": "OpenCode API клучеви",
  "dialog.credential.description": "Префрлајте се помеѓу поврзаните OpenCode API клучеви или управувајте со зачуваните.",
  "dialog.credential.active": "Активен",
  "dialog.credential.select": "Префрли на овој клуч",
  "dialog.credential.rename": "Преименувај",
  "dialog.credential.remove": "Отстрани",
  "dialog.credential.add": "Додај API клуч",
  "dialog.credential.rename.placeholder": "Ознака",
  "dialog.credential.empty": "Сè уште нема поврзани API клучеви.",
  "provider.connect.apiKey.labelName": "Ознака",
  "provider.connect.apiKey.labelPlaceholder": "напр. Личен, Работа",
  ...
  "dialog.titlePrompt.default": "Стандарден промпт",
  "dialog.titlePrompt.token.previousTitle": "Се заменува со тековниот наслов на сесијата",
  "dialog.titlePrompt.token.conversation": "Секогаш се прикачува, дури и ако го изоставите",
  "usage.go.title": "Користење на OpenCode Go",
  "usage.window.5h": "5 часа",
  "usage.window.week": "Неделно",
  "usage.window.month": "Месечно",
  "usage.calls.one": "{{count}} повик",
  "usage.calls.other": "{{count}} повици",
  "usage.reset": "Ресетирај",
  "usage.clear": "Исчисти",
  "usage.reset.predicted": "Предвидено",
  ...
  "dialog.titlePrompt.title": "Промпт за генерирање наслов",
  "dialog.titlePrompt.description": "Инструкции за моделот за наслови. Разговорот секогаш се прикачува; {previousTitle} се заменува со тековниот наслов.",
  "dialog.titlePrompt.placeholder": "Прилагодени инструкции (празно = стандарден промпт)",
  "dialog.titlePrompt.reset": "Врати на стандардно",
  ...
  "toast.title.regenerated": "Насловот на сесијата е ажуриран",
  "toast.title.failed": "Неуспешно генерирање наслов на сесија",
  "toast.title.keepExisting": "Насловот е задржан — се променил при генерирањето",
  ...
  "session.panel.fileBrowser": "Преглед и датотеки",
  ...
  "session.changes.filesChanged": "Променети датотеки {{count}}",
  "session.changes.change.one": "Промена",
  "session.changes.change.other": "Промени",
  "session.changes.loadingChanges": "Се вчитуваат промените...",
  "session.changes.empty": "Сè уште нема промени на оваа сесија",
  "session.changes.noVcs": "Не е откриен систем за контрола на верзијата Git, промените не се прикажани",
  "session.changes.noVcs.createGit.title": "Направете складиште Git",
  "session.changes.noVcs.createGit.description": "Следете, прегледувајте и поништете ги промените во овој проект",
  "session.changes.noVcs.createGit.actionLoading": "Се создава складиште Git...",
  "session.changes.noVcs.createGit.action": "Креирај Git складиште",
  ...
  "session.changes.noChanges": "Нема промени",
  "session.changes.noUncommittedChanges": "Сè уште нема необврзани промени",
  "session.changes.noBranchChanges": "Сè уште нема промени во гранката",
  ...
  "settings.general.section.titleGeneration": "Генерирање наслови",
  ...
  "settings.general.row.titleModel.title": "Модел за наслови",
  "settings.general.row.titleModel.description": "Модел што се користи за генерирање и повторно генерирање наслови на сесии",
  "settings.general.row.titleModel.default": "Стандардно (мал модел)",
  "settings.general.row.titlePrompt.edit": "Уреди промпт",
