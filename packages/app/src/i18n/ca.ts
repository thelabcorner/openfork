export const dict = {
  ...
  "command.fileTree.toggle": "Commuta l'arbre de fitxers",  "command.terminal.new": "Nou terminal",
  ...
  "dialog.credential.manageKeys": "Gestiona les claus API",
  "dialog.credential.title": "Claus API d'OpenCode",
  "dialog.credential.description": "Alterna entre les claus API d'OpenCode connectades o gestiona les desades.",
  "dialog.credential.active": "Activa",
  "dialog.credential.select": "Canvia a aquesta clau",
  "dialog.credential.rename": "Reanomena",
  "dialog.credential.remove": "Elimina",
  "dialog.credential.add": "Afegeix una clau API",
  "dialog.credential.rename.placeholder": "Etiqueta",
  "dialog.credential.empty": "Encara no hi ha claus API connectades.",
  "provider.connect.apiKey.labelName": "Etiqueta",
  "provider.connect.apiKey.labelPlaceholder": "p. ex. Personal, Feina",
  ...
  "dialog.titlePrompt.default": "Prompt per defecte",
  "dialog.titlePrompt.token.previousTitle": "Se substitueix pel títol actual de la sessió",
  "dialog.titlePrompt.token.conversation": "Sempre s'adjunta, encara que l'ometeu",
  "usage.go.title": "Ús d'OpenCode Go",
  "usage.window.5h": "5 hores",
  "usage.window.week": "Setmanal",
  "usage.window.month": "Mensual",
  "usage.calls.one": "{{count}} trucada",
  "usage.calls.other": "{{count}} trucades",
  "usage.calls.many": "{{count}} trucades",
  "usage.reset": "Restableix",
  "usage.clear": "Esborra",
  "usage.reset.predicted": "Previst",
  ...
  "dialog.titlePrompt.title": "Prompt de generació de títols",
  "dialog.titlePrompt.description": "Instruccions per al model de títols. La conversa sempre s'adjunta; {previousTitle} se substitueix pel títol actual.",
  "dialog.titlePrompt.placeholder": "Instruccions personalitzades (buit = prompt per defecte)",
  "dialog.titlePrompt.reset": "Restableix el valor per defecte",
  ...
  "toast.title.regenerated": "Títol de la sessió actualitzat",
  "toast.title.failed": "No s'ha pogut generar el títol de la sessió",
  "toast.title.keepExisting": "Títol conservat: ha canviat durant la generació",
  ...
  "session.tab.changes": "Revisió",
  "session.tab.context": "Context",
  "session.tab.unknown": "Sessió desconeguda",
  "session.panel.fileBrowser": "Revisió i arxius",
  ...
  "session.changes.filesChanged": "Fitxers canviats {{count}}",
  "session.changes.change.one": "Canviar",
  "session.changes.change.other": "Canvis",
  "session.changes.loadingChanges": "S'estan carregant els canvis...",
  "session.changes.empty": "Encara no hi ha canvis en aquesta sessió",
  "session.changes.noVcs": "No Git S'ha detectat el sistema de control de versions, els canvis no es mostren",
  "session.changes.noVcs.createGit.title": "Creeu un repositori Git.",
  "session.changes.noVcs.createGit.description": "Feu un seguiment, reviseu i desfer els canvis en aquest projecte",
  "session.changes.noVcs.createGit.actionLoading": "S'està creant un repositori Git...",
  "session.changes.noVcs.createGit.action": "Crea un repositori Git",
  ...
  "session.changes.noChanges": "Sense canvis",
  "session.changes.noUncommittedChanges": "Encara no hi ha canvis no compromesos",
  "session.changes.noBranchChanges": "Encara no hi ha canvis de branca",
  ...
  "settings.general.section.titleGeneration": "Generació de títols",
  ...
  "settings.general.row.titleModel.title": "Model de títols",
  "settings.general.row.titleModel.description": "Model utilitzat per generar i regenerar títols de sessions",
  "settings.general.row.titleModel.default": "Per defecte (model petit)",
  "settings.general.row.titlePrompt.edit": "Edita el prompt",
