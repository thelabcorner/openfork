...
export const dict = {
  ...
  "command.fileTree.toggle": "Fájlfa váltása",  "command.terminal.new": "Új terminál",
  ...
  "command.browser.toggle": "Böngésző váltása",
  "browser.address.placeholder": "Keresés vagy cím megadása",
  "browser.nav.back": "Vissza",
  "browser.nav.forward": "Előre",
  "browser.nav.reload": "Újratöltés",
  "browser.nav.stop": "Leállítás",
  "browser.nav.newTab": "Új lap",
  ...
  "browser.panel.empty": "Nincs nyitott oldal",
  "browser.panel.unavailable": "A böngésző csak az asztali alkalmazásban érhető el",
  "browser.mode.fill": "Kitöltés",
  "browser.mode.freeform": "Szabad",
  "browser.mode.preset": "Előbeállítás",
  "browser.viewportMode": "Nézet mód",
  "browser.rotate": "Forgatás",
  "browser.aspectLock": "Képarány zárolása",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "Jelvények",
  "browser.badges.toggle": "Elemjelvények váltása",
  ...
  "browser.resize.left": "Átméretezés bal széltől",
  "browser.resize.right": "Átméretezés jobb széltől",
  "browser.resize.bottom": "Átméretezés alsó széltől",
  "browser.resize.bottom-left": "Átméretezés bal alsó sarokból",
  "browser.resize.bottom-right": "Átméretezés jobb alsó sarokból",
  "browser.crash.title": "Ez az oldal összeomlott",
  "browser.crash.reload": "Oldal újratöltése",
  "browser.action.running": "Fut",
  "browser.action.succeeded": "Sikeres",
  "browser.action.failed": "Sikertelen",
  "browser.action.interrupted": "Megszakítva",
  "browser.summary.interactive": "Interaktív",
  "browser.summary.forms": "Űrlapok",
  "browser.summary.consoleErrors": "Konzolhibák",
  "browser.summary.failedRequests": "Sikertelen kérések",
  ...
  "dialog.credential.manageKeys": "API-kulcsok kezelése",
  "dialog.credential.title": "OpenCode API-kulcsok",
  "dialog.credential.description": "Váltson a csatlakoztatott OpenCode API-kulcsok között, vagy kezelje a mentetteket.",
  "dialog.credential.active": "Aktív",
  "dialog.credential.select": "Váltás erre a kulcsra",
  "dialog.credential.rename": "Átnevezés",
  "dialog.credential.remove": "Eltávolítás",
  "dialog.credential.add": "API-kulcs hozzáadása",
  "dialog.credential.rename.placeholder": "Címke",
  "dialog.credential.empty": "Még nincsenek csatlakoztatott API-kulcsok.",
  "provider.connect.apiKey.labelName": "Címke",
  "provider.connect.apiKey.labelPlaceholder": "pl. Személyes, Munka",
  ...
  "dialog.titlePrompt.default": "Alapértelmezett prompt",
  "dialog.titlePrompt.token.previousTitle": "Az aktuális munkamenet-címmel helyettesítve",
  "dialog.titlePrompt.token.conversation": "Mindig csatolva, még ha kihagyod is",
  "usage.go.title": "OpenCode Go-használat",
  "usage.window.5h": "5 óra",
  "usage.window.week": "Heti",
  "usage.window.month": "Havi",
  "usage.calls.one": "{{count}} hívás",
  "usage.calls.other": "{{count}} hívás",
  "usage.reset": "Visszaállítás",
  "usage.clear": "Törlés",
  "usage.reset.predicted": "Becsült",
  ...
  "dialog.titlePrompt.title": "Címgeneráló prompt",
  "dialog.titlePrompt.description": "Utasítások a címmodellnek. A beszélgetés mindig csatolva van; a {previousTitle} helyére az aktuális cím kerül.",
  "dialog.titlePrompt.placeholder": "Egyedi utasítások (üres = alapértelmezett prompt)",
  "dialog.titlePrompt.reset": "Visszaállítás alapértelmezettre",
  ...
  "toast.title.regenerated": "A munkamenet címe frissítve",
  "toast.title.failed": "A munkamenet címének generálása sikertelen",
  "toast.title.keepExisting": "Cím megtartva — a generálás közben megváltozott",
  ...
  "session.tab.changes": "Tekintse át",
  "session.tab.context": "Kontextus",
  "session.tab.unknown": "Ismeretlen munkamenet",
  "session.panel.fileBrowser": "Áttekintés és fájlok",
  ...
  "session.changes.filesChanged": "A fájlok megváltoztak {{count}}",
  "session.changes.change.one": "Változás",
  "session.changes.change.other": "Változások",
  "session.changes.loadingChanges": "Módosítások betöltése...",
  "session.changes.empty": "Ebben a munkamenetben még nincs változás",
  "session.changes.noVcs": "Nem észlelt Git verzióvezérlő rendszert, a változások nem jelennek meg",
  "session.changes.noVcs.createGit.title": "Hozzon létre egy Git tárolót",
  ...
  "session.changes.noVcs.createGit.actionLoading": "Git adattár létrehozása...",
  "session.changes.noVcs.createGit.action": "Git tároló létrehozása",
  ...
  "session.changes.noChanges": "Nincs változás",
  "session.changes.noUncommittedChanges": "Még nincsenek végrehajtatlan változtatások",
  "session.changes.noBranchChanges": "A fióktelep még nem változott",
  ...
  "settings.general.section.titleGeneration": "Címgenerálás",
  ...
  "settings.general.row.titleModel.title": "Címmodell",
  "settings.general.row.titleModel.description": "A munkamenet-címek generálásához és újragenerálásához használt modell",
  "settings.general.row.titleModel.default": "Alapértelmezett (kis modell)",
  "settings.general.row.titlePrompt.edit": "Prompt szerkesztése",
