export const dict = {
  ...
  "command.fileTree.toggle": "Փոխարկել ֆայլի ծառը",  "command.terminal.new": "Նոր տերմինալ",
  ...
  "dialog.credential.manageKeys": "API բանալիների կառավարում",
  "dialog.credential.title": "OpenCode API բանալիներ",
  "dialog.credential.description": "Անցեք միացված OpenCode API բանալիների միջև կամ կառավարեք պահվածները։",
  "dialog.credential.active": "Ակտիվ",
  "dialog.credential.select": "Անցնել այս բանալուն",
  "dialog.credential.rename": "Վերանվանել",
  "dialog.credential.remove": "Հեռացնել",
  "dialog.credential.add": "Ավելացնել API բանալի",
  "dialog.credential.rename.placeholder": "Պիտակ",
  "dialog.credential.empty": "Միացված API բանալիներ դեռ չկան։",
  "provider.connect.apiKey.labelName": "Պիտակ",
  "provider.connect.apiKey.labelPlaceholder": "օր. Անձնական, Աշխատանք",
  ...
  "dialog.titlePrompt.default": "Լռելյայն հուշում",
  "dialog.titlePrompt.token.previousTitle": "Փոխարինվում է սեանսի ընթացիկ վերնագրով",
  "dialog.titlePrompt.token.conversation": "Միշտ կցվում է, նույնիսկ եթե այն բաց եք թողնում",
  "usage.go.title": "OpenCode Go-ի օգտագործումը",
  "usage.window.5h": "5 ժամ",
  "usage.window.week": "Շաբաթական",
  "usage.window.month": "Ամսական",
  "usage.calls.one": "{{count}} զանգ",
  "usage.calls.other": "{{count}} զանգ",
  "usage.reset": "Վերականգնել",
  "usage.clear": "Մաքրել",
  "usage.reset.predicted": "Կանխատեսված",
  ...
  "dialog.titlePrompt.title": "Վերնագրի ստեղծման հուշում",
  "dialog.titlePrompt.description": "Հրահանգներ վերնագրերի մոդելի համար։ Զրույցը միշտ կցվում է; {previousTitle}-ը փոխարինվում է ընթացիկ վերնագրով։",
  "dialog.titlePrompt.placeholder": "Հատուկ հրահանգներ (դատարկ = լռելյայն հուշում)",
  "dialog.titlePrompt.reset": "Վերականգնել լռելյայնը",
  ...
  "toast.title.regenerated": "Սեանսի վերնագիրը թարմացվել է",
  "toast.title.failed": "Չհաջողվեց ստեղծել սեանսի վերնագիրը",
  "toast.title.keepExisting": "Վերնագիրը պահպանված է — այն փոխվել է ստեղծման ընթացքում",
  ...
  "session.tab.changes": "Վերանայել",
  "session.tab.context": "Համատեքստ",
  "session.tab.unknown": "Անհայտ նիստ",
  "session.panel.fileBrowser": "Վերանայել և ֆայլեր",
  ...
  "session.changes.filesChanged": "Ֆայլերը փոխվել են {{count}}",
  "session.changes.change.one": "Փոխել",
  "session.changes.change.other": "Փոփոխություններ",
  "session.changes.loadingChanges": "Բեռնվում են փոփոխություններ...",
  "session.changes.empty": "Այս նիստում դեռ փոփոխություններ չկան",
  "session.changes.noVcs": "Չի հայտնաբերվել Git Տարբերակի կառավարման համակարգ, փոփոխությունները չեն ցուցադրվում",
  "session.changes.noVcs.createGit.title": "Ստեղծել Git պահոց",
  "session.changes.noVcs.createGit.description": "Հետեւել, վերանայել և հետարկել այս նախագծի փոփոխությունները",
  "session.changes.noVcs.createGit.actionLoading": "Ստեղծվում է Git պահոց...",
  "session.changes.noVcs.createGit.action": "Ստեղծել Git պահոց",
  "session.changes.noSnapshot":
    "Snapshot-ի հետագծումն անջատված է կազմաձևում, ուստի նիստի փոփոխություններն անհասանելի են",
  "session.changes.noChanges": "Ոչ փոփոխություններ",
  "session.changes.noUncommittedChanges": "Դեռեւս չկատարված փոփոխություններ",
  "session.changes.noBranchChanges": "Ճյուղի փոփոխություններ դեռ չկան",
  ...
  "settings.general.section.titleGeneration": "Վերնագրերի ստեղծում",
  ...
  "settings.general.row.titleModel.title": "Վերնագրերի մոդել",
  "settings.general.row.titleModel.description": "Մոդել, որն օգտագործվում է սեանսների վերնագրեր ստեղծելու և վերստեղծելու համար",
  "settings.general.row.titleModel.default": "Լռելյայն (փոքր մոդել)",
  "settings.general.row.titlePrompt.edit": "Խմբագրել հուշումը",
