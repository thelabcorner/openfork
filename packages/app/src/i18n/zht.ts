...
export const dict = {
  ...
  "command.fileTree.toggle": "切換檔案樹",  "command.terminal.new": "新增終端機",
  ...
  "command.browser.toggle": "切換瀏覽器",
  "browser.address.placeholder": "搜尋或輸入網址",
  "browser.nav.back": "上一頁",
  "browser.nav.forward": "下一頁",
  "browser.nav.reload": "重新整理",
  "browser.nav.stop": "停止",
  "browser.nav.newTab": "新增分頁",
  ...
  "browser.panel.empty": "沒有開啟的頁面",
  "browser.panel.unavailable": "瀏覽器僅可在桌面應用程式中使用",
  "browser.mode.fill": "填滿",
  "browser.mode.freeform": "自由",
  "browser.mode.preset": "預設",
  "browser.viewportMode": "檢視區域模式",
  "browser.rotate": "旋轉",
  "browser.aspectLock": "鎖定長寬比",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "徽章",
  "browser.badges.toggle": "切換元素徽章",
  ...
  "browser.resize.left": "從左側邊緣調整大小",
  "browser.resize.right": "從右側邊緣調整大小",
  "browser.resize.bottom": "從底部邊緣調整大小",
  "browser.resize.bottom-left": "從左下角調整大小",
  "browser.resize.bottom-right": "從右下角調整大小",
  "browser.crash.title": "此頁面已當機",
  "browser.crash.reload": "重新載入頁面",
  "browser.action.running": "執行中",
  "browser.action.succeeded": "成功",
  "browser.action.failed": "失敗",
  "browser.action.interrupted": "已中斷",
  "browser.summary.interactive": "可互動",
  "browser.summary.forms": "表單",
  "browser.summary.consoleErrors": "主控台錯誤",
  "browser.summary.failedRequests": "失敗的要求",
  ...
  "dialog.credential.manageKeys": "管理 API 金鑰",
  "dialog.credential.title": "OpenCode API 金鑰",
  "dialog.credential.description": "在已連線的 OpenCode API 金鑰之間切換，或管理已儲存的金鑰。",
  "dialog.credential.active": "啟用",
  "dialog.credential.select": "切換到此金鑰",
  "dialog.credential.rename": "重新命名",
  "dialog.credential.remove": "移除",
  "dialog.credential.add": "新增 API 金鑰",
  "dialog.credential.rename.placeholder": "標籤",
  "dialog.credential.empty": "尚未連線 API 金鑰。",
  "provider.connect.apiKey.labelName": "標籤",
  "provider.connect.apiKey.labelPlaceholder": "例如：個人、工作",
  ...
  "dialog.titlePrompt.default": "預設提示詞",
  "dialog.titlePrompt.token.previousTitle": "取代為目前工作階段標題",
  "dialog.titlePrompt.token.conversation": "一律附加，即使省略",
  "usage.go.title": "OpenCode Go 用量",
  "usage.window.5h": "5 小時",
  "usage.window.week": "每週",
  "usage.window.month": "每月",
  "usage.calls.one": "{{count}} 次呼叫",
  "usage.calls.other": "{{count}} 次呼叫",
  "usage.reset": "重設",
  "usage.clear": "清除",
  "usage.reset.predicted": "預測",
  ...
  "dialog.titlePrompt.title": "標題生成提示詞",
  "dialog.titlePrompt.description": "用於標題模型的說明。對話始終會被附加；{previousTitle} 會替換為目前標題。",
  "dialog.titlePrompt.placeholder": "自訂說明（留空 = 預設提示詞）",
  "dialog.titlePrompt.reset": "重設為預設值",
  ...
  "session.tab.changes": "檢閱",
  "session.tab.context": "上下文",
  "session.tab.unknown": "未知的工作階段",
  "session.panel.fileBrowser": "檢閱與檔案",
  ...
  "session.changes.filesChanged": "{{count}} 個檔案變更",
  "session.changes.change.one": "變更",
  "session.changes.change.other": "變更",
  "session.changes.loadingChanges": "正在載入變更...",
  "session.changes.empty": "此工作階段尚無變更",
  "session.changes.noChanges": "沒有變更",
  "session.changes.noUncommittedChanges": "尚無未提交的變更",
  "session.changes.noBranchChanges": "尚無分支變更",
  "session.changes.noVcs": "未偵測到 Git 版本控制系統，無法顯示變更",
  "session.changes.noSnapshot": "設定中已停用快照追蹤，因此無法使用工作階段變更",
  ...
  "settings.general.section.titleGeneration": "標題產生",
  ...
  "settings.general.row.titleModel.title": "標題模型",
  "settings.general.row.titleModel.description": "用於產生和重新產生工作階段標題的模型",
  "settings.general.row.titleModel.default": "預設（小型模型）",
  "settings.general.row.titlePrompt.edit": "編輯提示詞",
  ...
  "toast.title.regenerated": "工作階段標題已更新",
  "toast.title.failed": "產生工作階段標題失敗",
  "toast.title.keepExisting": "已保留標題 — 產生期間標題已變更",
  ...
  "session.changes.noVcs.createGit.title": "建立 Git 儲存庫",
  "session.changes.noVcs.createGit.description": "追蹤、檢閱及復原此專案中的變更",
  "session.changes.noVcs.createGit.actionLoading": "正在建立 Git 儲存庫...",
  "session.changes.noVcs.createGit.action": "建立 Git 儲存庫",
