...
export const dict = {
  ...
  "command.fileTree.toggle": "Dateibaum umschalten",  "command.terminal.new": "Neues Terminal",
  ...
  "command.browser.toggle": "Browser umschalten",
  "browser.address.placeholder": "Adresse suchen oder eingeben",
  "browser.nav.back": "Zurück",
  "browser.nav.forward": "Vor",
  "browser.nav.reload": "Neu laden",
  "browser.nav.stop": "Stopp",
  "browser.nav.newTab": "Neuer Tab",
  ...
  "browser.panel.empty": "Keine Seiten geöffnet",
  "browser.panel.unavailable": "Der Browser ist nur in der Desktop-App verfügbar",
  "browser.mode.fill": "Füllen",
  "browser.mode.freeform": "Frei",
  "browser.mode.preset": "Voreinstellung",
  "browser.viewportMode": "Viewport-Modus",
  "browser.rotate": "Drehen",
  "browser.aspectLock": "Seitenverhältnis sperren",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "Abzeichen",
  "browser.badges.toggle": "Element-Abzeichen umschalten",
  ...
  "browser.resize.left": "Von der linken Kante aus skalieren",
  "browser.resize.right": "Von der rechten Kante aus skalieren",
  "browser.resize.bottom": "Von der unteren Kante aus skalieren",
  "browser.resize.bottom-left": "Von der unteren linken Ecke aus skalieren",
  "browser.resize.bottom-right": "Von der unteren rechten Ecke aus skalieren",
  "browser.crash.title": "Diese Seite ist abgestürzt",
  "browser.crash.reload": "Seite neu laden",
  "browser.action.running": "Wird ausgeführt",
  "browser.action.succeeded": "Erfolgreich",
  "browser.action.failed": "Fehlgeschlagen",
  "browser.action.interrupted": "Unterbrochen",
  "browser.summary.interactive": "Interaktiv",
  "browser.summary.forms": "Formulare",
  "browser.summary.consoleErrors": "Konsolenfehler",
  "browser.summary.failedRequests": "Fehlgeschlagene Anforderungen",
  ...
  "dialog.credential.manageKeys": "API-Schlüssel verwalten",
  "dialog.credential.title": "OpenCode-API-Schlüssel",
  "dialog.credential.description": "Wechseln Sie zwischen Ihren verbundenen OpenCode-API-Schlüsseln oder verwalten Sie die gespeicherten.",
  "dialog.credential.active": "Aktiv",
  "dialog.credential.select": "Zu diesem Schlüssel wechseln",
  "dialog.credential.rename": "Umbenennen",
  "dialog.credential.remove": "Entfernen",
  "dialog.credential.add": "API-Schlüssel hinzufügen",
  "dialog.credential.rename.placeholder": "Bezeichnung",
  "dialog.credential.empty": "Noch keine API-Schlüssel verbunden.",
  "provider.connect.apiKey.labelName": "Bezeichnung",
  "provider.connect.apiKey.labelPlaceholder": "z. B. Persönlich, Arbeit",
  ...
  "dialog.titlePrompt.token.previousTitle": "Wird durch den aktuellen Session-Titel ersetzt",
  "dialog.titlePrompt.token.conversation": "Immer angehängt, auch wenn du es weglässt",
  "usage.go.title": "OpenCode Go-Nutzung",
  "usage.window.5h": "5 Stunden",
  "usage.window.week": "Wöchentlich",
  "usage.window.month": "Monatlich",
  "usage.calls.one": "{{count}} Aufruf",
  "usage.calls.other": "{{count}} Aufrufe",
  "usage.reset": "Zurücksetzen",
  "usage.clear": "Löschen",
  "usage.reset.predicted": "Vorhergesagt",
  ...
  "dialog.titlePrompt.title": "Titelgenerierungs-Prompt",
  "dialog.titlePrompt.description": "Anweisungen für das Titelmodell. Die Konversation wird immer angehängt; {previousTitle} wird durch den aktuellen Titel ersetzt.",
  "dialog.titlePrompt.placeholder": "Eigene Anweisungen (leer = Standard-Prompt)",
  "dialog.titlePrompt.reset": "Auf Standard zurücksetzen",
  ...
  "session.tab.changes": "Überprüfung",
  "session.tab.context": "Kontext",
  "session.tab.unknown": "Unbekannte Sitzung",
  "session.panel.fileBrowser": "Überprüfung und Dateien",
  ...
  "session.changes.filesChanged": "Geänderte Dateien: {{count}}",
  "session.changes.change.one": "Änderung",
  "session.changes.change.other": "Änderungen",
  "session.changes.loadingChanges": "Änderungen werden geladen…",
  "session.changes.empty": "Noch keine Änderungen in dieser Sitzung",
  "session.changes.noVcs": "Kein Git-Versionskontrollsystem erkannt. Änderungen werden nicht angezeigt",
  ...
  "session.changes.noChanges": "Keine Änderungen",
  "session.changes.noUncommittedChanges": "Noch keine nicht committeten Änderungen",
  "session.changes.noBranchChanges": "Noch keine Branch-Änderungen",
  ...
  "settings.general.section.titleGeneration": "Titelgenerierung",
  ...
  "settings.general.row.titleModel.title": "Titelmodell",
  "settings.general.row.titleModel.description": "Modell zum Generieren und Regenerieren von Session-Titeln",
  "settings.general.row.titleModel.default": "Standard (kleines Modell)",
  "settings.general.row.titlePrompt.edit": "Prompt bearbeiten",
  ...
  "toast.title.regenerated": "Session-Titel aktualisiert",
  "toast.title.failed": "Session-Titel konnte nicht generiert werden",
  "toast.title.keepExisting": "Titel beibehalten – er wurde während der Generierung geändert",
  ...
  "session.changes.noVcs.createGit.title": "Git-Repository erstellen",
  "session.changes.noVcs.createGit.description":
    "Änderungen in diesem Projekt verfolgen, überprüfen und rückgängig machen",
  "session.changes.noVcs.createGit.actionLoading": "Git-Repository wird erstellt…",
  "session.changes.noVcs.createGit.action": "Git-Repository erstellen",
