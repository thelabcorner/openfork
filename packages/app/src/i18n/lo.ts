export const dict = {
  ...
  "command.fileTree.toggle": "ສະຫຼັບຕົ້ນໄມ້ໄຟລ໌",  "command.terminal.new": "ສະຖານີໃໝ່",
  ...
  "dialog.credential.manageKeys": "ຈັດການກະແຈ API",
  "dialog.credential.title": "ກະແຈ OpenCode API",
  "dialog.credential.description": "ປ່ຽນລະຫວ່າງກະແຈ OpenCode API ທີ່ເຊື່ອມຕໍ່ ຫຼືຈັດການກັບທີ່ບັນທຶກໄວ້.",
  "dialog.credential.active": "ເຄື່ອນໄຫວ",
  "dialog.credential.select": "ປ່ຽນໄປກະແຈນີ້",
  "dialog.credential.rename": "ປ່ຽນຊື່",
  "dialog.credential.remove": "ລຶບອອກ",
  "dialog.credential.add": "ເພີ່ມກະແຈ API",
  "dialog.credential.rename.placeholder": "ປ້າຍກຳກັບ",
  "dialog.credential.empty": "ຍັງບໍ່ທັນມີກະແຈ API ທີ່ເຊື່ອມຕໍ່ເທື່ອ.",
  "provider.connect.apiKey.labelName": "ປ້າຍກຳກັບ",
  "provider.connect.apiKey.labelPlaceholder": "ເຊັ່ນ: ສ່ວນຕົວ, ວຽກ",
  ...
  "dialog.titlePrompt.default": "ພຣອມພ໌ຕ໌ເລີ່ມຕົ້ນ",
  "dialog.titlePrompt.token.previousTitle": "ຖືກແທນທີ່ດ້ວຍຊື່ເຊສຊັນປັດຈຸບັນ",
  "dialog.titlePrompt.token.conversation": "ຖືກແນບສະເໝີ ເຖິງແມ່ນວ່າຈະລືມໃສ່",
  "usage.go.title": "ການໃຊ້ງານ OpenCode Go",
  "usage.window.5h": "5 ຊົ່ວໂມງ",
  "usage.window.week": "ປະຈໍາອາທິດ",
  "usage.window.month": "ປະຈໍາເດືອນ",
  "usage.calls.one": "{{count}} ການໂທ",
  "usage.calls.other": "{{count}} ການໂທ",
  "usage.reset": "ຣີເຊັດ",
  "usage.clear": "ລຶບ",
  "usage.reset.predicted": "ທີ່ຄາດຄະເນ",
  ...
  "dialog.titlePrompt.title": "ພຣອມພ໌ຕ໌ສ້າງຊື່ເລື່ອງ",
  "dialog.titlePrompt.description": "ຄໍາແນະນໍາສໍາລັບຕົວແບບຊື່ເລື່ອງ. ການສົນທະນາຖືກແນບມາໃຫ້ສະເໝີ; {previousTitle} ຈະຖືກແທນທີ່ດ້ວຍຊື່ເລື່ອງປັດຈຸບັນ.",
  "dialog.titlePrompt.placeholder": "ຄໍາແນະນໍາທີ່ກໍານົດເອງ (ຫວ່າງ = ພຣອມພ໌ຕ໌ເລີ່ມຕົ້ນ)",
  "dialog.titlePrompt.reset": "ຣີເຊັດກັບຄ່າເລີ່ມຕົ້ນ",
  ...
  "toast.title.regenerated": "ອັບເດດຊື່ເລື່ອງເຊສຊັນແລ້ວ",
  "toast.title.failed": "ບໍ່ສາມາດສ້າງຊື່ເລື່ອງເຊສຊັນໄດ້",
  "toast.title.keepExisting": "ຮັກສາຊື່ເລື່ອງໄວ້ — ມັນປ່ຽນໄປໃນລະຫວ່າງການສ້າງ",
  ...
  "session.tab.changes": "ການທົບທວນຄືນ",
  "session.tab.context": "ບໍລິບົດ",
  "session.tab.unknown": "ເຊດຊັນທີ່ບໍ່ຮູ້ຈັກ",
  "session.panel.fileBrowser": "ການທົບທວນຄືນແລະໄຟລ໌",
  ...
  "session.changes.filesChanged": "ໄຟລ໌ປ່ຽນ {{count}}",
  "session.changes.change.one": "ປ່ຽນແປງ",
  "session.changes.change.other": "ການປ່ຽນແປງ",
  "session.changes.loadingChanges": "ກຳລັງໂຫຼດການປ່ຽນແປງ...",
  "session.changes.empty": "ບໍ່ມີການປ່ຽນແປງໃນເຊດຊັນນີ້ເທື່ອ",
  "session.changes.noVcs": "ບໍ່ພົບລະບົບການຄວບຄຸມເວີຊັນ Git, ການປ່ຽນແປງບໍ່ສະແດງ",
  "session.changes.noVcs.createGit.title": "ສ້າງບ່ອນເກັບຂໍ້ມູນ Git",
  "session.changes.noVcs.createGit.description": "ຕິດຕາມ, ທົບທວນ, ແລະຍົກເລີກການປ່ຽນແປງໃນໂຄງການນີ້",
  "session.changes.noVcs.createGit.actionLoading": "ກຳລັງສ້າງບ່ອນເກັບຂໍ້ມູນ Git...",
  "session.changes.noVcs.createGit.action": "ສ້າງບ່ອນເກັບຂໍ້ມູນ Git",
  "session.changes.noSnapshot": "ການຕິດຕາມພາບຖ່າຍຖືກປິດໃຊ້ງານຢູ່ໃນການຕັ້ງຄ່າ, ດັ່ງນັ້ນການປ່ຽນແປງເຊດຊັນບໍ່ສາມາດໃຊ້ໄດ້",
  "session.changes.noChanges": "ບໍ່ມີການປ່ຽນແປງ",
  "session.changes.noUncommittedChanges": "ບໍ່ມີການປ່ຽນແປງທີ່ບໍ່ໄດ້ຕົກລົງເທື່ອ",
  "session.changes.noBranchChanges": "ບໍ່ມີການປ່ຽນແປງສາຂາເທື່ອ",
  ...
  "settings.general.section.titleGeneration": "ການສ້າງຊື່ເລື່ອງ",
  ...
  "settings.general.row.titleModel.title": "ຕົວແບບຊື່ເລື່ອງ",
  "settings.general.row.titleModel.description": "ຕົວແບບທີ່ໃຊ້ສໍາລັບສ້າງ ແລະ ສ້າງໃໝ່ຊື່ເລື່ອງຂອງເຊສຊັນ",
  "settings.general.row.titleModel.default": "ຄ່າເລີ່ມຕົ້ນ (ຕົວແບບນ້ອຍ)",
  "settings.general.row.titlePrompt.edit": "ແກ້ໄຂພຣອມພ໌ຕ໌",
