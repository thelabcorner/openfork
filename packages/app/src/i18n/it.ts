export const dict = {
  ...
  "command.fileTree.toggle": "Mostra o nascondi l'albero dei file",  "command.terminal.new": "Nuovo terminale",
  ...
  "command.browser.toggle": "Attiva/disattiva browser",
  "browser.address.placeholder": "Cerca o inserisci un indirizzo",
  "browser.nav.back": "Indietro",
  "browser.nav.forward": "Avanti",
  "browser.nav.reload": "Ricarica",
  "browser.nav.stop": "Ferma",
  "browser.nav.newTab": "Nuova scheda",
  ...
  "browser.panel.empty": "Nessuna pagina aperta",
  "browser.panel.unavailable": "Il browser è disponibile solo nell'app desktop",
  "browser.mode.fill": "Riempi",
  "browser.mode.freeform": "Libero",
  "browser.mode.preset": "Preimpostato",
  "browser.viewportMode": "Modalità viewport",
  "browser.rotate": "Ruota",
  "browser.aspectLock": "Blocca proporzioni",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "Distintivi",
  "browser.badges.toggle": "Attiva/disattiva distintivi elementi",
  ...
  "browser.resize.left": "Ridimensiona dal bordo sinistro",
  "browser.resize.right": "Ridimensiona dal bordo destro",
  "browser.resize.bottom": "Ridimensiona dal bordo inferiore",
  "browser.resize.bottom-left": "Ridimensiona dall'angolo inferiore sinistro",
  "browser.resize.bottom-right": "Ridimensiona dall'angolo inferiore destro",
  "browser.crash.title": "Questa pagina si è arrestata",
  "browser.crash.reload": "Ricarica pagina",
  "browser.action.running": "In esecuzione",
  "browser.action.succeeded": "Riuscito",
  "browser.action.failed": "Non riuscito",
  "browser.action.interrupted": "Interrotto",
  "browser.summary.interactive": "Interattivi",
  "browser.summary.forms": "Moduli",
  "browser.summary.consoleErrors": "Errori di console",
  "browser.summary.failedRequests": "Richieste non riuscite",
  ...
  "dialog.credential.manageKeys": "Gestisci chiavi API",
  "dialog.credential.title": "Chiavi API OpenCode",
  "dialog.credential.description": "Passa da una all'altra delle tue chiavi API OpenCode connesse o gestisci quelle salvate.",
  "dialog.credential.active": "Attiva",
  "dialog.credential.select": "Passa a questa chiave",
  "dialog.credential.rename": "Rinomina",
  "dialog.credential.remove": "Rimuovi",
  "dialog.credential.add": "Aggiungi chiave API",
  "dialog.credential.rename.placeholder": "Etichetta",
  "dialog.credential.empty": "Nessuna chiave API connessa.",
  "provider.connect.apiKey.labelName": "Etichetta",
  "provider.connect.apiKey.labelPlaceholder": "es. Personale, Lavoro",
  ...
  "dialog.titlePrompt.default": "Prompt predefinito",
  "dialog.titlePrompt.token.previousTitle": "Sostituito con il titolo corrente della sessione",
  "dialog.titlePrompt.token.conversation": "Sempre allegata, anche se la ometti",
  "usage.go.title": "Utilizzo di OpenCode Go",
  "usage.window.5h": "5 ore",
  "usage.window.week": "Settimanale",
  "usage.window.month": "Mensile",
  "usage.calls.one": "{{count}} chiamata",
  "usage.calls.other": "{{count}} chiamate",
  "usage.calls.many": "{{count}} chiamate",
  "usage.reset": "Ripristina",
  "usage.clear": "Cancella",
  "usage.reset.predicted": "Previsto",
  ...
  "dialog.titlePrompt.title": "Prompt di generazione del titolo",
  "dialog.titlePrompt.description": "Istruzioni per il modello dei titoli. La conversazione viene sempre allegata; {previousTitle} viene sostituito con il titolo corrente.",
  "dialog.titlePrompt.placeholder": "Istruzioni personalizzate (vuoto = prompt predefinito)",
  "dialog.titlePrompt.reset": "Ripristina predefinito",
  ...
  "toast.title.regenerated": "Titolo della sessione aggiornato",
  "toast.title.failed": "Impossibile generare il titolo della sessione",
  "toast.title.keepExisting": "Titolo conservato: è cambiato durante la generazione",
  ...
  "session.tab.changes": "Revisione",
  "session.tab.context": "Contesto",
  "session.tab.unknown": "Sessione sconosciuta",
  "session.panel.fileBrowser": "Revisione e file",
  ...
  "session.changes.filesChanged": "{{count}} file modificati",
  "session.changes.change.one": "Modifica",
  "session.changes.change.other": "Modifiche",
  "session.changes.loadingChanges": "Caricamento modifiche...",
  "session.changes.empty": "Nessuna modifica ancora in questa sessione",
  "session.changes.noVcs": "Nessun sistema di controllo della versione Git rilevato, modifiche non visualizzate",
  "session.changes.noVcs.createGit.title": "Crea un repository Git",
  "session.changes.noVcs.createGit.description": "Tieni traccia, rivedi e annulla le modifiche in questo progetto",
  "session.changes.noVcs.createGit.actionLoading": "Creazione del repository Git in corso...",
  "session.changes.noVcs.createGit.action": "Crea un repository Git",
  ...
  "session.changes.noChanges": "Nessuna modifica",
  "session.changes.noUncommittedChanges": "Ancora nessuna modifica senza commit",
  "session.changes.noBranchChanges": "Ancora nessuna modifica del branch",
  ...
  "settings.general.section.titleGeneration": "Generazione del titolo",
  ...
  "settings.general.row.titleModel.title": "Modello per il titolo",
  "settings.general.row.titleModel.description": "Modello usato per generare e rigenerare i titoli delle sessioni",
  "settings.general.row.titleModel.default": "Predefinito (modello piccolo)",
  "settings.general.row.titlePrompt.edit": "Modifica prompt",
