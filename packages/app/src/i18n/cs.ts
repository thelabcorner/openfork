export const dict = {
  ...
  "command.fileTree.toggle": "Přepnout strom souborů",  "command.terminal.new": "Nový terminál",
  ...
  "command.browser.toggle": "Přepnout prohlížeč",
  "browser.address.placeholder": "Hledat nebo zadat adresu",
  "browser.nav.back": "Zpět",
  "browser.nav.forward": "Vpřed",
  "browser.nav.reload": "Znovu načíst",
  "browser.nav.stop": "Zastavit",
  ...
  "browser.panel.empty": "Žádné otevřené stránky",
  "browser.panel.unavailable": "Prohlížeč je k dispozici pouze v desktopové aplikaci",
  "browser.mode.fill": "Vyplnit",
  "browser.mode.freeform": "Volný",
  "browser.mode.preset": "Předvolba",
  "browser.viewportMode": "Režim výřezu",
  "browser.rotate": "Otočit",
  "browser.aspectLock": "Zamknout poměr stran",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "Odznaky",
  "browser.badges.toggle": "Přepnout odznaky prvků",
  ...
  "browser.resize.left": "Změnit velikost od levého okraje",
  "browser.resize.right": "Změnit velikost od pravého okraje",
  "browser.resize.bottom": "Změnit velikost od dolního okraje",
  "browser.resize.bottom-left": "Změnit velikost od levého dolního rohu",
  "browser.resize.bottom-right": "Změnit velikost od pravého dolního rohu",
  "browser.crash.title": "Tato stránka spadla",
  "browser.crash.reload": "Znovu načíst stránku",
  "browser.action.running": "Probíhá",
  "browser.action.succeeded": "Úspěšné",
  "browser.action.failed": "Selhalo",
  "browser.action.interrupted": "Přerušeno",
  "browser.summary.interactive": "Interaktivní",
  "browser.summary.forms": "Formuláře",
  "browser.summary.consoleErrors": "Chyby konzole",
  "browser.summary.failedRequests": "Neúspěšné požadavky",
  ...
  "dialog.credential.manageKeys": "Spravovat klíče API",
  "dialog.credential.title": "Klíče OpenCode API",
  "dialog.credential.description": "Přepínejte mezi připojenými klíči OpenCode API nebo spravujte uložené.",
  "dialog.credential.active": "Aktivní",
  "dialog.credential.select": "Přepnout na tento klíč",
  "dialog.credential.rename": "Přejmenovat",
  "dialog.credential.remove": "Odebrat",
  "dialog.credential.add": "Přidat klíč API",
  "dialog.credential.rename.placeholder": "Štítek",
  "dialog.credential.empty": "Zatím nejsou připojeny žádné klíče API.",
  "provider.connect.apiKey.labelName": "Štítek",
  "provider.connect.apiKey.labelPlaceholder": "např. Osobní, Pracovní",
  ...
  "dialog.titlePrompt.default": "Výchozí prompt",
  "dialog.titlePrompt.token.previousTitle": "Nahrazeno aktuálním názvem relace",
  "dialog.titlePrompt.token.conversation": "Vždy připojena, i když ji vynecháte",
  "usage.go.title": "Využití OpenCode Go",
  "usage.window.5h": "5 hodin",
  "usage.window.week": "Týdně",
  "usage.window.month": "Měsíčně",
  "usage.calls.one": "{{count}} volání",
  "usage.calls.other": "{{count}} volání",
  "usage.calls.few": "{{count}} volání",
  "usage.calls.many": "{{count}} volání",
  "usage.reset": "Obnovit",
  "usage.clear": "Vymazat",
  "usage.reset.predicted": "Předpověď",
  ...
  "dialog.titlePrompt.title": "Prompt pro generování názvu",
  "dialog.titlePrompt.description": "Instrukce pro model názvů. Konverzace se vždy připojuje; {previousTitle} se nahradí aktuálním názvem.",
  "dialog.titlePrompt.placeholder": "Vlastní instrukce (prázdné = výchozí prompt)",
  "dialog.titlePrompt.reset": "Obnovit výchozí",
  ...
  "toast.title.regenerated": "Název relace aktualizován",
  "toast.title.failed": "Nepodařilo se vygenerovat název relace",
  "toast.title.keepExisting": "Název zachován — změnil se během generování",
  ...
  "session.tab.changes": "Recenze",
  "session.tab.context": "Kontext",
  "session.tab.unknown": "Neznámá relace",
  "session.panel.fileBrowser": "Recenze a soubory",
  ...
  "session.changes.filesChanged": "Soubory změněny {{count}}",
  "session.changes.change.one": "Změna",
  "session.changes.change.other": "Změny",
  "session.changes.loadingChanges": "Načítání změn...",
  "session.changes.empty": "V této relaci zatím žádné změny",
  "session.changes.noVcs": "Ne Git Zjištěn systém správy verzí, změny se nezobrazují",
  "session.changes.noVcs.createGit.title": "Vytvořte úložiště Git",
  "session.changes.noVcs.createGit.description": "Sledujte, kontrolujte a vracejte změny v tomto projektu",
  "session.changes.noVcs.createGit.actionLoading": "Vytváření Git úložiště...",
  "session.changes.noVcs.createGit.action": "Vytvořit Git úložiště",
  "session.changes.noSnapshot": "Sledování snímků je v konfiguraci zakázáno, takže změny relace nejsou dostupné",
  "session.changes.noChanges": "Žádné změny",
  "session.changes.noUncommittedChanges": "Zatím žádné neprovedené změny",
  "session.changes.noBranchChanges": "Zatím žádné změny ve větvi",
  ...
  "settings.general.section.titleGeneration": "Generování názvů",
  ...
  "settings.general.row.titleModel.title": "Model názvů",
  "settings.general.row.titleModel.description": "Model používaný ke generování a regenerování názvů relací",
  "settings.general.row.titleModel.default": "Výchozí (malý model)",
  "settings.general.row.titlePrompt.edit": "Upravit prompt",
