export const dict = {
  ...
  "command.fileTree.toggle": "ფაილის ხის გადართვა",  "command.terminal.new": "ახალი ტერმინალი",
  ...
  "dialog.credential.manageKeys": "API გასაღებების მართვა",
  "dialog.credential.title": "OpenCode API გასაღებები",
  "dialog.credential.description": "გადართეთ დაკავშირებულ OpenCode API გასაღებებს შორის ან მართეთ შენახული.",
  "dialog.credential.active": "აქტიური",
  "dialog.credential.select": "ამ გასაღებზე გადართვა",
  "dialog.credential.rename": "გადარქმევა",
  "dialog.credential.remove": "წაშლა",
  "dialog.credential.add": "API გასაღების დამატება",
  "dialog.credential.rename.placeholder": "იარლიყი",
  "dialog.credential.empty": "დაკავშირებული API გასაღებები ჯერ არ არის.",
  "provider.connect.apiKey.labelName": "იარლიყი",
  "provider.connect.apiKey.labelPlaceholder": "მაგ., პირადი, სამუშაო",
  ...
  "dialog.titlePrompt.default": "ნაგულისხმევი პრომპტი",
  "dialog.titlePrompt.token.previousTitle": "იცვლება სესიის მიმდინარე სათაურით",
  "dialog.titlePrompt.token.conversation": "ყოველთვის ერთვის, თუნდაც გამოტოვოთ",
  "usage.go.title": "OpenCode Go-ს გამოყენება",
  "usage.window.5h": "5 საათი",
  "usage.window.week": "კვირეული",
  "usage.window.month": "თვიური",
  "usage.calls.one": "{{count}} ზარი",
  "usage.calls.other": "{{count}} ზარი",
  "usage.reset": "გადატვირთვა",
  "usage.clear": "გასუფთავება",
  "usage.reset.predicted": "პროგნოზი",
  ...
  "dialog.titlePrompt.title": "სათაურის გენერაციის პრომპტი",
  "dialog.titlePrompt.description": "ინსტრუქციები სათაურის მოდელისთვის. საუბარი ყოველთვის ერთვის; {previousTitle} იცვლება მიმდინარე სათაურით.",
  "dialog.titlePrompt.placeholder": "მორგებული ინსტრუქციები (ცარიელი = ნაგულისხმევი პრომპტი)",
  "dialog.titlePrompt.reset": "ნაგულისხმევზე დაბრუნება",
  ...
  "toast.title.regenerated": "სესიის სათაური განახლდა",
  "toast.title.failed": "სესიის სათაურის გენერირება ვერ მოხერხდა",
  "toast.title.keepExisting": "სათაური შენარჩუნდა — ის გენერაციისას შეიცვალა",
  ...
  "session.tab.changes": "მიმოხილვა",
  "session.tab.context": "კონტექსტი",
  "session.tab.unknown": "უცნობი სესია",
  "session.panel.fileBrowser": "მიმოხილვა და ფაილები",
  ...
  "session.changes.filesChanged": "ფაილები შეიცვალა {{count}}",
  "session.changes.change.one": "შეცვლა",
  "session.changes.change.other": "ცვლილებები",
  "session.changes.loadingChanges": "ცვლილებების ჩატვირთვა...",
  "session.changes.empty": "ამ სესიაში ცვლილებები ჯერ არ არის",
  "session.changes.noVcs": "არ არის აღმოჩენილი Git ვერსიის კონტროლის სისტემა, ცვლილებები არ არის ნაჩვენები",
  "session.changes.noVcs.createGit.title": "შექმენით Git საცავი",
  "session.changes.noVcs.createGit.description": "თვალყური ადევნეთ, გადახედეთ და გააუქმეთ ცვლილებები ამ პროექტში",
  "session.changes.noVcs.createGit.actionLoading": "Git საცავის შექმნა...",
  "session.changes.noVcs.createGit.action": "შექმენით Git საცავი",
  "session.changes.noSnapshot": "Snapshot tracking გამორთულია კონფიგურაციაში, ამიტომ სესიის ცვლილებები მიუწვდომელია",
  "session.changes.noChanges": "ცვლილებები არ არის",
  "session.changes.noUncommittedChanges": "შეუსრულებელი ცვლილებები ჯერ არ არის",
  "session.changes.noBranchChanges": "ფილიალი ჯერ არ არის ცვლილებები",
  ...
  "settings.general.section.titleGeneration": "სათაურის გენერაცია",
  ...
  "settings.general.row.titleModel.title": "სათაურის მოდელი",
  "settings.general.row.titleModel.description": "მოდელი სესიის სათაურების გენერირებისა და ხელახალი გენერირებისთვის",
  "settings.general.row.titleModel.default": "ნაგულისხმევი (მცირე მოდელი)",
  "settings.general.row.titlePrompt.edit": "პრომპტის რედაქტირება",
