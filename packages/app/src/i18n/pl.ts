export const dict = {
  ...
  "command.fileTree.toggle": "Przełącz drzewo plików",  "command.terminal.new": "Nowy terminal",
  ...
  "command.browser.toggle": "Przełącz przeglądarkę",
  "browser.address.placeholder": "Szukaj lub wpisz adres",
  "browser.nav.back": "Wstecz",
  "browser.nav.forward": "Do przodu",
  "browser.nav.reload": "Odśwież",
  "browser.nav.stop": "Zatrzymaj",
  "browser.nav.newTab": "Nowa karta",
  ...
  "browser.panel.empty": "Brak otwartych stron",
  "browser.panel.unavailable": "Przeglądarka jest dostępna tylko w aplikacji desktopowej",
  "browser.mode.fill": "Wypełnij",
  "browser.mode.freeform": "Swobodny",
  "browser.mode.preset": "Preset",
  "browser.viewportMode": "Tryb widoku",
  "browser.rotate": "Obróć",
  "browser.aspectLock": "Zablokuj proporcje",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "Odznaki",
  "browser.badges.toggle": "Przełącz odznaki elementów",
  ...
  "browser.resize.left": "Zmień rozmiar od lewej krawędzi",
  "browser.resize.right": "Zmień rozmiar od prawej krawędzi",
  "browser.resize.bottom": "Zmień rozmiar od dolnej krawędzi",
  "browser.resize.bottom-left": "Zmień rozmiar od lewego dolnego rogu",
  "browser.resize.bottom-right": "Zmień rozmiar od prawego dolnego rogu",
  "browser.crash.title": "Ta strona uległa awarii",
  "browser.crash.reload": "Przeładuj stronę",
  "browser.action.running": "W trakcie",
  "browser.action.succeeded": "Powodzenie",
  "browser.action.failed": "Niepowodzenie",
  "browser.action.interrupted": "Przerwano",
  "browser.summary.interactive": "Interaktywne",
  "browser.summary.forms": "Formularze",
  "browser.summary.consoleErrors": "Błędy konsoli",
  "browser.summary.failedRequests": "Nieudane żądania",
  ...
  "dialog.credential.manageKeys": "Zarządzaj kluczami API",
  "dialog.credential.title": "Klucze API OpenCode",
  "dialog.credential.description": "Przełączaj się między połączonymi kluczami API OpenCode lub zarządzaj zapisanymi.",
  "dialog.credential.active": "Aktywny",
  "dialog.credential.select": "Przełącz na ten klucz",
  "dialog.credential.rename": "Zmień nazwę",
  "dialog.credential.remove": "Usuń",
  "dialog.credential.add": "Dodaj klucz API",
  "dialog.credential.rename.placeholder": "Etykieta",
  "dialog.credential.empty": "Nie połączono jeszcze żadnych kluczy API.",
  "provider.connect.apiKey.labelName": "Etykieta",
  "provider.connect.apiKey.labelPlaceholder": "np. Osobisty, Praca",
  ...
  "dialog.titlePrompt.default": "Domyślny prompt",
  "dialog.titlePrompt.token.previousTitle": "Zastępowane bieżącym tytułem sesji",
  "dialog.titlePrompt.token.conversation": "Zawsze dołączana, nawet jeśli ją pominiesz",
  "usage.go.title": "Użycie OpenCode Go",
  "usage.window.5h": "5 godzin",
  "usage.window.week": "Tygodniowo",
  "usage.window.month": "Miesięcznie",
  "usage.calls.one": "{{count}} wywołanie",
  "usage.calls.other": "{{count}} wywołań",
  "usage.calls.few": "{{count}} wywołań",
  "usage.calls.many": "{{count}} wywołań",
  "usage.reset": "Resetuj",
  "usage.clear": "Wyczyść",
  "usage.reset.predicted": "Przewidywane",
  ...
  "dialog.titlePrompt.title": "Prompt generowania tytułu",
  "dialog.titlePrompt.description": "Instrukcje dla modelu tytułów. Rozmowa jest zawsze dołączana; {previousTitle} zostaje zastąpione bieżącym tytułem.",
  "dialog.titlePrompt.placeholder": "Własne instrukcje (puste = domyślny prompt)",
  "dialog.titlePrompt.reset": "Przywróć domyślne",
  ...
  "session.tab.changes": "Przegląd",
  "session.tab.context": "Kontekst",
  "session.tab.unknown": "Nieznana sesja",
  "session.panel.fileBrowser": "Przegląd i pliki",
  ...
  "session.changes.filesChanged": "Zmieniono {{count}} plików",
  "session.changes.change.one": "Zmiana",
  "session.changes.change.other": "Zmiany",
  "session.changes.loadingChanges": "Ładowanie zmian...",
  "session.changes.empty": "Brak zmian w tej sesji",
  "session.changes.noVcs": "Nie wykryto systemu kontroli wersji Git, dlatego zmiany nie są wyświetlane",
  "session.changes.noSnapshot": "Śledzenie migawek jest wyłączone w konfiguracji, więc zmiany w sesji są niedostępne",
  "session.changes.noChanges": "Brak zmian",
  "session.changes.noUncommittedChanges": "Brak jeszcze niezatwierdzonych zmian",
  "session.changes.noBranchChanges": "Brak jeszcze zmian w gałęzi",
  ...
  "settings.general.section.titleGeneration": "Generowanie tytułu",
  ...
  "settings.general.row.titleModel.title": "Model tytułów",
  "settings.general.row.titleModel.description": "Model używany do generowania i ponownego generowania tytułów sesji",
  "settings.general.row.titleModel.default": "Domyślny (mały model)",
  "settings.general.row.titlePrompt.edit": "Edytuj prompt",
  ...
  "toast.title.regenerated": "Zaktualizowano tytuł sesji",
  "toast.title.failed": "Nie udało się wygenerować tytułu sesji",
  "toast.title.keepExisting": "Tytuł zachowany — zmienił się podczas generowania",
  ...
  "session.changes.noVcs.createGit.title": "Utwórz repozytorium Git",
  "session.changes.noVcs.createGit.description": "Śledź, przeglądaj i cofaj zmiany w tym projekcie",
  "session.changes.noVcs.createGit.actionLoading": "Tworzenie repozytorium Git...",
  "session.changes.noVcs.createGit.action": "Utwórz repozytorium Git",
