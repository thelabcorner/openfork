export const dict = {
  ...
  "command.fileTree.toggle": "Preklop drevesa datotek",  "command.terminal.new": "Nov terminal",
  ...
  "dialog.credential.manageKeys": "Upravljaj API ključi",
  "dialog.credential.title": "OpenCode API ključi",
  "dialog.credential.description": "Preklapljajte med povezanimi OpenCode API ključi ali upravljajte shranjene.",
  "dialog.credential.active": "Aktiven",
  "dialog.credential.select": "Preklopi na ta ključ",
  "dialog.credential.rename": "Preimenuj",
  "dialog.credential.remove": "Odstrani",
  "dialog.credential.add": "Dodaj API ključ",
  "dialog.credential.rename.placeholder": "Oznaka",
  "dialog.credential.empty": "Povezanih API ključev še ni.",
  "provider.connect.apiKey.labelName": "Oznaka",
  "provider.connect.apiKey.labelPlaceholder": "npr. Osebni, Služba",
  ...
  "dialog.titlePrompt.default": "Privzeti poziv",
  "dialog.titlePrompt.token.previousTitle": "Nadomesti se s trenutnim naslovom seje",
  "dialog.titlePrompt.token.conversation": "Vedno priložena, tudi če jo izpustite",
  "usage.go.title": "Uporaba OpenCode Go",
  "usage.window.5h": "5 ur",
  "usage.window.week": "Tedensko",
  "usage.window.month": "Mesečno",
  "usage.calls.one": "{{count}} klic",
  "usage.calls.other": "{{count}} klicev",
  "usage.calls.two": "{{count}} klicev",
  "usage.calls.few": "{{count}} klicev",
  "usage.reset": "Ponastavi",
  "usage.clear": "Počisti",
  "usage.reset.predicted": "Predvideno",
  ...
  "dialog.titlePrompt.title": "Poziv za ustvarjanje naslova",
  "dialog.titlePrompt.description": "Navodila za model naslovov. Pogovor je vedno priložen; {previousTitle} se nadomesti s trenutnim naslovom.",
  "dialog.titlePrompt.placeholder": "Lastna navodila (prazno = privzeti poziv)",
  "dialog.titlePrompt.reset": "Ponastavi na privzeto",
  ...
  "toast.title.regenerated": "Naslov seje posodobljen",
  "toast.title.failed": "Ustvarjanje naslova seje ni uspelo",
  "toast.title.keepExisting": "Naslov ohranjen — spremenil se je med ustvarjanjem",
  ...
  "session.tab.changes": "Pregled",
  "session.tab.context": "Kontekst",
  "session.tab.unknown": "Neznana seja",
  "session.panel.fileBrowser": "Pregled in datoteke",
  ...
  "session.changes.filesChanged": "Spremenjene datoteke {{count}}",
  "session.changes.change.one": "spremeniti",
  "session.changes.change.other": "Spremembe",
  "session.changes.loadingChanges": "Nalaganje sprememb ...",
  "session.changes.empty": "V tej seji še ni sprememb",
  "session.changes.noVcs": "Sistem za nadzor različic Git ni bil zaznan, spremembe niso prikazane",
  "session.changes.noVcs.createGit.title": "Ustvarite repozitorij Git",
  "session.changes.noVcs.createGit.description": "Sledite, pregledujte in razveljavite spremembe v tem projektu",
  "session.changes.noVcs.createGit.actionLoading": "Ustvarjanje skladišča Git ...",
  "session.changes.noVcs.createGit.action": "Ustvari repozitorij Git",
  "session.changes.noSnapshot": "Sledenje posnetku je onemogočeno v konfiguraciji, zato spremembe seje niso na voljo",
  "session.changes.noChanges": "Brez sprememb",
  "session.changes.noUncommittedChanges": "Ni še nepotrjenih sprememb",
  "session.changes.noBranchChanges": "Ni še nobenih sprememb veje",
  ...
  "settings.general.section.titleGeneration": "Ustvarjanje naslovov",
  ...
  "settings.general.row.titleModel.title": "Model naslovov",
  "settings.general.row.titleModel.description": "Model za ustvarjanje in ponovno ustvarjanje naslovov sej",
  "settings.general.row.titleModel.default": "Privzeto (majhen model)",
  "settings.general.row.titlePrompt.edit": "Uredi poziv",
