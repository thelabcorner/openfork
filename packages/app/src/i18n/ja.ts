export const dict = {
  ...
  "command.fileTree.toggle": "ファイルツリーを切り替え",  "command.terminal.new": "新しいターミナル",
  ...
  "command.browser.toggle": "ブラウザを切り替え",
  "browser.address.placeholder": "アドレスを検索または入力",
  "browser.nav.back": "戻る",
  "browser.nav.forward": "進む",
  "browser.nav.reload": "再読み込み",
  "browser.nav.stop": "停止",
  "browser.nav.newTab": "新しいタブ",
  ...
  "browser.panel.empty": "開いているページはありません",
  "browser.panel.unavailable": "ブラウザはデスクトップアプリでのみ利用できます",
  "browser.mode.fill": "フィル",
  "browser.mode.freeform": "フリーフォーム",
  "browser.mode.preset": "プリセット",
  "browser.viewportMode": "ビューポートモード",
  "browser.rotate": "回転",
  "browser.aspectLock": "アスペクト比を固定",
  "browser.dimension.width": "Width",
  "browser.dimension.height": "Height",
  "browser.badges": "バッジ",
  "browser.badges.toggle": "要素バッジの切り替え",
  ...
  "browser.resize.left": "左端からサイズ変更",
  "browser.resize.right": "右端からサイズ変更",
  "browser.resize.bottom": "下端からサイズ変更",
  "browser.resize.bottom-left": "左下隅からサイズ変更",
  "browser.resize.bottom-right": "右下隅からサイズ変更",
  "browser.crash.title": "このページはクラッシュしました",
  "browser.crash.reload": "ページを再読み込み",
  "browser.action.running": "実行中",
  "browser.action.succeeded": "成功",
  "browser.action.failed": "失敗",
  "browser.action.interrupted": "中断",
  "browser.summary.interactive": "インタラクティブ",
  "browser.summary.forms": "フォーム",
  "browser.summary.consoleErrors": "コンソールエラー",
  "browser.summary.failedRequests": "失敗したリクエスト",
  ...
  "dialog.credential.manageKeys": "APIキーを管理",
  "dialog.credential.title": "OpenCode APIキー",
  "dialog.credential.description": "接続済みのOpenCode APIキーを切り替えたり、保存したキーを管理します。",
  "dialog.credential.active": "アクティブ",
  "dialog.credential.select": "このキーに切り替え",
  "dialog.credential.rename": "名前を変更",
  "dialog.credential.remove": "削除",
  "dialog.credential.add": "APIキーを追加",
  "dialog.credential.rename.placeholder": "ラベル",
  "dialog.credential.empty": "接続済みのAPIキーはまだありません。",
  "provider.connect.apiKey.labelName": "ラベル",
  "provider.connect.apiKey.labelPlaceholder": "例: 個人、仕事",
  ...
  "dialog.titlePrompt.default": "デフォルトプロンプト",
  "dialog.titlePrompt.token.previousTitle": "現在のセッションタイトルに置き換えられます",
  "dialog.titlePrompt.token.conversation": "省略しても常に添付されます",
  "usage.go.title": "OpenCode Go の使用量",
  "usage.window.5h": "5時間",
  "usage.window.week": "週間",
  "usage.window.month": "月間",
  "usage.calls.one": "{{count}} 回の呼び出し",
  "usage.calls.other": "{{count}} 回の呼び出し",
  "usage.reset": "リセット",
  "usage.clear": "クリア",
  "usage.reset.predicted": "予測",
  ...
  "dialog.titlePrompt.title": "タイトル生成プロンプト",
  "dialog.titlePrompt.description": "タイトルモデルへの指示。会話は常に添付されます。{previousTitle} は現在のタイトルに置き換えられます。",
  "dialog.titlePrompt.placeholder": "カスタム指示（空欄 = デフォルトのプロンプト）",
  "dialog.titlePrompt.reset": "デフォルトにリセット",
  ...
  "session.tab.changes": "レビュー",
  "session.tab.context": "コンテキスト",
  "session.tab.unknown": "不明なセッション",
  "session.panel.fileBrowser": "レビューとファイル",
  ...
  "session.changes.filesChanged": "変更されたファイル: {{count}}件",
  "session.changes.change.one": "変更",
  "session.changes.change.other": "変更",
  "session.changes.loadingChanges": "変更を読み込み中...",
  "session.changes.empty": "このセッションでの変更はまだありません",
  "session.changes.noVcs": "Gitバージョン管理システムが検出されないため、変更は表示されません",
  "session.changes.noSnapshot": "設定でスナップショット追跡が無効になっているため、セッションの変更は利用できません",
  "session.changes.noChanges": "変更なし",
  "session.changes.noUncommittedChanges": "コミットされていない変更はまだありません",
  "session.changes.noBranchChanges": "ブランチの変更はまだありません",
  ...
  "settings.general.section.titleGeneration": "タイトル生成",
  ...
  "settings.general.row.titleModel.title": "タイトルモデル",
  "settings.general.row.titleModel.description": "セッションのタイトルの生成と再生成に使うモデル",
  "settings.general.row.titleModel.default": "デフォルト（小さいモデル）",
  "settings.general.row.titlePrompt.edit": "プロンプトを編集",
  ...
  "toast.title.regenerated": "セッションのタイトルを更新しました",
  "toast.title.failed": "セッションのタイトルを生成できませんでした",
  "toast.title.keepExisting": "タイトルを保持しました — 生成中に変更されました",
  ...
  "session.changes.noVcs.createGit.title": "Git リポジトリを作成",
  "session.changes.noVcs.createGit.description": "このプロジェクトの変更を追跡、レビュー、元に戻す",
  "session.changes.noVcs.createGit.actionLoading": "Git リポジトリを作成中...",
  "session.changes.noVcs.createGit.action": "Git リポジトリを作成",
