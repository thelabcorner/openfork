// Structural subset of the synced message store. Typed here rather than
// imported from the SDK so this module stays dependency-free and can be shared
// by every client (desktop renderer and PWA) without either pinning a
