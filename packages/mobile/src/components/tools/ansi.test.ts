...
// Ported from packages/session-ui/src/components/shell-output.test.ts — the
// parser is a byte-for-byte port, so the same cases must hold. If a case here
// and the desktop's diverge, the two renderers have drifted.
