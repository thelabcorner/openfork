// Ported from packages/ui/src/context/marked-parser.tsx — same Marked
// instance shape (KaTeX inline/block math extension + marked-shiki code
// highlighting) so mobile renders markdown identically to desktop.
