...
export const OperationInput = {
  ...
  visual_capture: VisualCaptureInput,
  visual_diff: VisualDiffInput,
  visual_record: VisualRecordInput,
  visual_history: VisualHistoryInput,
...
export const OperationOutput = {
  ...
  visual_capture: VisualCaptureOutput,
  visual_diff: VisualDiffOutput,
  visual_record: VisualRecordOutput,
  visual_history: VisualHistoryOutput,
  visual_artifact: VisualArtifactOutput,
  click: ClickOutput,
  type: TypeOutput,
  press: PressOutput,
  scroll: ScrollOutput,
...
export const DEFAULT_TIMEOUT_MS: Record<OperationName, number> = {
  ...
  snapshot: 30_000,
  screenshot: 30_000,
  visual_capture: 60_000,
  visual_diff: 60_000,
  visual_record: 90_000,
  visual_history: 10_000,
  visual_artifact: 10_000,
  open: 30_000,
  claim: 10_000,
  navigate: 30_000,
  resize: 10_000,
...
export type BrowserFamily = "browser.read" | "browser.navigate" | "browser.interact" | "browser.evaluate" | "browser.record" | "browser.visual"

export const FAMILY: Record<OperationName, BrowserFamily> = {
  status: "browser.read",
  snapshot: "browser.read",
  screenshot: "browser.read",
  visual_capture: "browser.visual",
  visual_diff: "browser.visual",
  visual_record: "browser.visual",
  visual_history: "browser.visual",
  visual_artifact: "browser.visual",
  query: "browser.read",
