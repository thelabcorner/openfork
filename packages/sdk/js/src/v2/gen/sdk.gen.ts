...
import type {
  ...
  SessionGroupCapabilitiesErrors,
  SessionGroupCapabilitiesResponses,
  SessionGroupCreateErrors,
  SessionGroupCreateResponses,
  SessionGroupForSessionErrors,
  SessionGroupForSessionResponses,
  ...
  SessionGroupReorderMembersErrors,
  SessionGroupReorderMembersResponses,
  SessionGroupReorderResponses,
  SessionGroupResolveErrors,
  SessionGroupResolveResponses,
  SessionGroupSetPolicyErrors,
  SessionGroupSetPolicyResponses,
  SessionInitErrors,
...
export class Preferences extends HeyApiClient {
  ...
  public get<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).get<
      ...
      GlobalPreferencesGetErrors,
      ThrowOnError
    >({ url: "/global/preferences", ...options })
  }
...
export class SessionGroup extends HeyApiClient {
  ...
  public capabilities<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).get<
      ...
      SessionGroupCapabilitiesErrors,
      ThrowOnError
    >({ url: "/session-group/capabilities", ...options })
  }
   ...
   */
  public reorderMembers<ThrowOnError extends boolean = false>(
    parameters: {
      groupID: string
      ...
      [
        {
          args: [
            { in: "path", key: "groupID" },
            { key: "sessionGroupPolicy", map: "body" },
          ],
        },
      ],
    )
