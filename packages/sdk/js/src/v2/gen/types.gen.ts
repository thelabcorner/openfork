...
export type ModelPreferencesRecentEntry = {
    providerID: string;
    modelID: string;
};

export type ModelPreferencesInfo = {
    order?: {
        [key: string]: Array<string>;
    };
    favorite?: Array<string>;
    recent?: Array<ModelPreferencesRecentEntry>;
    subProvider?: {
        [key: string]: string;
    };
    variant?: {
...
export type ModelPreferencesRemoval = {
    order?: Array<string>;
    subProvider?: Array<string>;
...
export type FileMutationError = {
    name: 'FileMutationError';
    data: {
        message: string;
        path?: string;
        code: 'conflict' | 'invalid_path' | 'filesystem';
    };
};
...
export type SessionDurableEvent = SessionNextAgentSwitched | SessionNextModelSwitched | SessionNextMoved | SessionNextPrompted | SessionNextPromptAdmitted | SessionNextContextUpdated | SessionNextSynthetic | SessionNextShellStarted | SessionNextShellEnded | SessionNextStepStarted | SessionNextStepStreamed | SessionNextStepEnded | SessionNextStepFailed | SessionNextTextStarted | SessionNextTextEnded | SessionNextToolInputStarted | SessionNextToolInputEnded | SessionNextToolCalled | SessionNextToolProgress | SessionNextToolSuccess | SessionNextToolFailed | SessionNextReasoningStarted | SessionNextReasoningEnded | SessionNextRetried | SessionNextCompactionStarted | SessionNextCompactionEnded | SessionNextRevertStaged | SessionNextRevertCleared | SessionNextRevertCommitted | SessionNextPaused | SessionNextResumed | SessionNextRenamed;
...
export type V2Event = ModelsDevRefreshed | IntegrationUpdated | IntegrationConnectionUpdated | CatalogUpdated | SessionCreated | SessionUpdated | SessionDeleted | MessageUpdated | MessageRemoved | MessagePartUpdated | MessagePartRemoved | SessionNextAgentSwitched | SessionNextModelSwitched | SessionNextMoved | SessionNextPrompted | SessionNextPromptAdmitted | SessionNextContextUpdated | SessionNextSynthetic | SessionNextShellStarted | SessionNextShellEnded | SessionNextStepStarted | SessionNextStepStreamed | SessionNextStepEnded | SessionNextStepFailed | SessionNextTextStarted | SessionNextTextDelta | SessionNextTextEnded | SessionNextReasoningStarted | SessionNextReasoningDelta | SessionNextReasoningEnded | SessionNextToolInputStarted | SessionNextToolInputDelta | SessionNextToolInputEnded | SessionNextToolCalled | SessionNextToolProgress | SessionNextToolSuccess | SessionNextToolFailed | SessionNextRetried | SessionNextCompactionStarted | SessionNextCompactionDelta | SessionNextCompactionEnded | SessionNextRevertStaged | SessionNextRevertCleared | SessionNextRevertCommitted | SessionNextPaused | SessionNextResumed | SessionNextRenamed | MessagePartDelta | SessionDiff | SessionError | InstallationUpdated | InstallationUpdateAvailable | FileEdited | ReferenceUpdated | PermissionV2Asked | PermissionV2Replied | PluginAdded | ProjectDirectoriesUpdated | FileWatcherUpdated | PtyCreated | PtyUpdated | PtyExited | PtyDeleted | QuestionV2Asked | QuestionV2Replied | QuestionV2Rejected | TodoUpdated | SessionGroupCreated | SessionGroupUpdated | SessionGroupDeleted | SessionGroupSessionAdded | SessionGroupSessionRemoved | LspUpdated | PermissionAsked | PermissionReplied | TuiPromptAppend | TuiCommandExecute | TuiToastShow | TuiSessionSelect | McpToolsChanged | McpBrowserOpenFailed | ToolReloaded | CommandExecuted | ProjectUpdated | SessionStatus2 | SessionIdle | QuestionAsked | QuestionReplied2 | QuestionRejected2 | SessionCompacted | VcsBranchUpdated | WorkspaceReady | WorkspaceFailed | WorkspaceStatus | WorktreeReady | WorktreeFailed | ServerConnected | GlobalDisposed;
...
export type SyncEventSessionNextStepStreamed = {
    type: 'sync';
    id: string;
    syncEvent: {
        type: 'session.next.step.streamed.1';
        id: string;
        seq: number;
        aggregateID: string;
        data: {
...
export type SessionNextStepStreamed = {
    id: string;
    metadata?: {
        [key: string]: unknown;
    };
...
export type FileSystemEmptyResult = {
    [key: string]: unknown;
};
...
export type SessionGroupCreated = {
    id: string;
    metadata?: {
        [key: string]: unknown;
    };
    ...
    data: {
        groupID: string;
        info: SessionGroupInfo3;
    };
};

export type SessionGroupUpdated = {
    id: string;
    metadata?: {
        [key: string]: unknown;
    };
...
export type SessionGroupDeleted = {
    id: string;
    metadata?: {
        [key: string]: unknown;
    };
...
export type SessionGroupSessionAdded = {
    id: string;
    metadata?: {
        [key: string]: unknown;
    };
...
export type SessionGroupSessionRemoved = {
    id: string;
    metadata?: {
        [key: string]: unknown;
    };
...
export type EventSessionNextStepStreamed = {
    id: string;
    type: 'session.next.step.streamed';
    properties: {
        timestamp: number;
...
export type EventSessionGroupCreated = {
    id: string;
    type: 'session_group.created';
    properties: {
        groupID: string;
        info: SessionGroupInfo4;
    };
};

export type EventSessionGroupUpdated = {
    id: string;
    type: 'session_group.updated';
    properties: {
        groupID: string;
...
export type EventSessionGroupDeleted = {
    id: string;
    type: 'session_group.deleted';
    properties: {
        groupID: string;
...
export type EventSessionGroupSessionAdded = {
    id: string;
    type: 'session_group.session.added';
    properties: {
        groupID: string;
...
export type EventSessionGroupSessionRemoved = {
    id: string;
    type: 'session_group.session.removed';
    properties: {
        groupID: string;
...
export type ForkCredentialSetDefaultResponse = ForkCredentialSetDefaultResponses[keyof ForkCredentialSetDefaultResponses];
...
export type GlobalPreferencesGetErrors = {
    /**
     * Bad request
     */
    400: BadRequestError;
...
export type GlobalPreferencesGetError = GlobalPreferencesGetErrors[keyof GlobalPreferencesGetErrors];

export type GlobalPreferencesGetResponses = {
    /**
     * Model selector preferences
     */
    200: ModelPreferencesInfo;
};
...
export type GlobalPreferencesUpdateResponses = {
    /**
     * Updated model selector preferences
     */
    200: ModelPreferencesInfo;
};
...
export type ExperimentalOpenrouterTelemetryGetError = ExperimentalOpenrouterTelemetryGetErrors[keyof ExperimentalOpenrouterTelemetryGetErrors];
...
export type ExperimentalOpenrouterTelemetryGetResponse = ExperimentalOpenrouterTelemetryGetResponses[keyof ExperimentalOpenrouterTelemetryGetResponses];
...
export type ExperimentalOpenrouterEndpointsGetError = ExperimentalOpenrouterEndpointsGetErrors[keyof ExperimentalOpenrouterEndpointsGetErrors];
...
export type ExperimentalOpenrouterEndpointsGetResponse = ExperimentalOpenrouterEndpointsGetResponses[keyof ExperimentalOpenrouterEndpointsGetResponses];
...
export type ExperimentalOpenrouterFreeUsageGetError = ExperimentalOpenrouterFreeUsageGetErrors[keyof ExperimentalOpenrouterFreeUsageGetErrors];
...
export type ExperimentalOpenrouterFreeUsageGetResponse = ExperimentalOpenrouterFreeUsageGetResponses[keyof ExperimentalOpenrouterFreeUsageGetResponses];
...
export type SessionContextOpsHistoryResponse = SessionContextOpsHistoryResponses[keyof SessionContextOpsHistoryResponses];
...
export type SessionContextForkOriginResponse = SessionContextForkOriginResponses[keyof SessionContextForkOriginResponses];
...
export type SessionGroupRemoveResponses = {
    /**
     * Successfully deleted session group
     */
    204: void;
};
...
export type SessionGroupGetData = {
    body?: never;
    path: {
        groupID: string;
    };
...
export type SessionGroupGetErrors = {
    /**
     * BadRequest | InvalidRequestError
     */
    400: EffectHttpApiErrorBadRequest | InvalidRequestError;
...
export type SessionGroupGetResponses = {
    /**
     * Session group with sessions
     */
    200: SessionGroupDetail;
};

export type SessionGroupGetResponse = SessionGroupGetResponses[keyof SessionGroupGetResponses];
...
export type SessionGroupRenameResponses = {
    /**
     * Successfully renamed session group
     */
    204: void;
};
...
export type SessionGroupReorderResponses = {
    /**
     * Successfully reordered session group
     */
    204: void;
};
...
export type SessionGroupAddSessionData = {
    body?: {
        sessionId: string;
        locked?: boolean;
        origin?: 'user' | 'auto_subagent' | 'plugin';
...
export type SessionGroupAddSessionErrors = {
    /**
     * BadRequest | InvalidRequestError
     */
    400: EffectHttpApiErrorBadRequest | InvalidRequestError;
...
export type SessionGroupAddSessionResponses = {
    /**
     * Successfully added session to group
     */
    204: void;
};

export type SessionGroupAddSessionResponse = SessionGroupAddSessionResponses[keyof SessionGroupAddSessionResponses];

export type SessionGroupRemoveSessionData = {
    body?: never;
    path: {
        groupID: string;
        sessionID: string;
...
export type SessionGroupRemoveSessionErrors = {
    /**
     * BadRequest | InvalidRequestError
     */
    400: EffectHttpApiErrorBadRequest | InvalidRequestError;
...
export type SessionGroupRemoveSessionError = SessionGroupRemoveSessionErrors[keyof SessionGroupRemoveSessionErrors];

export type SessionGroupRemoveSessionResponses = {
    /**
     * Successfully removed session from group
     */
    204: void;
};

export type SessionGroupRemoveSessionResponse = SessionGroupRemoveSessionResponses[keyof SessionGroupRemoveSessionResponses];

export type SessionGroupCapabilitiesData = {
    body?: never;
    path?: never;
    query?: never;
    url: '/session-group/capabilities';
};

export type SessionGroupCapabilitiesErrors = {
    /**
     * Bad request
     */
    400: BadRequestError;
...
export type SessionGroupCapabilitiesError = SessionGroupCapabilitiesErrors[keyof SessionGroupCapabilitiesErrors];

export type SessionGroupCapabilitiesResponses = {
    /**
     * Supported session-group capabilities
     */
    200: {
...
export type SessionGroupCapabilitiesResponse = SessionGroupCapabilitiesResponses[keyof SessionGroupCapabilitiesResponses];

export type SessionGroupForSessionData = {
    body?: never;
    path: {
        sessionID: string;
    };
...
export type SessionGroupForSessionErrors = {
    /**
     * Bad request
     */
    400: BadRequestError;
...
export type SessionGroupForSessionError = SessionGroupForSessionErrors[keyof SessionGroupForSessionErrors];

export type SessionGroupForSessionResponses = {
    /**
     * Groups containing the session
     */
    200: Array<SessionGroupDetail>;
};

export type SessionGroupForSessionResponse = SessionGroupForSessionResponses[keyof SessionGroupForSessionResponses];
...
export type SessionGroupResolveErrors = {
    /**
     * BadRequest | InvalidRequestError
     */
    400: EffectHttpApiErrorBadRequest | InvalidRequestError;
...
export type SessionGroupResolveError = SessionGroupResolveErrors[keyof SessionGroupResolveErrors];

export type SessionGroupResolveResponses = {
    /**
...
export type SessionGroupResolveResponse = SessionGroupResolveResponses[keyof SessionGroupResolveResponses];

export type SessionGroupReorderMembersData = {
    body?: {
...
export type SessionGroupReorderMembersErrors = {
    /**
     * BadRequest | InvalidRequestError
     */
    400: EffectHttpApiErrorBadRequest | InvalidRequestError;
...
export type SessionGroupReorderMembersResponses = {
    /**
     * Successfully reordered group members
     */
    204: void;
};

export type SessionGroupReorderMembersResponse = SessionGroupReorderMembersResponses[keyof SessionGroupReorderMembersResponses];

export type SessionGroupSetPolicyData = {
    body?: SessionGroupPolicy;
    path: {
        groupID: string;
    };
    query?: never;
...
export type SessionGroupSetPolicyErrors = {
    /**
     * BadRequest | InvalidRequestError
     */
    400: EffectHttpApiErrorBadRequest | InvalidRequestError;
...
export type SessionGroupSetPolicyResponses = {
    /**
     * Successfully updated group policy
     */
    204: void;
};
...
export type ToolReloadError = ToolReloadErrors[keyof ToolReloadErrors];

export type ToolReloadResponses = {
    /**
     * Tool reload result
     */
    200: ToolReloadResponse;
};
...
export type V2SessionPauseData = {
    body?: never;
    path: {
        sessionID: string;
    };
...
export type V2SessionPauseErrors = {
    /**
     * InvalidRequestError
     */
    400: InvalidRequestError;
...
export type V2SessionPauseError = V2SessionPauseErrors[keyof V2SessionPauseErrors];

export type V2SessionPauseResponses = {
    /**
     * <No Content>
     */
    204: void;
...
export type V2SessionPauseResponse = V2SessionPauseResponses[keyof V2SessionPauseResponses];
...
export type V2SessionRegenerateTitleData = {
    body: {
        model?: ModelRef;
        prompt?: string;
    };
...
export type V2SessionRegenerateTitleErrors = {
    /**
     * InvalidRequestError
     */
    400: InvalidRequestError;
...
export type V2SessionRegenerateTitleError = V2SessionRegenerateTitleErrors[keyof V2SessionRegenerateTitleErrors];

export type V2SessionRegenerateTitleResponses = {
    /**
     * <No Content>
     */
    204: void;
...
export type V2SessionRegenerateTitleResponse = V2SessionRegenerateTitleResponses[keyof V2SessionRegenerateTitleResponses];
...
export type V2SessionCheckpointCreateResponse = V2SessionCheckpointCreateResponses[keyof V2SessionCheckpointCreateResponses];
...
export type V2SessionCheckpointDiffRawResponse = V2SessionCheckpointDiffRawResponses[keyof V2SessionCheckpointDiffRawResponses];
...
export type V2SessionCheckpointRevertErrors = {
     ...
     */
    409: CheckpointEpochError | ConflictError1;
    /**
     * CheckpointUnsupportedError
     */
    422: CheckpointUnsupportedError;
...
export type V2SessionCheckpointRevertResponse = V2SessionCheckpointRevertResponses[keyof V2SessionCheckpointRevertResponses];
...
export type V2BrowserAssignData = {
    body: {
        tabId: string;
        owner: {
            kind: 'user';
...
export type V2BrowserAssignErrors = {
    /**
     * InvalidRequestError
     */
    400: InvalidRequestError;
...
export type V2BrowserAssignError = V2BrowserAssignErrors[keyof V2BrowserAssignErrors];

export type V2BrowserAssignResponses = {
    /**
     * Success
     */
    200: {
...
export type V2PushSubscriptionDeleteResponse = V2PushSubscriptionDeleteResponses[keyof V2PushSubscriptionDeleteResponses];
...
export type V2PushSubscriptionCreateResponse = V2PushSubscriptionCreateResponses[keyof V2PushSubscriptionCreateResponses];
