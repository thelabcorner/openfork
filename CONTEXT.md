...
- The first instruction-service slice observes global and upward project `docs/handoff/AGENTS.md` files as one ordered aggregate **Context Source** at each **Safe Provider-Turn Boundary**.
