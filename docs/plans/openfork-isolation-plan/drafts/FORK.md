...
Machine copy: `../../../../keep-manifest.json` until that file is moved to repo root as `../../../../keep-manifest.json`.
...
| Meta | `../../../handoff/AGENTS.md`, `../../../../FORK.md`, `.github/workflows/**`, root `../../../../README.md`, `../../../../packages/desktop/src/main/updater.ts` |
