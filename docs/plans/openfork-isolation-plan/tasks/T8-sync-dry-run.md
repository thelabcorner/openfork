...
3. Write `../sync-dry-run.md` containing:
...
An agent that has never seen this planning folder can execute the next tag merge using only `../../../handoff/AGENTS.md` + `../../../../FORK.md` + the skill. The dry-run file is the evidence.
