...
| Host `../../handoff/AGENTS.md` + `packages/*` listing | Monorepo conventions: package-scoped tests only (`do-not-run-tests-from-root`), `bun typecheck` per package dir, Effect-style architecture, V1-as-production-API doctrine |
...
### 3.1 Monorepo conventions (from host `../../handoff/AGENTS.md`)
