...
**Base:** `../architecture-research.md` (§13, 16, 17, 29, 30, Appendix D/G/H, §31)
...
Pinned against oses-arch's physical design (`oses.md` §7, swarm msg `msg_a57f569701a34c259a01d1171a2790f8`):
