...
**Supersedes:** the corpus sections of `../ideation/benchmark.md` (§2) where they conflict; this is the architecture-level specification, the ideation remains the rationale.
**Related:** `../ideation/event-destructuring-real-corpus.md` (the canonical synthetic-model failure this protocol exists to prevent); `../ideation/SYNTHESIS.md` §5/§7; peer architecture chapters (`storage.md`, `codec.md`, `migration.md`, `contract.md`).
