...
- Directly discover and read global plus upward project `../../handoff/AGENTS.md` files at each safe provider-turn boundary.
...
- Add the canonical V1-to-V2 runtime-context parity checklist to `..on.md`.
