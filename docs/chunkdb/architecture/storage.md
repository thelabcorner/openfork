...
**Corpus authority:** `corpus/ground-truth-v2` (18 GB snapshot, 1,377,243 events) + `docs/chunkdb/ideation/event-destructuring-real-corpus.md` (the correction) + benchmark-arch `docs/chunkdb/architecture/corpus.md` (tiers T0–T3, deliverables D2/D3/D4/D5). **No claim below without a corpus anchor where one exists.**
**Companions:** `docs/chunkdb/ideation/oses.md` (prior lane — superseded where noted), `event-codec.md`, `event-destructuring.md` (v1 — superseded), migration-arch's chapter, contract-arch's chapter, codec-arch's chapter.
