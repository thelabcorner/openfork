...
**Inputs:** openswarm plugin source (`C:\Users\slooshied\Documents\openswarm`, 14 modules under `src/`), host repo survey (`C:\Users\slooshied\WebstormProjects\opencode`), binding doctrine in root `AGENTS.md` + `packages/opencode/AGENTS.md` + `packages/schema/AGENTS.md`.
...
### 2.1 Binding doctrine (root `AGENTS.md`)
